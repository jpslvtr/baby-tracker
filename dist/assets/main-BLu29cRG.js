 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ku="FirebaseError";class fn extends Error{constructor(t,e,r){super(e),this.code=t,this.customData=r,this.name=Ku,Object.setPrototypeOf(this,fn.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,ll.prototype.create)}}class ll{constructor(t,e,r){this.service=t,this.serviceName=e,this.errors=r}create(t,...e){const r=e[0]||{},s=`${this.service}/${t}`,o=this.errors[t],a=o?Wu(o,r):"Error",c=`${this.serviceName}: ${a} (${s}).`;return new fn(s,c,r)}}function Wu(n,t){return n.replace(Gu,(e,r)=>{const s=t[r];return s!=null?String(s):`<${r}?>`})}const Gu=/\{\$([^}]+)}/g;function Gs(n,t){if(n===t)return!0;const e=Object.keys(n),r=Object.keys(t);for(const s of e){if(!r.includes(s))return!1;const o=n[s],a=t[s];if(oa(o)&&oa(a)){if(!Gs(o,a))return!1}else if(o!==a)return!1}for(const s of r)if(!e.includes(s))return!1;return!0}function oa(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sd(n){Nr(new jn("platform-logger",t=>new mh(t),"PRIVATE")),Nr(new jn("heartbeat",t=>new ed(t),"PRIVATE")),tn(Xs,ua,n),tn(Xs,ua,"esm2017"),tn("fire-js","")}sd("");var id="firebase",od="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Be=new cl("@firebase/firestore");function Nn(){return Be.logLevel}function B(n,...t){if(Be.logLevel<=Z.DEBUG){const e=t.map(Ti);Be.debug(`Firestore (${mn}): ${n}`,...e)}}function de(n,...t){if(Be.logLevel<=Z.ERROR){const e=t.map(Ti);Be.error(`Firestore (${mn}): ${n}`,...e)}}function rn(n,...t){if(Be.logLevel<=Z.WARN){const e=t.map(Ti);Be.warn(`Firestore (${mn}): ${n}`,...e)}}function Ti(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function K(n="Unexpected state"){const t=`FIRESTORE (${mn}) INTERNAL ASSERTION FAILED: `+n;throw de(t),new Error(t)}function it(n,t){n||K()}function G(n,t){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vl{constructor(t,e){this.user=e,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${t}`)}}class ad{getToken(){return Promise.resolve(null)}invalidateToken(){}start(t,e){t.enqueueRetryable(()=>e(Ft.UNAUTHENTICATED))}shutdown(){}}class ld{constructor(t){this.token=t,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(t,e){this.changeListener=e,t.enqueueRetryable(()=>e(this.token.user))}shutdown(){this.changeListener=null}}class cd{constructor(t){this.t=t,this.currentUser=Ft.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(t,e){it(this.o===void 0);let r=this.i;const s=h=>this.i!==r?(r=this.i,e(h)):Promise.resolve();let o=new ce;this.o=()=>{this.i++,this.currentUser=this.u(),o.resolve(),o=new ce,t.enqueueRetryable(()=>s(this.currentUser))};const a=()=>{const h=o;t.enqueueRetryable(async()=>{await h.promise,await s(this.currentUser)})},c=h=>{B("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=h,this.o&&(this.auth.addAuthTokenListener(this.o),a())};this.t.onInit(h=>c(h)),setTimeout(()=>{if(!this.auth){const h=this.t.getImmediate({optional:!0});h?c(h):(B("FirebaseAuthCredentialsProvider","Auth not yet detected"),o.resolve(),o=new ce)}},0),a()}getToken(){const t=this.i,e=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(e).then(r=>this.i!==t?(B("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(it(typeof r.accessToken=="string"),new vl(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const t=this.auth&&this.auth.getUid();return it(t===null||typeof t=="string"),new Ft(t)}}class ud{constructor(t,e,r){this.l=t,this.h=e,this.P=r,this.type="FirstParty",this.user=Ft.FIRST_PARTY,this.I=new Map}T(){return this.P?this.P():null}get headers(){this.I.set("X-Goog-AuthUser",this.l);const t=this.T();return t&&this.I.set("Authorization",t),this.h&&this.I.set("X-Goog-Iam-Authorization-Token",this.h),this.I}}class hd{constructor(t,e,r){this.l=t,this.h=e,this.P=r}getToken(){return Promise.resolve(new ud(this.l,this.h,this.P))}start(t,e){t.enqueueRetryable(()=>e(Ft.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class dd{constructor(t){this.value=t,this.type="AppCheck",this.headers=new Map,t&&t.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class fd{constructor(t){this.A=t,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(t,e){it(this.o===void 0);const r=o=>{o.error!=null&&B("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${o.error.message}`);const a=o.token!==this.R;return this.R=o.token,B("FirebaseAppCheckTokenProvider",`Received ${a?"new":"existing"} token.`),a?e(o.token):Promise.resolve()};this.o=o=>{t.enqueueRetryable(()=>r(o))};const s=o=>{B("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=o,this.o&&this.appCheck.addTokenListener(this.o)};this.A.onInit(o=>s(o)),setTimeout(()=>{if(!this.appCheck){const o=this.A.getImmediate({optional:!0});o?s(o):B("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const t=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(t).then(e=>e?(it(typeof e.token=="string"),this.R=e.token,new dd(e.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Jn(n){if(n.code!==D.FAILED_PRECONDITION||n.message!==Ed)throw n;B("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ya(n){let t=0;for(const e in n)Object.prototype.hasOwnProperty.call(n,e)&&t++;return t}function $e(n,t){for(const e in n)Object.prototype.hasOwnProperty.call(n,e)&&t(e,n[e])}function wl(n){for(const t in n)if(Object.prototype.hasOwnProperty.call(n,t))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gn{constructor(t,e){this.mapKeyFn=t,this.equalsFn=e,this.inner={},this.innerSize=0}get(t){const e=this.mapKeyFn(t),r=this.inner[e];if(r!==void 0){for(const[s,o]of r)if(this.equalsFn(s,t))return o}}has(t){return this.get(t)!==void 0}set(t,e){const r=this.mapKeyFn(t),s=this.inner[r];if(s===void 0)return this.inner[r]=[[t,e]],void this.innerSize++;for(let o=0;o<s.length;o++)if(this.equalsFn(s[o][0],t))return void(s[o]=[t,e]);s.push([t,e]),this.innerSize++}delete(t){const e=this.mapKeyFn(t),r=this.inner[e];if(r===void 0)return!1;for(let s=0;s<r.length;s++)if(this.equalsFn(r[s][0],t))return r.length===1?delete this.inner[e]:r.splice(s,1),this.innerSize--,!0;return!1}forEach(t){$e(this.inner,(e,r)=>{for(const[s,o]of r)t(s,o)})}isEmpty(){return wl(this.inner)}size(){return this.innerSize}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $d=new mt(q.comparator);function fe(){return $d}const xl=new mt(q.comparator);function Ln(...n){let t=xl;for(const e of n)t=t.insert(e.key,e);return t}function Ll(n){let t=xl;return n.forEach((e,r)=>t=t.insert(e,r.overlayedDocument)),t}function xe(){return $n()}function Bl(){return $n()}function $n(){return new gn(n=>n.toString(),(n,t)=>n.isEqual(t))}const qd=new mt(q.comparator),jd=new Ct(q.comparator);function X(...n){let t=jd;for(const e of n)t=t.add(e);return t}const zd=new Ct(et);function Hd(){return zd}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const of=new Le([4294967295,4294967295],0);function ka(n){const t=sf().encode(n),e=new pl;return e.update(t),new Uint8Array(e.digest())}function Na(n){const t=new DataView(n.buffer),e=t.getUint32(0,!0),r=t.getUint32(4,!0),s=t.getUint32(8,!0),o=t.getUint32(12,!0);return[new Le([e,r],0),new Le([s,o],0)]}class Vi{constructor(t,e,r){if(this.bitmap=t,this.padding=e,this.hashCount=r,e<0||e>=8)throw new Bn(`Invalid padding: ${e}`);if(r<0)throw new Bn(`Invalid hash count: ${r}`);if(t.length>0&&this.hashCount===0)throw new Bn(`Invalid hash count: ${r}`);if(t.length===0&&e!==0)throw new Bn(`Invalid padding when bitmap length is 0: ${e}`);this.Ie=8*t.length-e,this.Te=Le.fromNumber(this.Ie)}Ee(t,e,r){let s=t.add(e.multiply(Le.fromNumber(r)));return s.compare(of)===1&&(s=new Le([s.getBits(0),s.getBits(1)],0)),s.modulo(this.Te).toNumber()}de(t){return(this.bitmap[Math.floor(t/8)]&1<<t%8)!=0}mightContain(t){if(this.Ie===0)return!1;const e=ka(t),[r,s]=Na(e);for(let o=0;o<this.hashCount;o++){const a=this.Ee(r,s,o);if(!this.de(a))return!1}return!0}static create(t,e,r){const s=t%8==0?0:8-t%8,o=new Uint8Array(Math.ceil(t/8)),a=new Vi(o,s,e);return r.forEach(c=>a.insert(c)),a}insert(t){if(this.Ie===0)return;const e=ka(t),[r,s]=Na(e);for(let o=0;o<this.hashCount;o++){const a=this.Ee(r,s,o);this.Ae(a)}}Ae(t){const e=Math.floor(t/8),r=t%8;this.bitmap[e]|=1<<r}}class Bn extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pf{constructor(){this.changes=new gn(t=>t.toString(),(t,e)=>t.isEqual(e)),this.changesApplied=!1}addEntry(t){this.assertNotApplied(),this.changes.set(t.key,t)}removeEntry(t,e){this.assertNotApplied(),this.changes.set(t,Ot.newInvalidDocument(t).setReadTime(e))}getEntry(t,e){this.assertNotApplied();const r=this.changes.get(e);return r!==void 0?V.resolve(r):this.getFromCache(t,e)}getEntries(t,e){return this.getAllFromCache(t,e)}apply(t){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(t)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nf{constructor(){this.overlays=new mt(q.comparator),this.Ir=new Map}getOverlay(t,e){return V.resolve(this.overlays.get(e))}getOverlays(t,e){const r=xe();return V.forEach(e,s=>this.getOverlay(t,s).next(o=>{o!==null&&r.set(s,o)})).next(()=>r)}saveOverlays(t,e,r){return r.forEach((s,o)=>{this.ht(t,e,o)}),V.resolve()}removeOverlaysForBatchId(t,e,r){const s=this.Ir.get(r);return s!==void 0&&(s.forEach(o=>this.overlays=this.overlays.remove(o)),this.Ir.delete(r)),V.resolve()}getOverlaysForCollection(t,e,r){const s=xe(),o=e.length+1,a=new q(e.child("")),c=this.overlays.getIteratorFrom(a);for(;c.hasNext();){const h=c.getNext().value,d=h.getKey();if(!e.isPrefixOf(d.path))break;d.path.length===o&&h.largestBatchId>r&&s.set(h.getKey(),h)}return V.resolve(s)}getOverlaysForCollectionGroup(t,e,r,s){let o=new mt((d,m)=>d-m);const a=this.overlays.getIterator();for(;a.hasNext();){const d=a.getNext().value;if(d.getKey().getCollectionGroup()===e&&d.largestBatchId>r){let m=o.get(d.largestBatchId);m===null&&(m=xe(),o=o.insert(d.largestBatchId,m)),m.set(d.getKey(),d)}}const c=xe(),h=o.getIterator();for(;h.hasNext()&&(h.getNext().value.forEach((d,m)=>c.set(d,m)),!(c.size()>=s)););return V.resolve(c)}ht(t,e,r){const s=this.overlays.get(r.key);if(s!==null){const a=this.Ir.get(s.largestBatchId).delete(r.key);this.Ir.set(s.largestBatchId,a)}this.overlays=this.overlays.insert(r.key,new ef(e,r));let o=this.Ir.get(e);o===void 0&&(o=X(),this.Ir.set(e,o)),this.Ir.set(e,o.add(r.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bt="WebChannelConnection";class em extends class{constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const r=e.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),o=encodeURIComponent(this.databaseId.database);this.Do=r+"://"+e.host,this.vo=`projects/${s}/databases/${o}`,this.Co=this.databaseId.database==="(default)"?`project_id=${s}`:`project_id=${s}&database_id=${o}`}get Fo(){return!1}Mo(e,r,s,o,a){const c=xs(),h=this.xo(e,r.toUriEncodedString());B("RestConnection",`Sending RPC '${e}' ${c}:`,h,s);const d={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(d,o,a),this.No(e,h,d,s).then(m=>(B("RestConnection",`Received RPC '${e}' ${c}: `,m),m),m=>{throw rn("RestConnection",`RPC '${e}' ${c} failed with error: `,m,"url: ",h,"request:",s),m})}Lo(e,r,s,o,a,c){return this.Mo(e,r,s,o,a)}Oo(e,r,s){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+mn}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((o,a)=>e[a]=o),s&&s.headers.forEach((o,a)=>e[a]=o)}xo(e,r){const s=Zf[e];return`${this.Do}/v1/${r}:${s}`}terminate(){}}{constructor(t){super(t),this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}No(t,e,r,s){const o=xs();return new Promise((a,c)=>{const h=new gl;h.setWithCredentials(!0),h.listenOnce(yl.COMPLETE,()=>{try{switch(h.getLastErrorCode()){case br.NO_ERROR:const m=h.getResponseJson();B(Bt,`XHR for RPC '${t}' ${o} received:`,JSON.stringify(m)),a(m);break;case br.TIMEOUT:B(Bt,`RPC '${t}' ${o} timed out`),c(new M(D.DEADLINE_EXCEEDED,"Request time out"));break;case br.HTTP_ERROR:const E=h.getStatus();if(B(Bt,`RPC '${t}' ${o} failed with status:`,E,"response text:",h.getResponseText()),E>0){let v=h.getResponseJson();Array.isArray(v)&&(v=v[0]);const S=v==null?void 0:v.error;if(S&&S.status&&S.message){const P=function(C){const R=C.toLowerCase().replace(/_/g,"-");return Object.values(D).indexOf(R)>=0?R:D.UNKNOWN}(S.status);c(new M(P,S.message))}else c(new M(D.UNKNOWN,"Server responded with status "+h.getStatus()))}else c(new M(D.UNAVAILABLE,"Connection failed."));break;default:K()}}finally{B(Bt,`RPC '${t}' ${o} completed.`)}});const d=JSON.stringify(s);B(Bt,`RPC '${t}' ${o} sending request:`,s),h.send(e,"POST",d,r,15)})}Bo(t,e,r){const s=xs(),o=[this.Do,"/","google.firestore.v1.Firestore","/",t,"/channel"],a=Tl(),c=El(),h={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(h.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(h.useFetchStreams=!0),this.Oo(h.initMessageHeaders,e,r),h.encodeInitMessageHeaders=!0;const m=o.join("");B(Bt,`Creating RPC '${t}' stream ${s}: ${m}`,h);const E=a.createWebChannel(m,h);let v=!1,S=!1;const P=new tm({Io:C=>{S?B(Bt,`Not sending because RPC '${t}' stream ${s} is closed:`,C):(v||(B(Bt,`Opening RPC '${t}' stream ${s} transport.`),E.open(),v=!0),B(Bt,`RPC '${t}' stream ${s} sending:`,C),E.send(C))},To:()=>E.close()}),k=(C,R,O)=>{C.listen(R,F=>{try{O(F)}catch(z){setTimeout(()=>{throw z},0)}})};return k(E,xn.EventType.OPEN,()=>{S||(B(Bt,`RPC '${t}' stream ${s} transport opened.`),P.yo())}),k(E,xn.EventType.CLOSE,()=>{S||(S=!0,B(Bt,`RPC '${t}' stream ${s} transport closed`),P.So())}),k(E,xn.EventType.ERROR,C=>{S||(S=!0,rn(Bt,`RPC '${t}' stream ${s} transport errored:`,C),P.So(new M(D.UNAVAILABLE,"The operation could not be completed")))}),k(E,xn.EventType.MESSAGE,C=>{var R;if(!S){const O=C.data[0];it(!!O);const F=O,z=F.error||((R=F[0])===null||R===void 0?void 0:R.error);if(z){B(Bt,`RPC '${t}' stream ${s} received error:`,z);const Q=z.status;let U=function(y){const T=It[y];if(T!==void 0)return Hl(T)}(Q),I=z.message;U===void 0&&(U=D.INTERNAL,I="Unknown error status: "+Q+" with message "+z.message),S=!0,P.So(new M(U,I)),E.close()}else B(Bt,`RPC '${t}' stream ${s} received:`,O),P.bo(O)}}),k(c,_l.STAT_EVENT,C=>{C.stat===ti.PROXY?B(Bt,`RPC '${t}' stream ${s} detected buffering proxy`):C.stat===ti.NOPROXY&&B(Bt,`RPC '${t}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{P.wo()},0),P}}function Ls(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sm extends class{}{constructor(t,e,r,s){super(),this.authCredentials=t,this.appCheckCredentials=e,this.connection=r,this.serializer=s,this.y_=!1}w_(){if(this.y_)throw new M(D.FAILED_PRECONDITION,"The client has already been terminated.")}Mo(t,e,r,s){return this.w_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([o,a])=>this.connection.Mo(t,ai(e,r),s,o,a)).catch(o=>{throw o.name==="FirebaseError"?(o.code===D.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),o):new M(D.UNKNOWN,o.toString())})}Lo(t,e,r,s,o){return this.w_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([a,c])=>this.connection.Lo(t,ai(e,r),s,a,c,o)).catch(a=>{throw a.name==="FirebaseError"?(a.code===D.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),a):new M(D.UNKNOWN,a.toString())})}terminate(){this.y_=!0,this.connection.terminate()}}class im{constructor(t,e){this.asyncQueue=t,this.onlineStateHandler=e,this.state="Unknown",this.S_=0,this.b_=null,this.D_=!0}v_(){this.S_===0&&(this.C_("Unknown"),this.b_=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,()=>(this.b_=null,this.F_("Backend didn't respond within 10 seconds."),this.C_("Offline"),Promise.resolve())))}M_(t){this.state==="Online"?this.C_("Unknown"):(this.S_++,this.S_>=1&&(this.x_(),this.F_(`Connection failed 1 times. Most recent error: ${t.toString()}`),this.C_("Offline")))}set(t){this.x_(),this.S_=0,t==="Online"&&(this.D_=!1),this.C_(t)}C_(t){t!==this.state&&(this.state=t,this.onlineStateHandler(t))}F_(t){const e=`Could not reach Cloud Firestore backend. ${t}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class en{constructor(t){this.comparator=t?(e,r)=>t(e,r)||q.comparator(e.key,r.key):(e,r)=>q.comparator(e.key,r.key),this.keyedMap=Ln(),this.sortedSet=new mt(this.comparator)}static emptySet(t){return new en(t.comparator)}has(t){return this.keyedMap.get(t)!=null}get(t){return this.keyedMap.get(t)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(t){const e=this.keyedMap.get(t);return e?this.sortedSet.indexOf(e):-1}get size(){return this.sortedSet.size}forEach(t){this.sortedSet.inorderTraversal((e,r)=>(t(e),!1))}add(t){const e=this.delete(t.key);return e.copy(e.keyedMap.insert(t.key,t),e.sortedSet.insert(t,null))}delete(t){const e=this.get(t);return e?this.copy(this.keyedMap.remove(t),this.sortedSet.remove(e)):this}isEqual(t){if(!(t instanceof en)||this.size!==t.size)return!1;const e=this.sortedSet.getIterator(),r=t.sortedSet.getIterator();for(;e.hasNext();){const s=e.getNext().key,o=r.getNext().key;if(!s.isEqual(o))return!1}return!0}toString(){const t=[];return this.forEach(e=>{t.push(e.toString())}),t.length===0?"DocumentSet ()":`DocumentSet (
  `+t.join(`  
`)+`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class un{constructor(t){this._byteString=t}static fromBase64String(t){try{return new un(Vt.fromBase64String(t))}catch(e){throw new M(D.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+e)}}static fromUint8Array(t){return new un(Vt.fromUint8Array(t))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(t){return this._byteString.isEqual(t._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class es{constructor(...t){for(let e=0;e<t.length;++e)if(t[e].length===0)throw new M(D.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Pt(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ki{constructor(t,e){if(!isFinite(t)||t<-90||t>90)throw new M(D.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+t);if(!isFinite(e)||e<-180||e>180)throw new M(D.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+e);this._lat=t,this._long=e}get latitude(){return this._lat}get longitude(){return this._long}isEqual(t){return this._lat===t._lat&&this._long===t._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(t){return et(this._lat,t._lat)||et(this._long,t._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rp(n){if(n.limitType==="L"&&n.explicitOrderBy.length===0)throw new M(D.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class Xi{}class Ji extends Xi{}function Et(n,t,...e){let r=[];t instanceof Xi&&r.push(t),r=r.concat(e),function(o){const a=o.filter(h=>h instanceof Zi).length,c=o.filter(h=>h instanceof is).length;if(a>1||a>0&&c>0)throw new M(D.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}(r);for(const s of r)n=s._apply(n);return n}class is extends Ji{constructor(t,e,r){super(),this._field=t,this._op=e,this._value=r,this.type="where"}static _create(t,e,r){return new is(t,e,r)}_apply(t){const e=this._parse(t);return Mc(t._query,e),new De(t.firestore,t.converter,ii(t._query,e))}_parse(t){const e=ns(t.firestore);return function(o,a,c,h,d,m,E){let v;if(d.isKeyField()){if(m==="array-contains"||m==="array-contains-any")throw new M(D.INVALID_ARGUMENT,`Invalid Query. You can't perform '${m}' queries on documentId().`);if(m==="in"||m==="not-in"){tl(E,m);const S=[];for(const P of E)S.push(Za(h,o,P));v={arrayValue:{values:S}}}else v=Za(h,o,E)}else m!=="in"&&m!=="not-in"&&m!=="array-contains-any"||tl(E,m),v=tp(c,a,E,m==="in"||m==="not-in");return wt.create(d,m,v)}(t._query,"where",e,t.firestore._databaseId,this._field,this._op,this._value)}}function Y(n,t,e){const r=t,s=ss("where",n);return is._create(s,r,e)}class Zi extends Xi{constructor(t,e){super(),this.type=t,this._queryConstraints=e}static _create(t,e){return new Zi(t,e)}_parse(t){const e=this._queryConstraints.map(r=>r._parse(t)).filter(r=>r.getFilters().length>0);return e.length===1?e[0]:te.create(e,this._getOperator())}_apply(t){const e=this._parse(t);return e.getFilters().length===0?t:(function(s,o){let a=s;const c=o.getFlattenedFilters();for(const h of c)Mc(a,h),a=ii(a,h)}(t._query,e),new De(t.firestore,t.converter,ii(t._query,e)))}_getQueryConstraints(){return this._queryConstraints}_getOperator(){return this.type==="and"?"and":"or"}}class to extends Ji{constructor(t,e){super(),this._field=t,this._direction=e,this.type="orderBy"}static _create(t,e){return new to(t,e)}_apply(t){const e=function(s,o,a){if(s.startAt!==null)throw new M(D.INVALID_ARGUMENT,"Invalid query. You must not call startAt() or startAfter() before calling orderBy().");if(s.endAt!==null)throw new M(D.INVALID_ARGUMENT,"Invalid query. You must not call endAt() or endBefore() before calling orderBy().");return new Qn(o,a)}(t._query,this._field,this._direction);return new De(t.firestore,t.converter,function(s,o){const a=s.explicitOrderBy.concat([o]);return new pn(s.path,s.collectionGroup,a,s.filters.slice(),s.limit,s.limitType,s.startAt,s.endAt)}(t._query,e))}}function Tt(n,t="asc"){const e=t,r=ss("orderBy",n);return to._create(r,e)}class eo extends Ji{constructor(t,e,r){super(),this.type=t,this._limit=e,this._limitType=r}static _create(t,e,r){return new eo(t,e,r)}_apply(t){return new De(t.firestore,t.converter,Lr(t._query,this._limit,this._limitType))}}function Ue(n){return Hm("limit",n),eo._create("limit",n,"F")}function Za(n,t,e){if(typeof(e=ue(e))=="string"){if(e==="")throw new M(D.INVALID_ARGUMENT,"Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");if(!kl(t)&&e.indexOf("/")!==-1)throw new M(D.INVALID_ARGUMENT,`Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${e}' contains a '/' character.`);const r=t.path.child(ft.fromString(e));if(!q.isDocumentKey(r))throw new M(D.INVALID_ARGUMENT,`Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${r}' is not because it has an odd number of segments (${r.length}).`);return va(n,new q(r))}if(e instanceof zt)return va(n,e._key);throw new M(D.INVALID_ARGUMENT,`Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${Zr(e)}.`)}function tl(n,t){if(!Array.isArray(n)||n.length===0)throw new M(D.INVALID_ARGUMENT,`Invalid Query. A non-empty array is required for '${t.toString()}' filters.`)}function Mc(n,t){const e=function(s,o){for(const a of s)for(const c of a.getFlattenedFilters())if(o.indexOf(c.op)>=0)return c.op;return null}(n.filters,function(s){switch(s){case"!=":return["!=","not-in"];case"array-contains-any":case"in":return["not-in"];case"not-in":return["array-contains-any","in","not-in","!="];default:return[]}}(t.op));if(e!==null)throw e===t.op?new M(D.INVALID_ARGUMENT,`Invalid query. You cannot use more than one '${t.op.toString()}' filter.`):new M(D.INVALID_ARGUMENT,`Invalid query. You cannot use '${t.op.toString()}' filters with '${e.toString()}' filters.`)}class sp{convertValue(t,e="none"){switch(Oe(t)){case 0:return null;case 1:return t.booleanValue;case 2:return _t(t.integerValue||t.doubleValue);case 3:return this.convertTimestamp(t.timestampValue);case 4:return this.convertServerTimestamp(t,e);case 5:return t.stringValue;case 6:return this.convertBytes(Fe(t.bytesValue));case 7:return this.convertReference(t.referenceValue);case 8:return this.convertGeoPoint(t.geoPointValue);case 9:return this.convertArray(t.arrayValue,e);case 11:return this.convertObject(t.mapValue,e);case 10:return this.convertVectorValue(t.mapValue);default:throw K()}}convertObject(t,e){return this.convertObjectMap(t.fields,e)}convertObjectMap(t,e="none"){const r={};return $e(t,(s,o)=>{r[s]=this.convertValue(o,e)}),r}convertVectorValue(t){var e,r,s;const o=(s=(r=(e=t.fields)===null||e===void 0?void 0:e.value.arrayValue)===null||r===void 0?void 0:r.values)===null||s===void 0?void 0:s.map(a=>_t(a.doubleValue));return new Wi(o)}convertGeoPoint(t){return new Ki(_t(t.latitude),_t(t.longitude))}convertArray(t,e){return(t.values||[]).map(r=>this.convertValue(r,e))}convertServerTimestamp(t,e){switch(e){case"previous":const r=wi(t);return r==null?null:this.convertValue(r,e);case"estimate":return this.convertTimestamp(Kn(t));default:return null}}convertTimestamp(t){const e=Ae(t);return new j(e.seconds,e.nanos)}convertDocumentKey(t,e){const r=ft.fromString(t);it(tc(r));const s=new Wn(r.get(1),r.get(3)),o=new q(r.popFirst(5));return s.isEqual(e)||de(`Document ${o} contains a document reference within a different database (${s.projectId}/${s.database}) which is not supported. It will be treated as a reference in the current database (${e.projectId}/${e.database}) instead.`),o}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fn{constructor(t,e){this.hasPendingWrites=t,this.fromCache=e}isEqual(t){return this.hasPendingWrites===t.hasPendingWrites&&this.fromCache===t.fromCache}}class Lc extends Nc{constructor(t,e,r,s,o,a){super(t,e,r,s,a),this._firestore=t,this._firestoreImpl=t,this.metadata=o}exists(){return super.exists()}data(t={}){if(this._document){if(this._converter){const e=new Cr(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(e,t)}return this._userDataWriter.convertValue(this._document.data.value,t.serverTimestamps)}}get(t,e={}){if(this._document){const r=this._document.data.field(ss("DocumentSnapshot.get",t));if(r!==null)return this._userDataWriter.convertValue(r,e.serverTimestamps)}}}class Cr extends Lc{data(t={}){return super.data(t)}}class ip{constructor(t,e,r,s){this._firestore=t,this._userDataWriter=e,this._snapshot=s,this.metadata=new Fn(s.hasPendingWrites,s.fromCache),this.query=r}get docs(){const t=[];return this.forEach(e=>t.push(e)),t}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(t,e){this._snapshot.docs.forEach(r=>{t.call(e,new Cr(this._firestore,this._userDataWriter,r.key,r,new Fn(this._snapshot.mutatedKeys.has(r.key),this._snapshot.fromCache),this.query.converter))})}docChanges(t={}){const e=!!t.includeMetadataChanges;if(e&&this._snapshot.excludesMetadataChanges)throw new M(D.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===e||(this._cachedChanges=function(s,o){if(s._snapshot.oldDocs.isEmpty()){let a=0;return s._snapshot.docChanges.map(c=>{const h=new Cr(s._firestore,s._userDataWriter,c.doc.key,c.doc,new Fn(s._snapshot.mutatedKeys.has(c.doc.key),s._snapshot.fromCache),s.query.converter);return c.doc,{type:"added",doc:h,oldIndex:-1,newIndex:a++}})}{let a=s._snapshot.oldDocs;return s._snapshot.docChanges.filter(c=>o||c.type!==3).map(c=>{const h=new Cr(s._firestore,s._userDataWriter,c.doc.key,c.doc,new Fn(s._snapshot.mutatedKeys.has(c.doc.key),s._snapshot.fromCache),s.query.converter);let d=-1,m=-1;return c.type!==0&&(d=a.indexOf(c.doc.key),a=a.delete(c.doc.key)),c.type!==1&&(a=a.add(c.doc),m=a.indexOf(c.doc.key)),{type:op(c.type),doc:h,oldIndex:d,newIndex:m}})}}(this,e),this._cachedChangesIncludeMetadataChanges=e),this._cachedChanges}}function op(n){switch(n){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return K()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`))),r===e&&(n.value=e+`
`)}),n.addEventListener("keydown",e=>{const r=t.value;if(!r||r==="Other")return;const s=e.target,o=s.selectionStart,a=r.length;if(o<=a){if(["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Home","End"].includes(e.key)||e.key==="a"&&(e.ctrlKey||e.metaKey))return;if(e.key==="Backspace"||e.key==="Delete"){e.preventDefault();return}if(e.key.length===1||e.key==="Enter"){if(e.preventDefault(),s.selectionStart=a+1,s.selectionEnd=a+1,e.key==="Enter"){const c=s.value.substring(0,a+1),h=s.value.substring(a+1);s.value=c+`
`+h,s.selectionStart=a+2,s.selectionEnd=a+2}else if(e.key.length===1){const c=s.value.substring(0,a+1),h=s.value.substring(a+1);s.value=c+e.key+h,s.selectionStart=a+2,s.selectionEnd=a+2}return}}}),n.addEventListener("paste",e=>{const r=t.value;if(!r||r==="Other")return;const o=e.target.selectionStart,a=r.length;if(o<=a){e.preventDefault();return}}))}async function Pp(){const n=document.getElementById("entry-type").value,t=document.getElementById("submit-status");try{let e=null;const r=new Date;if(n==="bottle-breast-milk"||n==="bottle-formula"){const s=document.getElementById("bottle-time"),o=s.value,a=parseFloat(document.getElementById("bottle-amount").value),c=document.getElementById("bottle-unit").value,h=document.getElementById("bottle-notes").value;if(!o)throw new Error("Start time is required");const d=ut(s.value);if(d>r)throw new Error("Cannot add entries in the future");if(isNaN(a)||a<=0)throw new Error("Amount must be greater than 0");if(n==="bottle-formula"&&!document.getElementById("bottle-type").value)throw new Error("Formula type is required");const m=n==="bottle-formula"?document.getElementById("bottle-type").value:void 0;e={type:"Feed",subType:n==="bottle-breast-milk"?"Breast Milk":"Formula",startTime:d,amount:a,unit:c,formulaType:m,notes:h}}else if(n==="diaper"){const s=document.getElementById("diaper-time"),o=s.value,a=document.getElementById("diaper-type").value,c=document.getElementById("diaper-notes").value;if(!o)throw new Error("Start time is required");const h=ut(s.value);if(h>r)throw new Error("Cannot add entries in the future");if(!a)throw new Error("Diaper type is required");e={type:"Diaper",diaperType:a,startTime:h,notes:c}}else if(n==="solids"){const s=document.getElementById("solids-start-time"),o=document.getElementById("solids-notes").value;if(!s.value)throw new Error("Start time is required");const a=ut(s.value);if(a>r)throw new Error("Cannot add entries in the future");e={type:"Solids",startTime:a,notes:o}}else if(n==="sleep"){const s=document.getElementById("sleep-start-time"),o=document.getElementById("sleep-end-time"),a=document.getElementById("sleep-notes").value;if(!s.value)throw new Error("Start time is required");const c=ut(s.value);if(c>r)throw new Error("Cannot add entries in the future");const h=Et(yt(lt,"entries"),Y("type","==","Sleep"),Tt("startTime","desc"),Ue(1)),d=await At(h);if(!d.empty&&!d.docs[0].data().endTime)throw new Error("A sleep entry is already ongoing. End that entry before adding a new one.");let m;if(o.value){if(m=ut(o.value),m>r)throw new Error("End time cannot be in the future");if(m<=c)throw new Error("End time must be after start time")}e={type:"Sleep",startTime:c,endTime:m,notes:a}}e&&(await up(yt(lt,"entries"),{...e,startTime:j.fromDate(e.startTime),endTime:e.endTime?j.fromDate(e.endTime):null}),t.className="success",t.textContent="Entry added successfully!",t.style.display="block",Cp(),e.type==="Feed"||e.type==="Solids"?await zc():e.type==="Diaper"?await Hc():e.type==="Sleep"&&(await Yc(),await Jc()),ze(),setTimeout(()=>{t.style.display="none"},3e3))}catch(e){t.className="error",t.textContent=e instanceof Error?e.message:"Failed to add entry",t.style.display="block"}}function Cp(){document.getElementById("entry-type").value="",document.getElementById("bottle-amount").value="",document.getElementById("bottle-type").value="",document.getElementById("bottle-notes").value="",document.getElementById("diaper-notes").value="",document.getElementById("solids-notes").value="",document.getElementById("sleep-end-time").value="",document.getElementById("sleep-notes").value="",document.getElementById("bottle-fields").style.display="none",document.getElementById("bottle-type-container").style.display="none",document.getElementById("diaper-fields").style.display="none",document.getElementById("solids-fields").style.display="none",document.getElementById("sleep-fields").style.display="none",document.getElementById("submit-entry").style.display="none",ls()}function Mn(n){const t=document.getElementById("start-date-filter"),e=document.getElementById("end-date-filter"),r=Xt();if(r.setHours(0,0,0,0),n==="all-time"){const s=new Date(2025,10,5);t.value=jt(s),e.value=jt(r)}else if(n==="today")t.value=jt(r),e.value=jt(r);else if(n==="yesterday"){const s=new Date(r);s.setDate(s.getDate()-1),t.value=jt(s),e.value=jt(s)}else if(n==="two-days-ago"){const s=new Date(r);s.setDate(s.getDate()-2),t.value=jt(s),e.value=jt(s)}else if(n==="three-days-ago"){const s=new Date(r);s.setDate(s.getDate()-3),t.value=jt(s),e.value=jt(s)}Ee()}async function Ee(){const n=++Ye,t=document.getElementById("timeline-list"),e=document.getElementById("timeline-loading"),r=document.getElementById("start-date-filter").value,s=document.getElementById("end-date-filter").value,o=document.getElementById("type-filter").value;e.style.display="block",t.innerHTML="";const a=document.querySelector(".filter-summary");a&&a.remove();try{let c=Et(yt(lt,"entries"),Tt("startTime","desc"));if(r&&s){const S=ut(`${r}T00:00`),P=ut(`${s}T23:59`);P.setSeconds(59,999),c=Et(yt(lt,"entries"),Y("startTime",">=",j.fromDate(S)),Y("startTime","<=",j.fromDate(P)),Tt("startTime","desc"))}const h=await At(c);if(n!==Ye)return;let d=[];if(r){const[S,P,k]=r.split("-").map(Number),C=new Date(S,P-1,k-1),R=`${C.getFullYear()}-${String(C.getMonth()+1).padStart(2,"0")}-${String(C.getDate()).padStart(2,"0")}`,O=ut(`${R}T19:00`),F=ut(`${r}T00:00`),z=Et(yt(lt,"entries"),Y("type","==","Sleep"),Y("startTime",">=",j.fromDate(O)),Y("startTime","<",j.fromDate(F)),Tt("startTime","desc"));try{(await At(z)).forEach(U=>{d.push({id:U.id,data:U.data()})})}catch(Q){console.error("Error fetching prior evening sleep:",Q)}}if(n!==Ye)return;const m=[],E=new Set;h.forEach(S=>{m.push({id:S.id,data:S.data()}),E.add(S.id)}),d.forEach(S=>{E.has(S.id)||(m.push(S),E.add(S.id))}),m.sort((S,P)=>P.data.startTime.toDate().getTime()-S.data.startTime.toDate().getTime());const v={bottles:{total:0,breastMilk:0,formula:0,sessions:0},diapers:{total:0,pee:0,poo:0,mixed:0},sleep:{totalMs:0,sessions:0},solids:{sessions:0}};if(m.length===0)t.innerHTML="<p>No entries found.</p>";else{let S="",P=!1;m.forEach(({id:C,data:R})=>{if(o!=="all"){let w="";if(R.type==="Feed"&&R.subType==="Breast Milk"?w="bottle-breast-milk":R.type==="Feed"&&R.subType==="Formula"?w="bottle-formula":R.type==="Diaper"?w="diaper-all":R.type==="Pump"?w="pump":R.type==="Sleep"?w="sleep":R.type==="Solids"&&(w="solids"),o==="bottle-all"){if(R.type!=="Feed")return}else if(o==="diaper-all"){if(R.type!=="Diaper")return}else if(o==="diaper-pee"){if(R.type!=="Diaper"||R.diaperType!=="Pee"&&R.diaperType!=="Mixed")return}else if(o==="diaper-poo"){if(R.type!=="Diaper"||R.diaperType!=="Poo"&&R.diaperType!=="Mixed")return}else if(w!==o)return}if(R.type==="Feed"){const w=nn(R.amount,R.unit);v.bottles.total+=w,v.bottles.sessions++,R.subType==="Breast Milk"?v.bottles.breastMilk+=w:R.subType==="Formula"&&(v.bottles.formula+=w)}else R.type==="Diaper"?(v.diapers.total++,R.diaperType==="Pee"?v.diapers.pee++:R.diaperType==="Poo"?v.diapers.poo++:R.diaperType==="Mixed"&&v.diapers.mixed++):R.type==="Sleep"?v.sleep.sessions++:R.type==="Solids"&&v.solids.sessions++;P=!0;const O=R.startTime.toDate(),F=yi(O);if(F!==S){S=F;const w=document.createElement("div");w.className="timeline-date-header",w.textContent=F,t.appendChild(w)}const z=document.createElement("div");z.className="timeline-entry";let Q=R.type,U="",I="";if(R.type==="Feed")Q=`Bottle - ${R.subType}`,U=`<div class="timeline-entry-details">Amount: ${ye(R.amount,R.unit)}</div>`,I="#d9ebf2";else if(R.type==="Breast Feed")Q="Breast Feed",U="",I="#d9ebf2";else if(R.type==="Diaper")U=`<div class="timeline-entry-details">Type: ${R.diaperType}</div>`,I="#fce2d4";else if(R.type==="Pump")U=`<div class="timeline-entry-details">Amount: ${ye(R.amount,R.unit)}</div>`,I="#e2daf2";else if(R.type==="Solids")Q="Solids",I="#f5e6d0";else if(R.type==="Sleep")if(Q="Sleep",I="#d4e8d4",R.endTime){const w=R.startTime.toDate(),p=R.endTime.toDate(),$=p.getTime()-w.getTime(),rt=Math.floor($/(1e3*60*60)),L=Math.floor($%(1e3*60*60)/(1e3*60));U=`<div class="timeline-entry-details">Duration: ${rt}h ${L}m</div>`,U+=`<div class="timeline-entry-details">End: ${gi(p)}</div>`}else U='<div class="timeline-entry-details">In progress</div>';z.style.backgroundColor=I;const g=R.notes?`<div class="timeline-entry-notes">${R.notes.replace(/\n/g,"<br>")}</div>`:"";let y="";if(R.type==="Diaper"&&(R.diaperType==="Poo"||R.diaperType==="Mixed")){const w=O.getTime(),p=[];m.forEach(rt=>{const L=rt.data;L.type==="Diaper"&&(L.diaperType==="Poo"||L.diaperType==="Mixed")&&p.push({time:L.startTime.toDate().getTime()})}),p.sort((rt,L)=>L.time-rt.time);const $=p.findIndex(rt=>rt.time===w);if($>=0&&$<p.length-1){const rt=p[$+1].time;y=`<div class="timeline-entry-details" style="color: #666; font-style: italic;">${((w-rt)/(1e3*60*60)).toFixed(1)} hours since previous poo</div>`}else $>=0&&$===p.length-1&&(z.dataset.needsPriorPoo="true",z.dataset.pooTime=String(w))}z.innerHTML=`
                    <div class="timeline-entry-header">
                        <span class="timeline-entry-type">${Q}</span>
                        <span class="timeline-entry-time">${gi(O)}</span>
                    </div>
                    ${U}
                    ${g}
                    ${y}
                ...
                `;const T=z.querySelector(".edit-button"),_=z.querySelector(".delete-button");T.addEventListener("click",()=>Lp(C,R)),_.addEventListener("click",()=>Fp(C)),t.appendChild(z)});const k=t.querySelectorAll('[data-needs-prior-poo="true"]');for(const C of Array.from(k)){const R=parseInt(C.dataset.pooTime||"0",10);if(R>0)try{const O=Et(yt(lt,"entries"),Y("type","==","Diaper"),Y("startTime","<",j.fromDate(new Date(R))),Tt("startTime","desc")),F=await At(O);let z=null;if(F.forEach(Q=>{if(z!==null)return;const U=Q.data();(U.diaperType==="Poo"||U.diaperType==="Mixed")&&(z=U.startTime.toDate().getTime())}),z!==null){const Q=(R-z)/36e5,U=document.createElement("div");U.className="timeline-entry-details",U.style.color="#666",U.style.fontStyle="italic",U.textContent=`${Q.toFixed(1)} hours since previous poo`;const I=C.querySelector(".timeline-entry-actions");I?C.insertBefore(U,I):C.appendChild(U)}}catch(O){console.error("Error fetching prior poo entry:",O)}C.removeAttribute("data-needs-prior-poo"),C.removeAttribute("data-poo-time")}if(!P)t.innerHTML="<p>No entries match the selected filters.</p>";else{const C=document.createElement("div");C.className="filter-summary";let R='<div class="summary-header">Summary</div><div class="summary-stats">',O=!1;if(o==="all"||o==="bottle-breast-milk"||o==="bottle-formula"||o==="bottle-all"||o==="solids"){const F=v.bottles.sessions+v.solids.sessions,z=o!=="solids",Q=o==="all"||o==="solids";R+=`
                        <div class="stat-group">
                            <div class="stat-group-title">Feeds</div>
                            <div class="stat-line">Number of Feeds: ${F}</div>
                            ${z?`
                    ...
                    `,O=!0}if(o==="all"||o==="diaper-all"||o==="diaper-pee"||o==="diaper-poo"){const F=v.diapers.pee+v.diapers.mixed,z=v.diapers.poo+v.diapers.mixed;R+=`
                        <div class="stat-group">
                            <div class="stat-group-title">Diapers</div>
                            <div class="stat-line">Pee: ${F}</div>
                            <div class="stat-line">Poo: ${z}</div>
                        </div>
                    `,O=!0}if(o==="all"||o==="sleep"){let F=0;if(r&&s){const U=[];m.forEach(ct=>{const ot=ct.data;ot.type==="Sleep"&&U.push({startTime:ot.startTime.toDate(),endTime:ot.endTime?ot.endTime.toDate():null})});const[I,g,y]=r.split("-").map(Number),T=new Date(I,g-1,y);T.setDate(T.getDate()-1);const _=new Date(T);_.setHours(0,0,0,0);const w=new Date(T);w.setHours(23,59,59,999);try{const ct=Et(yt(lt,"entries"),Y("type","==","Sleep"),Y("startTime",">=",j.fromDate(_)),Y("startTime","<=",j.fromDate(w)),Tt("startTime","asc"));(await At(ct)).forEach(ne=>{const kt=ne.data();U.push({startTime:kt.startTime.toDate(),endTime:kt.endTime?kt.endTime.toDate():null})})}catch(ct){console.error("Error fetching prior sleep entries:",ct)}const[p,$,rt]=s.split("-").map(Number),L=new Date(p,$-1,rt);L.setDate(L.getDate()+1);const x=new Date(L);x.setHours(0,0,0,0);const ht=new Date(L);ht.setHours(23,59,59,999);try{const ct=Et(yt(lt,"entries"),Y("type","==","Sleep"),Y("startTime",">=",j.fromDate(x)),Y("startTime","<=",j.fromDate(ht)),Tt("startTime","asc"));(await At(ct)).forEach(ne=>{const kt=ne.data();U.push({startTime:kt.startTime.toDate(),endTime:kt.endTime?kt.endTime.toDate():null})})}catch(ct){console.error("Error fetching post sleep entries:",ct)}const pt=new Date(I,g-1,y),st=new Date(p,$-1,rt),Ut=new Date(pt);for(;Ut<=st;){const ct=so(Ut);F+=ro(U,ct.start,ct.end),Ut.setDate(Ut.getDate()+1)}}const z=Math.floor(F/(1e3*60*60)),Q=Math.floor(F%(1e3*60*60)/(1e3*60));R+=`
                        <div class="stat-group">
                    ...
                    `,O=!0}if(R+="</div>",n===Ye&&O){C.innerHTML=R;const F=document.querySelector(".filter-section");F&&F.parentNode&&F.parentNode.insertBefore(C,t)}}}}catch{n===Ye&&(t.innerHTML='<p class="error">Failed to load timeline</p>')}finally{n===Ye&&(e.style.display="none")}}function ro(n,t,e){let r=0;for(const s of n){if(!s.endTime)continue;const o=Math.max(s.startTime.getTime(),t.getTime()),a=Math.min(s.endTime.getTime(),e.getTime());a>o&&(r+=a-o)}return r}function so(n){const t=new Date(n);t.setHours(0,0,0,0);const e=new Date(t);e.setDate(e.getDate()-1);const r=ut(`${el(e)}T19:00`),s=new Date(t);s.setDate(s.getDate()+1);const o=ut(`${el(s)}T07:00`);return{start:r,end:o}}function Vp(n){const t=Math.floor(n/36e5),e=Math.floor(n%(1e3*60*60)/(1e3*60));return`${t}h ${e}m`}async function ze(){const n=++Ne,t=document.getElementById("weekly-stats"),e=document.getElementById("weekly-loading"),r=document.getElementById("week-range"),s=document.getElementById("prev-week"),o=document.getElementById("next-week"),a=document.getElementById("current-week"),c=new Date(2025,10,5),h=hn(c),d=Xt(),m=hn(d),E=new Date(Qt);E.setHours(0,0,0,0),E<h&&(Qt=new Date(h)),E.getTime()<=h.getTime()?s.disabled=!0:s.disabled=!1,E.getTime()>=m.getTime()?o.disabled=!0:o.disabled=!1,a&&(E.getTime()===m.getTime()?(a.disabled=!0,a.style.backgroundColor="#999",a.style.color="#ccc",a.style.cursor="default"):(a.disabled=!1,a.style.backgroundColor="",a.style.color="",a.style.cursor="pointer"));const v=_p(Qt);r.textContent=`${yi(Qt).split(",")[1].trim()} - ${yi(v).split(",")[1].trim()}`,e.style.display="block",t.innerHTML="";try{const S=Et(yt(lt,"entries"),Y("startTime",">=",j.fromDate(Qt)),Y("startTime","<=",j.fromDate(v)),Tt("startTime","asc")),P=await At(S);if(n!==Ne)return;const k=new Date("2025-11-11");k.setHours(0,0,0,0);const C={},R=[];for(let L=0;L<7;L++){const x=new Date(Qt);if(x.setDate(x.getDate()+L),x.setHours(0,0,0,0),x>=k){const ht=`${x.getFullYear()}-${String(x.getMonth()+1).padStart(2,"0")}-${String(x.getDate()).padStart(2,"0")}`;R.push(ht)}}if(R.length>0){const L=await Promise.all(R.map(x=>Bc(_n(lt,"vitaminD",x))));R.forEach((x,ht)=>{var st;const pt=L[ht];C[x]=pt.exists()&&((st=pt.data())==null?void 0:st.given)===!0})}if(n!==Ne)return;const O=[];P.forEach(L=>{const x=L.data();x.type==="Sleep"&&O.push({startTime:x.startTime.toDate(),endTime:x.endTime?x.endTime.toDate():null})});const F=new Date(Qt);F.setDate(F.getDate()-1),F.setHours(0,0,0,0);const z=new Date(Qt);z.setHours(0,0,0,0);const Q=Et(yt(lt,"entries"),Y("type","==","Sleep"),Y("startTime",">=",j.fromDate(F)),Y("startTime","<",j.fromDate(z)),Tt("startTime","asc")),U=await At(Q);if(n!==Ne)return;U.forEach(L=>{const x=L.data();O.push({startTime:x.startTime.toDate(),endTime:x.endTime?x.endTime.toDate():null})});const I=new Date(v);I.setDate(I.getDate()+1),I.setHours(0,0,0,0);const g=new Date(I);g.setDate(g.getDate()+1),g.setHours(0,0,0,0);const y=Et(yt(lt,"entries"),Y("type","==","Sleep"),Y("startTime",">=",j.fromDate(I)),Y("startTime","<",j.fromDate(g)),Tt("startTime","asc")),T=await At(y);if(n!==Ne)return;T.forEach(L=>{const x=L.data();O.push({startTime:x.startTime.toDate(),endTime:x.endTime?x.endTime.toDate():null})});const _={};for(let L=0;L<7;L++){const x=new Date(Qt);x.setDate(x.getDate()+L),x.setHours(0,0,0,0);const ht=`${x.getFullYear()}-${x.getMonth()}-${x.getDate()}`,pt=`${x.getFullYear()}-${String(x.getMonth()+1).padStart(2,"0")}-${String(x.getDate()).padStart(2,"0")}`,st=so(x);_[ht]={date:new Date(x),vitaminD:x>=k?C[pt]===!0:null,bottles:{total:0,breastMilk:0,formula:0,sessions:0},diapers:{total:0,pee:0,poo:0,mixed:0},solids:{sessions:0},sleepMs:ro(O,st.start,st.end)}}P.forEach(L=>{const x=L.data(),ht=x.startTime.toDate(),pt=Rt(ht);pt.setHours(0,0,0,0);const st=`${pt.getFullYear()}-${pt.getMonth()}-${pt.getDate()}`;if(_[st])if(x.type==="Feed"){const Ut=nn(x.amount,x.unit);_[st].bottles.total+=Ut,_[st].bottles.sessions++,x.subType==="Breast Milk"?_[st].bottles.breastMilk+=Ut:x.subType==="Formula"&&(_[st].bottles.formula+=Ut)}else x.type==="Breast Feed"?_[st].bottles.sessions++:x.type==="Diaper"?(_[st].diapers.total++,x.diaperType==="Pee"?_[st].diapers.pee++:x.diaperType==="Poo"?_[st].diapers.poo++:x.diaperType==="Mixed"&&_[st].diapers.mixed++):x.type==="Solids"&&_[st].solids.sessions++});const w=Object.keys(_).map(L=>_[L]).sort((L,x)=>L.date.getTime()-x.date.getTime()),p=document.createElement("div");p.className="weekly-scroll-container";const $=Xt();$.setHours(0,0,0,0);let rt=-1;w.forEach((L,x)=>{const ht=document.createElement("div");ht.className="day-stats";const pt=new Date(L.date);pt.setHours(0,0,0,0),$.getTime()===pt.getTime()&&(ht.classList.add("current-day"),rt=x);const st=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"][L.date.getDay()],Ut=`${L.date.getMonth()+1}/${L.date.getDate()}`,ct=L.diapers.pee+L.diapers.mixed,ot=L.diapers.poo+L.diapers.mixed;let ne="";if(L.vitaminD!==null){const kt=L.vitaminD?"Yes":"No";ne=`
                    <div class="stat-group">
                        <div class="stat-group-title">Vitamin D</div>
                        <div class="stat-line" style="color: ${L.vitaminD?"#4caf50":"#f44336"}; font-weight: bold;">${kt}</div>
                    </div>
                `}ht.innerHTML=`
                ...
                <div class="stat-group">
                    <div class="stat-group-title">Feeds</div>
                    <div class="stat-line">Number of Feeds: ${L.bottles.sessions+L.solids.sessions}</div>
                    <div class="stat-line">Breast Milk: ${ye(L.bottles.breastMilk,"oz")}</div>
                    <div class="stat-line">Formula: ${ye(L.bottles.formula,"oz")}</div>
                    <div class="stat-line">Total Milk Volume: ${ye(L.bottles.total,"oz")}</div>
                    <div class="stat-line">Solid Sessions: ${L.solids.sessions}</div>
                </div>
                <div class="stat-group">
                    <div class="stat-group-title">Diapers</div>
