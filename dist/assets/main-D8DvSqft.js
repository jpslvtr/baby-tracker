 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vc="FirebaseError";class Ue extends Error{constructor(t,e,r){super(e),this.code=t,this.customData=r,this.name=Vc,Object.setPrototypeOf(this,Ue.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Ha.prototype.create)}}class Ha{constructor(t,e,r){this.service=t,this.serviceName=e,this.errors=r}create(t,...e){const r=e[0]||{},s=`${this.service}/${t}`,o=this.errors[t],a=o?kc(o,r):"Error",u=`${this.serviceName}: ${a} (${s}).`;return new Ue(s,u,r)}}function kc(n,t){return n.replace(Nc,(e,r)=>{const s=t[r];return s!=null?String(s):`<${r}?>`})}const Nc=/\{\$([^}]+)}/g;function Ds(n,t){if(n===t)return!0;const e=Object.keys(n),r=Object.keys(t);for(const s of e){if(!r.includes(s))return!1;const o=n[s],a=t[s];if(jo(o)&&jo(a)){if(!Ds(o,a))return!1}else if(o!==a)return!1}for(const s of r)if(!e.includes(s))return!1;return!0}function jo(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mc{constructor(t,e){this.name=t,this.container=e,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(t){const e=this.normalizeInstanceIdentifier(t);if(!this.instancesDeferred.has(e)){const r=new Ac;if(this.instancesDeferred.set(e,r),this.isInitialized(e)||this.shouldAutoInitialize())try{const s=this.getOrInitializeService({instanceIdentifier:e});s&&r.resolve(s)}catch{}}return this.instancesDeferred.get(e).promise}getImmediate(t){var e;const r=this.normalizeInstanceIdentifier(t==null?void 0:t.identifier),s=(e=t==null?void 0:t.optional)!==null&&e!==void 0?e:!1;if(this.isInitialized(r)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:r})}catch(o){if(s)return null;throw o}else{if(s)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(t){if(t.name!==this.name)throw Error(`Mismatching Component ${t.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=t,!!this.shouldAutoInitialize()){if(Lc(t))try{this.getOrInitializeService({instanceIdentifier:ue})}catch{}for(const[e,r]of this.instancesDeferred.entries()){const s=this.normalizeInstanceIdentifier(e);try{const o=this.getOrInitializeService({instanceIdentifier:s});r.resolve(o)}catch{}}}}clearInstance(t=ue){this.instancesDeferred.delete(t),this.instancesOptions.delete(t),this.instances.delete(t)}async delete(){const t=Array.from(this.instances.values());await Promise.all([...t.filter(e=>"INTERNAL"in e).map(e=>e.INTERNAL.delete()),...t.filter(e=>"_delete"in e).map(e=>e._delete())])}isComponentSet(){return this.component!=null}isInitialized(t=ue){return this.instances.has(t)}getOptions(t=ue){return this.instancesOptions.get(t)||{}}initialize(t={}){const{options:e={}}=t,r=this.normalizeInstanceIdentifier(t.instanceIdentifier);if(this.isInitialized(r))throw Error(`${this.name}(${r}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const s=this.getOrInitializeService({instanceIdentifier:r,options:e});for(const[o,a]of this.instancesDeferred.entries()){const u=this.normalizeInstanceIdentifier(o);r===u&&a.resolve(s)}return s}onInit(t,e){var r;const s=this.normalizeInstanceIdentifier(e),o=(r=this.onInitCallbacks.get(s))!==null&&r!==void 0?r:new Set;o.add(t),this.onInitCallbacks.set(s,o);const a=this.instances.get(s);return a&&t(a,s),()=>{o.delete(t)}}invokeOnInitCallbacks(t,e){const r=this.onInitCallbacks.get(e);if(r)for(const s of r)try{s(t,e)}catch{}}getOrInitializeService({instanceIdentifier:t,options:e={}}){let r=this.instances.get(t);if(!r&&this.component&&(r=this.component.instanceFactory(this.container,{instanceIdentifier:xc(t),options:e}),this.instances.set(t,r),this.instancesOptions.set(t,e),this.invokeOnInitCallbacks(r,t),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,t,r)}catch{}return r||null}normalizeInstanceIdentifier(t=ue){return this.component?this.component.multipleInstances?t:ue:t}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function xc(n){return n===ue?void 0:n}function Lc(n){return n.instantiationMode==="EAGER"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nh=Sh;function Qa(n,t={}){let e=n;typeof t!="object"&&(t={name:t});const r=Object.assign({name:Ns,automaticDataCollectionEnabled:!1},t),s=r.name;if(typeof s!="string"||!s)throw Yt.create("bad-app-name",{appName:String(s)});if(e||(e=za()),!e)throw Yt.create("no-options");const o=mr.get(s);if(o){if(Ds(e,o.options)&&Ds(r,o.config))return o;throw Yt.create("duplicate-app",{appName:s})}const a=new Oc(s);for(const h of Ms.values())a.addComponent(h);const u=new kh(e,r,a);return mr.set(s,u),u}function Mh(n=Ns){const t=mr.get(n);if(!t&&n===Ns&&za())return Qa();if(!t)throw Yt.create("no-app",{appName:n});return t}function Ce(n,t,e){var r;let s=(r=Ph[n])!==null&&r!==void 0?r:n;e&&(s+=`-${e}`);const o=s.match(/\s|\//),a=t.match(/\s|\//);if(o||a){const u=[`Unable to register library "${s}" with version "${t}":`];o&&u.push(`library name "${s}" contains illegal characters (whitespace or "/")`),o&&a&&u.push("and"),a&&u.push(`version name "${t}" contains illegal characters (whitespace or "/")`),$t.warn(u.join(" "));return}pr(new Tn(`${s}-version`,()=>({library:s,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jh(n){pr(new Tn("platform-logger",t=>new Zc(t),"PRIVATE")),pr(new Tn("heartbeat",t=>new Uh(t),"PRIVATE")),Ce(ks,Wo,n),Ce(ks,Wo,"esm2017"),Ce("fire-js","")}jh("");var zh="firebase",Hh="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Ce(zh,Hh,"app");var Jo=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var he,Ja;(function(){var n;/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function t(g,p){function y(){}y.prototype=p.prototype,g.D=p.prototype,g.prototype=new y,g.prototype.constructor=g,g.C=function(E,T,A){for(var _=Array(arguments.length-2),bt=2;bt<arguments.length;bt++)_[bt-2]=arguments[bt];return p.prototype[T].apply(E,_)}}function e(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}t(r,e),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(g,p,y){y||(y=0);var E=Array(16);if(typeof p=="string")for(var T=0;16>T;++T)E[T]=p.charCodeAt(y++)|p.charCodeAt(y++)<<8|p.charCodeAt(y++)<<16|p.charCodeAt(y++)<<24;else for(T=0;16>T;++T)E[T]=p[y++]|p[y++]<<8|p[y++]<<16|p[y++]<<24;p=g.g[0],y=g.g[1],T=g.g[2];var A=g.g[3],_=p+(A^y&(T^A))+E[0]+3614090360&4294967295;p=y+(_<<7&4294967295|_>>>25),_=A+(T^p&(y^T))+E[1]+3905402710&4294967295,A=p+(_<<12&4294967295|_>>>20),_=T+(y^A&(p^y))+E[2]+606105819&4294967295,T=A+(_<<17&4294967295|_>>>15),_=y+(p^T&(A^p))+E[3]+3250441966&4294967295,y=T+(_<<22&4294967295|_>>>10),_=p+(A^y&(T^A))+E[4]+4118548399&4294967295,p=y+(_<<7&4294967295|_>>>25),_=A+(T^p&(y^T))+E[5]+1200080426&4294967295,A=p+(_<<12&4294967295|_>>>20),_=T+(y^A&(p^y))+E[6]+2821735955&4294967295,T=A+(_<<17&4294967295|_>>>15),_=y+(p^T&(A^p))+E[7]+4249261313&4294967295,y=T+(_<<22&4294967295|_>>>10),_=p+(A^y&(T^A))+E[8]+1770035416&4294967295,p=y+(_<<7&4294967295|_>>>25),_=A+(T^p&(y^T))+E[9]+2336552879&4294967295,A=p+(_<<12&4294967295|_>>>20),_=T+(y^A&(p^y))+E[10]+4294925233&4294967295,T=A+(_<<17&4294967295|_>>>15),_=y+(p^T&(A^p))+E[11]+2304563134&4294967295,y=T+(_<<22&4294967295|_>>>10),_=p+(A^y&(T^A))+E[12]+1804603682&4294967295,p=y+(_<<7&4294967295|_>>>25),_=A+(T^p&(y^T))+E[13]+4254626195&4294967295,A=p+(_<<12&4294967295|_>>>20),_=T+(y^A&(p^y))+E[14]+2792965006&4294967295,T=A+(_<<17&4294967295|_>>>15),_=y+(p^T&(A^p))+E[15]+1236535329&4294967295,y=T+(_<<22&4294967295|_>>>10),_=p+(T^A&(y^T))+E[1]+4129170786&4294967295,p=y+(_<<5&4294967295|_>>>27),_=A+(y^T&(p^y))+E[6]+3225465664&4294967295,A=p+(_<<9&4294967295|_>>>23),_=T+(p^y&(A^p))+E[11]+643717713&4294967295,T=A+(_<<14&4294967295|_>>>18),_=y+(A^p&(T^A))+E[0]+3921069994&4294967295,y=T+(_<<20&4294967295|_>>>12),_=p+(T^A&(y^T))+E[5]+3593408605&4294967295,p=y+(_<<5&4294967295|_>>>27),_=A+(y^T&(p^y))+E[10]+38016083&4294967295,A=p+(_<<9&4294967295|_>>>23),_=T+(p^y&(A^p))+E[15]+3634488961&4294967295,T=A+(_<<14&4294967295|_>>>18),_=y+(A^p&(T^A))+E[4]+3889429448&4294967295,y=T+(_<<20&4294967295|_>>>12),_=p+(T^A&(y^T))+E[9]+568446438&4294967295,p=y+(_<<5&4294967295|_>>>27),_=A+(y^T&(p^y))+E[14]+3275163606&4294967295,A=p+(_<<9&4294967295|_>>>23),_=T+(p^y&(A^p))+E[3]+4107603335&4294967295,T=A+(_<<14&4294967295|_>>>18),_=y+(A^p&(T^A))+E[8]+1163531501&4294967295,y=T+(_<<20&4294967295|_>>>12),_=p+(T^A&(y^T))+E[13]+2850285829&4294967295,p=y+(_<<5&4294967295|_>>>27),_=A+(y^T&(p^y))+E[2]+4243563512&4294967295,A=p+(_<<9&4294967295|_>>>23),_=T+(p^y&(A^p))+E[7]+1735328473&4294967295,T=A+(_<<14&4294967295|_>>>18),_=y+(A^p&(T^A))+E[12]+2368359562&4294967295,y=T+(_<<20&4294967295|_>>>12),_=p+(y^T^A)+E[5]+4294588738&4294967295,p=y+(_<<4&4294967295|_>>>28),_=A+(p^y^T)+E[8]+2272392833&4294967295,A=p+(_<<11&4294967295|_>>>21),_=T+(A^p^y)+E[11]+1839030562&4294967295,T=A+(_<<16&4294967295|_>>>16),_=y+(T^A^p)+E[14]+4259657740&4294967295,y=T+(_<<23&4294967295|_>>>9),_=p+(y^T^A)+E[1]+2763975236&4294967295,p=y+(_<<4&4294967295|_>>>28),_=A+(p^y^T)+E[4]+1272893353&4294967295,A=p+(_<<11&4294967295|_>>>21),_=T+(A^p^y)+E[7]+4139469664&4294967295,T=A+(_<<16&4294967295|_>>>16),_=y+(T^A^p)+E[10]+3200236656&4294967295,y=T+(_<<23&4294967295|_>>>9),_=p+(y^T^A)+E[13]+681279174&4294967295,p=y+(_<<4&4294967295|_>>>28),_=A+(p^y^T)+E[0]+3936430074&4294967295,A=p+(_<<11&4294967295|_>>>21),_=T+(A^p^y)+E[3]+3572445317&4294967295,T=A+(_<<16&4294967295|_>>>16),_=y+(T^A^p)+E[6]+76029189&4294967295,y=T+(_<<23&4294967295|_>>>9),_=p+(y^T^A)+E[9]+3654602809&4294967295,p=y+(_<<4&4294967295|_>>>28),_=A+(p^y^T)+E[12]+3873151461&4294967295,A=p+(_<<11&4294967295|_>>>21),_=T+(A^p^y)+E[15]+530742520&4294967295,T=A+(_<<16&4294967295|_>>>16),_=y+(T^A^p)+E[2]+3299628645&4294967295,y=T+(_<<23&4294967295|_>>>9),_=p+(T^(y|~A))+E[0]+4096336452&4294967295,p=y+(_<<6&4294967295|_>>>26),_=A+(y^(p|~T))+E[7]+1126891415&4294967295,A=p+(_<<10&4294967295|_>>>22),_=T+(p^(A|~y))+E[14]+2878612391&4294967295,T=A+(_<<15&4294967295|_>>>17),_=y+(A^(T|~p))+E[5]+4237533241&4294967295,y=T+(_<<21&4294967295|_>>>11),_=p+(T^(y|~A))+E[12]+1700485571&4294967295,p=y+(_<<6&4294967295|_>>>26),_=A+(y^(p|~T))+E[3]+2399980690&4294967295,A=p+(_<<10&4294967295|_>>>22),_=T+(p^(A|~y))+E[10]+4293915773&4294967295,T=A+(_<<15&4294967295|_>>>17),_=y+(A^(T|~p))+E[1]+2240044497&4294967295,y=T+(_<<21&4294967295|_>>>11),_=p+(T^(y|~A))+E[8]+1873313359&4294967295,p=y+(_<<6&4294967295|_>>>26),_=A+(y^(p|~T))+E[15]+4264355552&4294967295,A=p+(_<<10&4294967295|_>>>22),_=T+(p^(A|~y))+E[6]+2734768916&4294967295,T=A+(_<<15&4294967295|_>>>17),_=y+(A^(T|~p))+E[13]+1309151649&4294967295,y=T+(_<<21&4294967295|_>>>11),_=p+(T^(y|~A))+E[4]+4149444226&4294967295,p=y+(_<<6&4294967295|_>>>26),_=A+(y^(p|~T))+E[11]+3174756917&4294967295,A=p+(_<<10&4294967295|_>>>22),_=T+(p^(A|~y))+E[2]+718787259&4294967295,T=A+(_<<15&4294967295|_>>>17),_=y+(A^(T|~p))+E[9]+3951481745&4294967295,g.g[0]=g.g[0]+p&4294967295,g.g[1]=g.g[1]+(T+(_<<21&4294967295|_>>>11))&4294967295,g.g[2]=g.g[2]+T&4294967295,g.g[3]=g.g[3]+A&4294967295}r.prototype.u=function(g,p){p===void 0&&(p=g.length);for(var y=p-this.blockSize,E=this.B,T=this.h,A=0;A<p;){if(T==0)for(;A<=y;)s(this,g,A),A+=this.blockSize;if(typeof g=="string"){for(;A<p;)if(E[T++]=g.charCodeAt(A++),T==this.blockSize){s(this,E),T=0;break}}else for(;A<p;)if(E[T++]=g[A++],T==this.blockSize){s(this,E),T=0;break}}this.h=T,this.o+=p},r.prototype.v=function(){var g=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);g[0]=128;for(var p=1;p<g.length-8;++p)g[p]=0;var y=8*this.o;for(p=g.length-8;p<g.length;++p)g[p]=y&255,y/=256;for(this.u(g),g=Array(16),p=y=0;4>p;++p)for(var E=0;32>E;E+=8)g[y++]=this.g[p]>>>E&255;return g};function o(g,p){var y=u;return Object.prototype.hasOwnProperty.call(y,g)?y[g]:y[g]=p(g)}function a(g,p){this.h=p;for(var y=[],E=!0,T=g.length-1;0<=T;T--){var A=g[T]|0;E&&A==p||(y[T]=A,E=!1)}this.g=y}var u={};function h(g){return-128<=g&&128>g?o(g,function(p){return new a([p|0],0>p?-1:0)}):new a([g|0],0>g?-1:0)}function d(g){if(isNaN(g)||!isFinite(g))return I;if(0>g)return D(d(-g));for(var p=[],y=1,E=0;g>=y;E++)p[E]=g/y|0,y*=4294967296;return new a(p,0)}function m(g,p){if(g.length==0)throw Error("number format error: empty string");if(p=p||10,2>p||36<p)throw Error("radix out of range: "+p);if(g.charAt(0)=="-")return D(m(g.substring(1),p));if(0<=g.indexOf("-"))throw Error('number format error: interior "-" character');for(var y=d(Math.pow(p,8)),E=I,T=0;T<g.length;T+=8){var A=Math.min(8,g.length-T),_=parseInt(g.substring(T,T+A),p);8>A?(A=d(Math.pow(p,A)),E=E.j(A).add(d(_))):(E=E.j(y),E=E.add(d(_)))}return E}var I=h(0),v=h(1),b=h(16777216);n=a.prototype,n.m=function(){if(N(this))return-D(this).m();for(var g=0,p=1,y=0;y<this.g.length;y++){var E=this.i(y);g+=(0<=E?E:4294967296+E)*p,p*=4294967296}return g},n.toString=function(g){if(g=g||10,2>g||36<g)throw Error("radix out of range: "+g);if(C(this))return"0";if(N(this))return"-"+D(this).toString(g);for(var p=d(Math.pow(g,6)),y=this,E="";;){var T=Z(y,p).g;y=O(y,T.j(p));var A=((0<y.g.length?y.g[0]:y.h)>>>0).toString(g);if(y=T,C(y))return A+E;for(;6>A.length;)A="0"+A;E=A+E}},n.i=function(g){return 0>g?0:g<this.g.length?this.g[g]:this.h};function C(g){if(g.h!=0)return!1;for(var p=0;p<g.g.length;p++)if(g.g[p]!=0)return!1;return!0}function N(g){return g.h==-1}n.l=function(g){return g=O(this,g),N(g)?-1:C(g)?0:1};function D(g){for(var p=g.g.length,y=[],E=0;E<p;E++)y[E]=~g.g[E];return new a(y,~g.h).add(v)}n.abs=function(){return N(this)?D(this):this},n.add=function(g){for(var p=Math.max(this.g.length,g.g.length),y=[],E=0,T=0;T<=p;T++){var A=E+(this.i(T)&65535)+(g.i(T)&65535),_=(A>>>16)+(this.i(T)>>>16)+(g.i(T)>>>16);E=_>>>16,A&=65535,_&=65535,y[T]=_<<16|A}return new a(y,y[y.length-1]&-2147483648?-1:0)};function O(g,p){return g.add(D(p))}n.j=function(g){if(C(this)||C(g))return I;if(N(this))return N(g)?D(this).j(D(g)):D(D(this).j(g));if(N(g))return D(this.j(D(g)));if(0>this.l(b)&&0>g.l(b))return d(this.m()*g.m());for(var p=this.g.length+g.g.length,y=[],E=0;E<2*p;E++)y[E]=0;for(E=0;E<this.g.length;E++)for(var T=0;T<g.g.length;T++){var A=this.i(E)>>>16,_=this.i(E)&65535,bt=g.i(T)>>>16,se=g.i(T)&65535;y[2*E+2*T]+=_*se,q(y,2*E+2*T),y[2*E+2*T+1]+=A*se,q(y,2*E+2*T+1),y[2*E+2*T+1]+=_*bt,q(y,2*E+2*T+1),y[2*E+2*T+2]+=A*bt,q(y,2*E+2*T+2)}for(E=0;E<p;E++)y[E]=y[2*E+1]<<16|y[2*E];for(E=p;E<2*p;E++)y[E]=0;return new a(y,0)};function q(g,p){for(;(g[p]&65535)!=g[p];)g[p+1]+=g[p]>>>16,g[p]&=65535,p++}function $(g,p){this.g=g,this.h=p}function Z(g,p){if(C(p))throw Error("division by zero");if(C(g))return new $(I,I);if(N(g))return p=Z(D(g),p),new $(D(p.g),D(p.h));if(N(p))return p=Z(g,D(p)),new $(D(p.g),p.h);if(30<g.g.length){if(N(g)||N(p))throw Error("slowDivide_ only works with positive integers.");for(var y=v,E=p;0>=E.l(g);)y=_t(y),E=_t(E);var T=x(y,1),A=x(E,1);for(E=x(E,2),y=x(y,2);!C(E);){var _=A.add(E);0>=_.l(g)&&(T=T.add(y),A=_),E=x(E,1),y=x(y,1)}return p=O(g,T.j(p)),new $(T,p)}for(T=I;0<=g.l(p);){for(y=Math.max(1,Math.floor(g.m()/p.m())),E=Math.ceil(Math.log(y)/Math.LN2),E=48>=E?1:Math.pow(2,E-48),A=d(y),_=A.j(p);N(_)||0<_.l(g);)y-=E,A=d(y),_=A.j(p);C(A)&&(A=v),T=T.add(A),g=O(g,_)}return new $(T,g)}n.A=function(g){return Z(this,g).h},n.and=function(g){for(var p=Math.max(this.g.length,g.g.length),y=[],E=0;E<p;E++)y[E]=this.i(E)&g.i(E);return new a(y,this.h&g.h)},n.or=function(g){for(var p=Math.max(this.g.length,g.g.length),y=[],E=0;E<p;E++)y[E]=this.i(E)|g.i(E);return new a(y,this.h|g.h)},n.xor=function(g){for(var p=Math.max(this.g.length,g.g.length),y=[],E=0;E<p;E++)y[E]=this.i(E)^g.i(E);return new a(y,this.h^g.h)};function _t(g){for(var p=g.g.length+1,y=[],E=0;E<p;E++)y[E]=g.i(E)<<1|g.i(E-1)>>>31;return new a(y,g.h)}function x(g,p){var y=p>>5;p%=32;for(var E=g.g.length-y,T=[],A=0;A<E;A++)T[A]=0<p?g.i(A+y)>>>p|g.i(A+y+1)<<32-p:g.i(A+y);return new a(T,g.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,Ja=r,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.A,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=d,a.fromString=m,he=a}).apply(typeof Jo<"u"?Jo:typeof self<"u"?self:typeof window<"u"?window:{});var rr=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var Za,dn,tl,lr,xs,el,nl,rl;(function(){var n,t=typeof Object.defineProperties=="function"?Object.defineProperty:function(i,l,c){return i==Array.prototype||i==Object.prototype||(i[l]=c.value),i};function e(i){i=[typeof globalThis=="object"&&globalThis,i,typeof window=="object"&&window,typeof self=="object"&&self,typeof rr=="object"&&rr];for(var l=0;l<i.length;++l){var c=i[l];if(c&&c.Math==Math)return c}throw Error("Cannot find global object")}var r=e(this);function s(i,l){if(l)t:{var c=r;i=i.split(".");for(var f=0;f<i.length-1;f++){var w=i[f];if(!(w in c))break t;c=c[w]}i=i[i.length-1],f=c[i],l=l(f),l!=f&&l!=null&&t(c,i,{configurable:!0,writable:!0,value:l})}}function o(i,l){i instanceof String&&(i+="");var c=0,f=!1,w={next:function(){if(!f&&c<i.length){var R=c++;return{value:l(R,i[R]),done:!1}}return f=!0,{done:!0,value:void 0}}};return w[Symbol.iterator]=function(){return w},w}s("Array.prototype.values",function(i){return i||function(){return o(this,function(l,c){return c})}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var a=a||{},u=this||self;function h(i){var l=typeof i;return l=l!="object"?l:i?Array.isArray(i)?"array":l:"null",l=="array"||l=="object"&&typeof i.length=="number"}function d(i){var l=typeof i;return l=="object"&&i!=null||l=="function"}function m(i,l,c){return i.call.apply(i.bind,arguments)}function I(i,l,c){if(!i)throw Error();if(2<arguments.length){var f=Array.prototype.slice.call(arguments,2);return function(){var w=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(w,f),i.apply(l,w)}}return function(){return i.apply(l,arguments)}}function v(i,l,c){return v=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?m:I,v.apply(null,arguments)}function b(i,l){var c=Array.prototype.slice.call(arguments,1);return function(){var f=c.slice();return f.push.apply(f,arguments),i.apply(this,f)}}function C(i,l){function c(){}c.prototype=l.prototype,i.aa=l.prototype,i.prototype=new c,i.prototype.constructor=i,i.Qb=function(f,w,R){for(var V=Array(arguments.length-2),Y=2;Y<arguments.length;Y++)V[Y-2]=arguments[Y];return l.prototype[w].apply(f,V)}}function N(i){const l=i.length;if(0<l){const c=Array(l);for(let f=0;f<l;f++)c[f]=i[f];return c}return[]}function D(i,l){for(let c=1;c<arguments.length;c++){const f=arguments[c];if(h(f)){const w=i.length||0,R=f.length||0;i.length=w+R;for(let V=0;V<R;V++)i[w+V]=f[V]}else i.push(f)}}class O{constructor(l,c){this.i=l,this.j=c,this.h=0,this.g=null}get(){let l;return 0<this.h?(this.h--,l=this.g,this.g=l.next,l.next=null):l=this.i(),l}}function q(i){return/^[\s\xa0]*$/.test(i)}function $(){var i=u.navigator;return i&&(i=i.userAgent)?i:""}function Z(i){return Z[" "](i),i}Z[" "]=function(){};var _t=$().indexOf("Gecko")!=-1&&!($().toLowerCase().indexOf("webkit")!=-1&&$().indexOf("Edge")==-1)&&!($().indexOf("Trident")!=-1||$().indexOf("MSIE")!=-1)&&$().indexOf("Edge")==-1;function x(i,l,c){for(const f in i)l.call(c,i[f],f,i)}function g(i,l){for(const c in i)l.call(void 0,i[c],c,i)}function p(i){const l={};for(const c in i)l[c]=i[c];return l}const y="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function E(i,l){let c,f;for(let w=1;w<arguments.length;w++){f=arguments[w];for(c in f)i[c]=f[c];for(let R=0;R<y.length;R++)c=y[R],Object.prototype.hasOwnProperty.call(f,c)&&(i[c]=f[c])}}function T(i){var l=1;i=i.split(":");const c=[];for(;0<l&&i.length;)c.push(i.shift()),l--;return i.length&&c.push(i.join(":")),c}function A(i){u.setTimeout(()=>{throw i},0)}function _(){var i=Hr;let l=null;return i.g&&(l=i.g,i.g=i.g.next,i.g||(i.h=null),l.next=null),l}class bt{constructor(){this.h=this.g=null}add(l,c){const f=se.get();f.set(l,c),this.h?this.h.next=f:this.g=f,this.h=f}}var se=new O(()=>new Ui,i=>i.reset());class Ui{constructor(){this.next=this.g=this.h=null}set(l,c){this.h=l,this.g=c,this.next=null}reset(){this.next=this.g=this.h=null}}let We,Ge=!1,Hr=new bt,$i=()=>{const i=u.Promise.resolve(void 0);We=()=>{i.then(Mu)}};var Mu=()=>{for(var i;i=_();){try{i.h.call(i.g)}catch(c){A(c)}var l=se;l.j(i),100>l.h&&(l.h++,i.next=l.g,l.g=i)}Ge=!1};function zt(){this.s=this.s,this.C=this.C}zt.prototype.s=!1,zt.prototype.ma=function(){this.s||(this.s=!0,this.N())},zt.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function ht(i,l){this.type=i,this.g=this.target=l,this.defaultPrevented=!1}ht.prototype.h=function(){this.defaultPrevented=!0};var xu=function(){if(!u.addEventListener||!Object.defineProperty)return!1;var i=!1,l=Object.defineProperty({},"passive",{get:function(){i=!0}});try{const c=()=>{};u.addEventListener("test",c,l),u.removeEventListener("test",c,l)}catch{}return i}();function Qe(i,l){if(ht.call(this,i?i.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,i){var c=this.type=i.type,f=i.changedTouches&&i.changedTouches.length?i.changedTouches[0]:null;if(this.target=i.target||i.srcElement,this.g=l,l=i.relatedTarget){if(_t){t:{try{Z(l.nodeName);var w=!0;break t}catch{}w=!1}w||(l=null)}}else c=="mouseover"?l=i.fromElement:c=="mouseout"&&(l=i.toElement);this.relatedTarget=l,f?(this.clientX=f.clientX!==void 0?f.clientX:f.pageX,this.clientY=f.clientY!==void 0?f.clientY:f.pageY,this.screenX=f.screenX||0,this.screenY=f.screenY||0):(this.clientX=i.clientX!==void 0?i.clientX:i.pageX,this.clientY=i.clientY!==void 0?i.clientY:i.pageY,this.screenX=i.screenX||0,this.screenY=i.screenY||0),this.button=i.button,this.key=i.key||"",this.ctrlKey=i.ctrlKey,this.altKey=i.altKey,this.shiftKey=i.shiftKey,this.metaKey=i.metaKey,this.pointerId=i.pointerId||0,this.pointerType=typeof i.pointerType=="string"?i.pointerType:Lu[i.pointerType]||"",this.state=i.state,this.i=i,i.defaultPrevented&&Qe.aa.h.call(this)}}C(Qe,ht);var Lu={2:"touch",3:"pen",4:"mouse"};Qe.prototype.h=function(){Qe.aa.h.call(this);var i=this.i;i.preventDefault?i.preventDefault():i.returnValue=!1};var Bn="closure_listenable_"+(1e6*Math.random()|0),Ou=0;function Bu(i,l,c,f,w){this.listener=i,this.proxy=null,this.src=l,this.type=c,this.capture=!!f,this.ha=w,this.key=++Ou,this.da=this.fa=!1}function Fn(i){i.da=!0,i.listener=null,i.proxy=null,i.src=null,i.ha=null}function Un(i){this.src=i,this.g={},this.h=0}Un.prototype.add=function(i,l,c,f,w){var R=i.toString();i=this.g[R],i||(i=this.g[R]=[],this.h++);var V=Wr(i,l,f,w);return-1<V?(l=i[V],c||(l.fa=!1)):(l=new Bu(l,this.src,R,!!f,w),l.fa=c,i.push(l)),l};function Kr(i,l){var c=l.type;if(c in i.g){var f=i.g[c],w=Array.prototype.indexOf.call(f,l,void 0),R;(R=0<=w)&&Array.prototype.splice.call(f,w,1),R&&(Fn(l),i.g[c].length==0&&(delete i.g[c],i.h--))}}function Wr(i,l,c,f){for(var w=0;w<i.length;++w){var R=i[w];if(!R.da&&R.listener==l&&R.capture==!!c&&R.ha==f)return w}return-1}var Gr="closure_lm_"+(1e6*Math.random()|0),Qr={};function qi(i,l,c,f,w){if(Array.isArray(l)){for(var R=0;R<l.length;R++)qi(i,l[R],c,f,w);return null}return c=Hi(c),i&&i[Bn]?i.K(l,c,d(f)?!!f.capture:!1,w):Fu(i,l,c,!1,f,w)}function Fu(i,l,c,f,w,R){if(!l)throw Error("Invalid event type");var V=d(w)?!!w.capture:!!w,Y=Xr(i);if(Y||(i[Gr]=Y=new Un(i)),c=Y.add(l,c,f,V,R),c.proxy)return c;if(f=Uu(),c.proxy=f,f.src=i,f.listener=c,i.addEventListener)xu||(w=V),w===void 0&&(w=!1),i.addEventListener(l.toString(),f,w);else if(i.attachEvent)i.attachEvent(zi(l.toString()),f);else if(i.addListener&&i.removeListener)i.addListener(f);else throw Error("addEventListener and attachEvent are unavailable.");return c}function Uu(){function i(c){return l.call(i.src,i.listener,c)}const l=$u;return i}function ji(i,l,c,f,w){if(Array.isArray(l))for(var R=0;R<l.length;R++)ji(i,l[R],c,f,w);else f=d(f)?!!f.capture:!!f,c=Hi(c),i&&i[Bn]?(i=i.i,l=String(l).toString(),l in i.g&&(R=i.g[l],c=Wr(R,c,f,w),-1<c&&(Fn(R[c]),Array.prototype.splice.call(R,c,1),R.length==0&&(delete i.g[l],i.h--)))):i&&(i=Xr(i))&&(l=i.g[l.toString()],i=-1,l&&(i=Wr(l,c,f,w)),(c=-1<i?l[i]:null)&&Yr(c))}function Yr(i){if(typeof i!="number"&&i&&!i.da){var l=i.src;if(l&&l[Bn])Kr(l.i,i);else{var c=i.type,f=i.proxy;l.removeEventListener?l.removeEventListener(c,f,i.capture):l.detachEvent?l.detachEvent(zi(c),f):l.addListener&&l.removeListener&&l.removeListener(f),(c=Xr(l))?(Kr(c,i),c.h==0&&(c.src=null,l[Gr]=null)):Fn(i)}}}function zi(i){return i in Qr?Qr[i]:Qr[i]="on"+i}function $u(i,l){if(i.da)i=!0;else{l=new Qe(l,this);var c=i.listener,f=i.ha||i.src;i.fa&&Yr(i),i=c.call(f,l)}return i}function Xr(i){return i=i[Gr],i instanceof Un?i:null}var Jr="__closure_events_fn_"+(1e9*Math.random()>>>0);function Hi(i){return typeof i=="function"?i:(i[Jr]||(i[Jr]=function(l){return i.handleEvent(l)}),i[Jr])}function dt(){zt.call(this),this.i=new Un(this),this.M=this,this.F=null}C(dt,zt),dt.prototype[Bn]=!0,dt.prototype.removeEventListener=function(i,l,c,f){ji(this,i,l,c,f)};function Et(i,l){var c,f=i.F;if(f)for(c=[];f;f=f.F)c.push(f);if(i=i.M,f=l.type||l,typeof l=="string")l=new ht(l,i);else if(l instanceof ht)l.target=l.target||i;else{var w=l;l=new ht(f,i),E(l,w)}if(w=!0,c)for(var R=c.length-1;0<=R;R--){var V=l.g=c[R];w=$n(V,f,!0,l)&&w}if(V=l.g=i,w=$n(V,f,!0,l)&&w,w=$n(V,f,!1,l)&&w,c)for(R=0;R<c.length;R++)V=l.g=c[R],w=$n(V,f,!1,l)&&w}dt.prototype.N=function(){if(dt.aa.N.call(this),this.i){var i=this.i,l;for(l in i.g){for(var c=i.g[l],f=0;f<c.length;f++)Fn(c[f]);delete i.g[l],i.h--}}this.F=null},dt.prototype.K=function(i,l,c,f){return this.i.add(String(i),l,!1,c,f)},dt.prototype.L=function(i,l,c,f){return this.i.add(String(i),l,!0,c,f)};function $n(i,l,c,f){if(l=i.i.g[String(l)],!l)return!0;l=l.concat();for(var w=!0,R=0;R<l.length;++R){var V=l[R];if(V&&!V.da&&V.capture==c){var Y=V.listener,ot=V.ha||V.src;V.fa&&Kr(i.i,V),w=Y.call(ot,f)!==!1&&w}}return w&&!f.defaultPrevented}function Ki(i,l,c){if(typeof i=="function")c&&(i=v(i,c));else if(i&&typeof i.handleEvent=="function")i=v(i.handleEvent,i);else throw Error("Invalid listener argument");return 2147483647<Number(l)?-1:u.setTimeout(i,l||0)}function Wi(i){i.g=Ki(()=>{i.g=null,i.i&&(i.i=!1,Wi(i))},i.l);const l=i.h;i.h=null,i.m.apply(null,l)}class qu extends zt{constructor(l,c){super(),this.m=l,this.l=c,this.h=null,this.i=!1,this.g=null}j(l){this.h=arguments,this.g?this.i=!0:Wi(this)}N(){super.N(),this.g&&(u.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Ye(i){zt.call(this),this.h=i,this.g={}}C(Ye,zt);var Gi=[];function Qi(i){x(i.g,function(l,c){this.g.hasOwnProperty(c)&&Yr(l)},i),i.g={}}Ye.prototype.N=function(){Ye.aa.N.call(this),Qi(this)},Ye.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Zr=u.JSON.stringify,ju=u.JSON.parse,zu=class{stringify(i){return u.JSON.stringify(i,void 0)}parse(i){return u.JSON.parse(i,void 0)}};function ts(){}ts.prototype.h=null;function Yi(i){return i.h||(i.h=i.i())}function Xi(){}var Xe={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function es(){ht.call(this,"d")}C(es,ht);function ns(){ht.call(this,"c")}C(ns,ht);var ie={},Ji=null;function qn(){return Ji=Ji||new dt}ie.La="serverreachability";function Zi(i){ht.call(this,ie.La,i)}C(Zi,ht);function Je(i){const l=qn();Et(l,new Zi(l))}ie.STAT_EVENT="statevent";function to(i,l){ht.call(this,ie.STAT_EVENT,i),this.stat=l}C(to,ht);function vt(i){const l=qn();Et(l,new to(l,i))}ie.Ma="timingevent";function eo(i,l){ht.call(this,ie.Ma,i),this.size=l}C(eo,ht);function Ze(i,l){if(typeof i!="function")throw Error("Fn must not be null and must be a function");return u.setTimeout(function(){i()},l)}function tn(){this.g=!0}tn.prototype.xa=function(){this.g=!1};function Hu(i,l,c,f,w,R){i.info(function(){if(i.g)if(R)for(var V="",Y=R.split("&"),ot=0;ot<Y.length;ot++){var K=Y[ot].split("=");if(1<K.length){var ft=K[0];K=K[1];var mt=ft.split("_");V=2<=mt.length&&mt[1]=="type"?V+(ft+"="+K+"&"):V+(ft+"=redacted&")}}else V=null;else V=R;return"XMLHTTP REQ ("+f+") [attempt "+w+"]: "+l+`
`+c+`
`+V})}function Ku(i,l,c,f,w,R,V){i.info(function(){return"XMLHTTP RESP ("+f+") [ attempt "+w+"]: "+l+`
`+c+`
`+R+" "+V})}function Ie(i,l,c,f){i.info(function(){return"XMLHTTP TEXT ("+l+"): "+Gu(i,c)+(f?" "+f:"")})}function Wu(i,l){i.info(function(){return"TIMEOUT: "+l})}tn.prototype.info=function(){};function Gu(i,l){if(!i.g)return l;if(!l)return null;try{var c=JSON.parse(l);if(c){for(i=0;i<c.length;i++)if(Array.isArray(c[i])){var f=c[i];if(!(2>f.length)){var w=f[1];if(Array.isArray(w)&&!(1>w.length)){var R=w[0];if(R!="noop"&&R!="stop"&&R!="close")for(var V=1;V<w.length;V++)w[V]=""}}}}return Zr(c)}catch{return l}}var jn={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},no={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},rs;function zn(){}C(zn,ts),zn.prototype.g=function(){return new XMLHttpRequest},zn.prototype.i=function(){return{}},rs=new zn;function Ht(i,l,c,f){this.j=i,this.i=l,this.l=c,this.R=f||1,this.U=new Ye(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new ro}function ro(){this.i=null,this.g="",this.h=!1}var so={},ss={};function is(i,l,c){i.L=1,i.v=Gn(Ot(l)),i.m=c,i.P=!0,io(i,null)}function io(i,l){i.F=Date.now(),Hn(i),i.A=Ot(i.v);var c=i.A,f=i.R;Array.isArray(f)||(f=[String(f)]),vo(c.i,"t",f),i.C=0,c=i.j.J,i.h=new ro,i.g=Bo(i.j,c?l:null,!i.m),0<i.O&&(i.M=new qu(v(i.Y,i,i.g),i.O)),l=i.U,c=i.g,f=i.ca;var w="readystatechange";Array.isArray(w)||(w&&(Gi[0]=w.toString()),w=Gi);for(var R=0;R<w.length;R++){var V=qi(c,w[R],f||l.handleEvent,!1,l.h||l);if(!V)break;l.g[V.key]=V}l=i.H?p(i.H):{},i.m?(i.u||(i.u="POST"),l["Content-Type"]="application/x-www-form-urlencoded",i.g.ea(i.A,i.u,i.m,l)):(i.u="GET",i.g.ea(i.A,i.u,null,l)),Je(),Hu(i.i,i.u,i.A,i.l,i.R,i.m)}Ht.prototype.ca=function(i){i=i.target;const l=this.M;l&&Bt(i)==3?l.j():this.Y(i)},Ht.prototype.Y=function(i){try{if(i==this.g)t:{const mt=Bt(this.g);var l=this.g.Ba();const Re=this.g.Z();if(!(3>mt)&&(mt!=3||this.g&&(this.h.h||this.g.oa()||So(this.g)))){this.J||mt!=4||l==7||(l==8||0>=Re?Je(3):Je(2)),os(this);var c=this.g.Z();this.X=c;e:if(oo(this)){var f=So(this.g);i="";var w=f.length,R=Bt(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){oe(this),en(this);var V="";break e}this.h.i=new u.TextDecoder}for(l=0;l<w;l++)this.h.h=!0,i+=this.h.i.decode(f[l],{stream:!(R&&l==w-1)});f.length=0,this.h.g+=i,this.C=0,V=this.h.g}else V=this.g.oa();if(this.o=c==200,Ku(this.i,this.u,this.A,this.l,this.R,mt,c),this.o){if(this.T&&!this.K){e:{if(this.g){var Y,ot=this.g;if((Y=ot.g?ot.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!q(Y)){var K=Y;break e}}K=null}if(c=K)Ie(this.i,this.l,c,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,as(this,c);else{this.o=!1,this.s=3,vt(12),oe(this),en(this);break t}}if(this.P){c=!0;let Pt;for(;!this.J&&this.C<V.length;)if(Pt=Qu(this,V),Pt==ss){mt==4&&(this.s=4,vt(14),c=!1),Ie(this.i,this.l,null,"[Incomplete Response]");break}else if(Pt==so){this.s=4,vt(15),Ie(this.i,this.l,V,"[Invalid Chunk]"),c=!1;break}else Ie(this.i,this.l,Pt,null),as(this,Pt);if(oo(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),mt!=4||V.length!=0||this.h.h||(this.s=1,vt(16),c=!1),this.o=this.o&&c,!c)Ie(this.i,this.l,V,"[Invalid Chunked Response]"),oe(this),en(this);else if(0<V.length&&!this.W){this.W=!0;var ft=this.j;ft.g==this&&ft.ba&&!ft.M&&(ft.j.info("Great, no buffering proxy detected. Bytes received: "+V.length),fs(ft),ft.M=!0,vt(11))}}else Ie(this.i,this.l,V,null),as(this,V);mt==4&&oe(this),this.o&&!this.J&&(mt==4?Mo(this.j,this):(this.o=!1,Hn(this)))}else dc(this.g),c==400&&0<V.indexOf("Unknown SID")?(this.s=3,vt(12)):(this.s=0,vt(13)),oe(this),en(this)}}}catch{}finally{}};function oo(i){return i.g?i.u=="GET"&&i.L!=2&&i.j.Ca:!1}function Qu(i,l){var c=i.C,f=l.indexOf(`
`,c);return f==-1?ss:(c=Number(l.substring(c,f)),isNaN(c)?so:(f+=1,f+c>l.length?ss:(l=l.slice(f,f+c),i.C=f+c,l)))}Ht.prototype.cancel=function(){this.J=!0,oe(this)};function Hn(i){i.S=Date.now()+i.I,ao(i,i.I)}function ao(i,l){if(i.B!=null)throw Error("WatchDog timer not null");i.B=Ze(v(i.ba,i),l)}function os(i){i.B&&(u.clearTimeout(i.B),i.B=null)}Ht.prototype.ba=function(){this.B=null;const i=Date.now();0<=i-this.S?(Wu(this.i,this.A),this.L!=2&&(Je(),vt(17)),oe(this),this.s=2,en(this)):ao(this,this.S-i)};function en(i){i.j.G==0||i.J||Mo(i.j,i)}function oe(i){os(i);var l=i.M;l&&typeof l.ma=="function"&&l.ma(),i.M=null,Qi(i.U),i.g&&(l=i.g,i.g=null,l.abort(),l.ma())}function as(i,l){try{var c=i.j;if(c.G!=0&&(c.g==i||ls(c.h,i))){if(!i.K&&ls(c.h,i)&&c.G==3){try{var f=c.Da.g.parse(l)}catch{f=null}if(Array.isArray(f)&&f.length==3){var w=f;if(w[0]==0){t:if(!c.u){if(c.g)if(c.g.F+3e3<i.F)tr(c),Jn(c);else break t;ds(c),vt(18)}}else c.za=w[1],0<c.za-c.T&&37500>w[2]&&c.F&&c.v==0&&!c.C&&(c.C=Ze(v(c.Za,c),6e3));if(1>=co(c.h)&&c.ca){try{c.ca()}catch{}c.ca=void 0}}else le(c,11)}else if((i.K||c.g==i)&&tr(c),!q(l))for(w=c.Da.g.parse(l),l=0;l<w.length;l++){let K=w[l];if(c.T=K[0],K=K[1],c.G==2)if(K[0]=="c"){c.K=K[1],c.ia=K[2];const ft=K[3];ft!=null&&(c.la=ft,c.j.info("VER="+c.la));const mt=K[4];mt!=null&&(c.Aa=mt,c.j.info("SVER="+c.Aa));const Re=K[5];Re!=null&&typeof Re=="number"&&0<Re&&(f=1.5*Re,c.L=f,c.j.info("backChannelRequestTimeoutMs_="+f)),f=c;const Pt=i.g;if(Pt){const nr=Pt.g?Pt.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(nr){var R=f.h;R.g||nr.indexOf("spdy")==-1&&nr.indexOf("quic")==-1&&nr.indexOf("h2")==-1||(R.j=R.l,R.g=new Set,R.h&&(us(R,R.h),R.h=null))}if(f.D){const ms=Pt.g?Pt.g.getResponseHeader("X-HTTP-Session-Id"):null;ms&&(f.ya=ms,X(f.I,f.D,ms))}}c.G=3,c.l&&c.l.ua(),c.ba&&(c.R=Date.now()-i.F,c.j.info("Handshake RTT: "+c.R+"ms")),f=c;var V=i;if(f.qa=Oo(f,f.J?f.ia:null,f.W),V.K){ho(f.h,V);var Y=V,ot=f.L;ot&&(Y.I=ot),Y.B&&(os(Y),Hn(Y)),f.g=V}else ko(f);0<c.i.length&&Zn(c)}else K[0]!="stop"&&K[0]!="close"||le(c,7);else c.G==3&&(K[0]=="stop"||K[0]=="close"?K[0]=="stop"?le(c,7):hs(c):K[0]!="noop"&&c.l&&c.l.ta(K),c.v=0)}}Je(4)}catch{}}var Yu=class{constructor(i,l){this.g=i,this.map=l}};function lo(i){this.l=i||10,u.PerformanceNavigationTiming?(i=u.performance.getEntriesByType("navigation"),i=0<i.length&&(i[0].nextHopProtocol=="hq"||i[0].nextHopProtocol=="h2")):i=!!(u.chrome&&u.chrome.loadTimes&&u.chrome.loadTimes()&&u.chrome.loadTimes().wasFetchedViaSpdy),this.j=i?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function uo(i){return i.h?!0:i.g?i.g.size>=i.j:!1}function co(i){return i.h?1:i.g?i.g.size:0}function ls(i,l){return i.h?i.h==l:i.g?i.g.has(l):!1}function us(i,l){i.g?i.g.add(l):i.h=l}function ho(i,l){i.h&&i.h==l?i.h=null:i.g&&i.g.has(l)&&i.g.delete(l)}lo.prototype.cancel=function(){if(this.i=fo(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const i of this.g.values())i.cancel();this.g.clear()}};function fo(i){if(i.h!=null)return i.i.concat(i.h.D);if(i.g!=null&&i.g.size!==0){let l=i.i;for(const c of i.g.values())l=l.concat(c.D);return l}return N(i.i)}function Xu(i){if(i.V&&typeof i.V=="function")return i.V();if(typeof Map<"u"&&i instanceof Map||typeof Set<"u"&&i instanceof Set)return Array.from(i.values());if(typeof i=="string")return i.split("");if(h(i)){for(var l=[],c=i.length,f=0;f<c;f++)l.push(i[f]);return l}l=[],c=0;for(f in i)l[c++]=i[f];return l}function Ju(i){if(i.na&&typeof i.na=="function")return i.na();if(!i.V||typeof i.V!="function"){if(typeof Map<"u"&&i instanceof Map)return Array.from(i.keys());if(!(typeof Set<"u"&&i instanceof Set)){if(h(i)||typeof i=="string"){var l=[];i=i.length;for(var c=0;c<i;c++)l.push(c);return l}l=[],c=0;for(const f in i)l[c++]=f;return l}}}function mo(i,l){if(i.forEach&&typeof i.forEach=="function")i.forEach(l,void 0);else if(h(i)||typeof i=="string")Array.prototype.forEach.call(i,l,void 0);else for(var c=Ju(i),f=Xu(i),w=f.length,R=0;R<w;R++)l.call(void 0,f[R],c&&c[R],i)}var po=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Zu(i,l){if(i){i=i.split("&");for(var c=0;c<i.length;c++){var f=i[c].indexOf("="),w=null;if(0<=f){var R=i[c].substring(0,f);w=i[c].substring(f+1)}else R=i[c];l(R,w?decodeURIComponent(w.replace(/\+/g," ")):"")}}}function ae(i){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,i instanceof ae){this.h=i.h,Kn(this,i.j),this.o=i.o,this.g=i.g,Wn(this,i.s),this.l=i.l;var l=i.i,c=new sn;c.i=l.i,l.g&&(c.g=new Map(l.g),c.h=l.h),go(this,c),this.m=i.m}else i&&(l=String(i).match(po))?(this.h=!1,Kn(this,l[1]||"",!0),this.o=nn(l[2]||""),this.g=nn(l[3]||"",!0),Wn(this,l[4]),this.l=nn(l[5]||"",!0),go(this,l[6]||"",!0),this.m=nn(l[7]||"")):(this.h=!1,this.i=new sn(null,this.h))}ae.prototype.toString=function(){var i=[],l=this.j;l&&i.push(rn(l,yo,!0),":");var c=this.g;return(c||l=="file")&&(i.push("//"),(l=this.o)&&i.push(rn(l,yo,!0),"@"),i.push(encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),c=this.s,c!=null&&i.push(":",String(c))),(c=this.l)&&(this.g&&c.charAt(0)!="/"&&i.push("/"),i.push(rn(c,c.charAt(0)=="/"?nc:ec,!0))),(c=this.i.toString())&&i.push("?",c),(c=this.m)&&i.push("#",rn(c,sc)),i.join("")};function Ot(i){return new ae(i)}function Kn(i,l,c){i.j=c?nn(l,!0):l,i.j&&(i.j=i.j.replace(/:$/,""))}function Wn(i,l){if(l){if(l=Number(l),isNaN(l)||0>l)throw Error("Bad port number "+l);i.s=l}else i.s=null}function go(i,l,c){l instanceof sn?(i.i=l,ic(i.i,i.h)):(c||(l=rn(l,rc)),i.i=new sn(l,i.h))}function X(i,l,c){i.i.set(l,c)}function Gn(i){return X(i,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),i}function nn(i,l){return i?l?decodeURI(i.replace(/%25/g,"%2525")):decodeURIComponent(i):""}function rn(i,l,c){return typeof i=="string"?(i=encodeURI(i).replace(l,tc),c&&(i=i.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),i):null}function tc(i){return i=i.charCodeAt(0),"%"+(i>>4&15).toString(16)+(i&15).toString(16)}var yo=/[#\/\?@]/g,ec=/[#\?:]/g,nc=/[#\?]/g,rc=/[#\?@]/g,sc=/#/g;function sn(i,l){this.h=this.g=null,this.i=i||null,this.j=!!l}function Kt(i){i.g||(i.g=new Map,i.h=0,i.i&&Zu(i.i,function(l,c){i.add(decodeURIComponent(l.replace(/\+/g," ")),c)}))}n=sn.prototype,n.add=function(i,l){Kt(this),this.i=null,i=we(this,i);var c=this.g.get(i);return c||this.g.set(i,c=[]),c.push(l),this.h+=1,this};function _o(i,l){Kt(i),l=we(i,l),i.g.has(l)&&(i.i=null,i.h-=i.g.get(l).length,i.g.delete(l))}function Eo(i,l){return Kt(i),l=we(i,l),i.g.has(l)}n.forEach=function(i,l){Kt(this),this.g.forEach(function(c,f){c.forEach(function(w){i.call(l,w,f,this)},this)},this)},n.na=function(){Kt(this);const i=Array.from(this.g.values()),l=Array.from(this.g.keys()),c=[];for(let f=0;f<l.length;f++){const w=i[f];for(let R=0;R<w.length;R++)c.push(l[f])}return c},n.V=function(i){Kt(this);let l=[];if(typeof i=="string")Eo(this,i)&&(l=l.concat(this.g.get(we(this,i))));else{i=Array.from(this.g.values());for(let c=0;c<i.length;c++)l=l.concat(i[c])}return l},n.set=function(i,l){return Kt(this),this.i=null,i=we(this,i),Eo(this,i)&&(this.h-=this.g.get(i).length),this.g.set(i,[l]),this.h+=1,this},n.get=function(i,l){return i?(i=this.V(i),0<i.length?String(i[0]):l):l};function vo(i,l,c){_o(i,l),0<c.length&&(i.i=null,i.g.set(we(i,l),N(c)),i.h+=c.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const i=[],l=Array.from(this.g.keys());for(var c=0;c<l.length;c++){var f=l[c];const R=encodeURIComponent(String(f)),V=this.V(f);for(f=0;f<V.length;f++){var w=R;V[f]!==""&&(w+="="+encodeURIComponent(String(V[f]))),i.push(w)}}return this.i=i.join("&")};function we(i,l){return l=String(l),i.j&&(l=l.toLowerCase()),l}function ic(i,l){l&&!i.j&&(Kt(i),i.i=null,i.g.forEach(function(c,f){var w=f.toLowerCase();f!=w&&(_o(this,f),vo(this,w,c))},i)),i.j=l}function oc(i,l){const c=new tn;if(u.Image){const f=new Image;f.onload=b(Wt,c,"TestLoadImage: loaded",!0,l,f),f.onerror=b(Wt,c,"TestLoadImage: error",!1,l,f),f.onabort=b(Wt,c,"TestLoadImage: abort",!1,l,f),f.ontimeout=b(Wt,c,"TestLoadImage: timeout",!1,l,f),u.setTimeout(function(){f.ontimeout&&f.ontimeout()},1e4),f.src=i}else l(!1)}function ac(i,l){const c=new tn,f=new AbortController,w=setTimeout(()=>{f.abort(),Wt(c,"TestPingServer: timeout",!1,l)},1e4);fetch(i,{signal:f.signal}).then(R=>{clearTimeout(w),R.ok?Wt(c,"TestPingServer: ok",!0,l):Wt(c,"TestPingServer: server error",!1,l)}).catch(()=>{clearTimeout(w),Wt(c,"TestPingServer: error",!1,l)})}function Wt(i,l,c,f,w){try{w&&(w.onload=null,w.onerror=null,w.onabort=null,w.ontimeout=null),f(c)}catch{}}function lc(){this.g=new zu}function uc(i,l,c){const f=c||"";try{mo(i,function(w,R){let V=w;d(w)&&(V=Zr(w)),l.push(f+R+"="+encodeURIComponent(V))})}catch(w){throw l.push(f+"type="+encodeURIComponent("_badmap")),w}}function Qn(i){this.l=i.Ub||null,this.j=i.eb||!1}C(Qn,ts),Qn.prototype.g=function(){return new Yn(this.l,this.j)},Qn.prototype.i=function(i){return function(){return i}}({});function Yn(i,l){dt.call(this),this.D=i,this.o=l,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}C(Yn,dt),n=Yn.prototype,n.open=function(i,l){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=i,this.A=l,this.readyState=1,an(this)},n.send=function(i){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const l={headers:this.u,method:this.B,credentials:this.m,cache:void 0};i&&(l.body=i),(this.D||u).fetch(new Request(this.A,l)).then(this.Sa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,on(this)),this.readyState=0},n.Sa=function(i){if(this.g&&(this.l=i,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=i.headers,this.readyState=2,an(this)),this.g&&(this.readyState=3,an(this),this.g)))if(this.responseType==="arraybuffer")i.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof u.ReadableStream<"u"&&"body"in i){if(this.j=i.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;To(this)}else i.text().then(this.Ra.bind(this),this.ga.bind(this))};function To(i){i.j.read().then(i.Pa.bind(i)).catch(i.ga.bind(i))}n.Pa=function(i){if(this.g){if(this.o&&i.value)this.response.push(i.value);else if(!this.o){var l=i.value?i.value:new Uint8Array(0);(l=this.v.decode(l,{stream:!i.done}))&&(this.response=this.responseText+=l)}i.done?on(this):an(this),this.readyState==3&&To(this)}},n.Ra=function(i){this.g&&(this.response=this.responseText=i,on(this))},n.Qa=function(i){this.g&&(this.response=i,on(this))},n.ga=function(){this.g&&on(this)};function on(i){i.readyState=4,i.l=null,i.j=null,i.v=null,an(i)}n.setRequestHeader=function(i,l){this.u.append(i,l)},n.getResponseHeader=function(i){return this.h&&this.h.get(i.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const i=[],l=this.h.entries();for(var c=l.next();!c.done;)c=c.value,i.push(c[0]+": "+c[1]),c=l.next();return i.join(`\r
`)};function an(i){i.onreadystatechange&&i.onreadystatechange.call(i)}Object.defineProperty(Yn.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(i){this.m=i?"include":"same-origin"}});function Io(i){let l="";return x(i,function(c,f){l+=f,l+=":",l+=c,l+=`\r
`}),l}function cs(i,l,c){t:{for(f in c){var f=!1;break t}f=!0}f||(c=Io(c),typeof i=="string"?c!=null&&encodeURIComponent(String(c)):X(i,l,c))}function et(i){dt.call(this),this.headers=new Map,this.o=i||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}C(et,dt);var cc=/^https?$/i,hc=["POST","PUT"];n=et.prototype,n.Ha=function(i){this.J=i},n.ea=function(i,l,c,f){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+i);l=l?l.toUpperCase():"GET",this.D=i,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():rs.g(),this.v=this.o?Yi(this.o):Yi(rs),this.g.onreadystatechange=v(this.Ea,this);try{this.B=!0,this.g.open(l,String(i),!0),this.B=!1}catch(R){wo(this,R);return}if(i=c||"",c=new Map(this.headers),f)if(Object.getPrototypeOf(f)===Object.prototype)for(var w in f)c.set(w,f[w]);else if(typeof f.keys=="function"&&typeof f.get=="function")for(const R of f.keys())c.set(R,f.get(R));else throw Error("Unknown input type for opt_headers: "+String(f));f=Array.from(c.keys()).find(R=>R.toLowerCase()=="content-type"),w=u.FormData&&i instanceof u.FormData,!(0<=Array.prototype.indexOf.call(hc,l,void 0))||f||w||c.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[R,V]of c)this.g.setRequestHeader(R,V);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{bo(this),this.u=!0,this.g.send(i),this.u=!1}catch(R){wo(this,R)}};function wo(i,l){i.h=!1,i.g&&(i.j=!0,i.g.abort(),i.j=!1),i.l=l,i.m=5,Ao(i),Xn(i)}function Ao(i){i.A||(i.A=!0,Et(i,"complete"),Et(i,"error"))}n.abort=function(i){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=i||7,Et(this,"complete"),Et(this,"abort"),Xn(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Xn(this,!0)),et.aa.N.call(this)},n.Ea=function(){this.s||(this.B||this.u||this.j?Ro(this):this.bb())},n.bb=function(){Ro(this)};function Ro(i){if(i.h&&typeof a<"u"&&(!i.v[1]||Bt(i)!=4||i.Z()!=2)){if(i.u&&Bt(i)==4)Ki(i.Ea,0,i);else if(Et(i,"readystatechange"),Bt(i)==4){i.h=!1;try{const V=i.Z();t:switch(V){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var l=!0;break t;default:l=!1}var c;if(!(c=l)){var f;if(f=V===0){var w=String(i.D).match(po)[1]||null;!w&&u.self&&u.self.location&&(w=u.self.location.protocol.slice(0,-1)),f=!cc.test(w?w.toLowerCase():"")}c=f}if(c)Et(i,"complete"),Et(i,"success");else{i.m=6;try{var R=2<Bt(i)?i.g.statusText:""}catch{R=""}i.l=R+" ["+i.Z()+"]",Ao(i)}}finally{Xn(i)}}}}function Xn(i,l){if(i.g){bo(i);const c=i.g,f=i.v[0]?()=>{}:null;i.g=null,i.v=null,l||Et(i,"ready");try{c.onreadystatechange=f}catch{}}}function bo(i){i.I&&(u.clearTimeout(i.I),i.I=null)}n.isActive=function(){return!!this.g};function Bt(i){return i.g?i.g.readyState:0}n.Z=function(){try{return 2<Bt(this)?this.g.status:-1}catch{return-1}},n.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.Oa=function(i){if(this.g){var l=this.g.responseText;return i&&l.indexOf(i)==0&&(l=l.substring(i.length)),ju(l)}};function So(i){try{if(!i.g)return null;if("response"in i.g)return i.g.response;switch(i.H){case"":case"text":return i.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in i.g)return i.g.mozResponseArrayBuffer}return null}catch{return null}}function dc(i){const l={};i=(i.g&&2<=Bt(i)&&i.g.getAllResponseHeaders()||"").split(`\r
`);for(let f=0;f<i.length;f++){if(q(i[f]))continue;var c=T(i[f]);const w=c[0];if(c=c[1],typeof c!="string")continue;c=c.trim();const R=l[w]||[];l[w]=R,R.push(c)}g(l,function(f){return f.join(", ")})}n.Ba=function(){return this.m},n.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function ln(i,l,c){return c&&c.internalChannelParams&&c.internalChannelParams[i]||l}function Po(i){this.Aa=0,this.i=[],this.j=new tn,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=ln("failFast",!1,i),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=ln("baseRetryDelayMs",5e3,i),this.cb=ln("retryDelaySeedMs",1e4,i),this.Wa=ln("forwardChannelMaxRetries",2,i),this.wa=ln("forwardChannelRequestTimeoutMs",2e4,i),this.pa=i&&i.xmlHttpFactory||void 0,this.Xa=i&&i.Tb||void 0,this.Ca=i&&i.useFetchStreams||!1,this.L=void 0,this.J=i&&i.supportsCrossDomainXhr||!1,this.K="",this.h=new lo(i&&i.concurrentRequestLimit),this.Da=new lc,this.P=i&&i.fastHandshake||!1,this.O=i&&i.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=i&&i.Rb||!1,i&&i.xa&&this.j.xa(),i&&i.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&i&&i.detectBufferingProxy||!1,this.ja=void 0,i&&i.longPollingTimeout&&0<i.longPollingTimeout&&(this.ja=i.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}n=Po.prototype,n.la=8,n.G=1,n.connect=function(i,l,c,f){vt(0),this.W=i,this.H=l||{},c&&f!==void 0&&(this.H.OSID=c,this.H.OAID=f),this.F=this.X,this.I=Oo(this,null,this.W),Zn(this)};function hs(i){if(Do(i),i.G==3){var l=i.U++,c=Ot(i.I);if(X(c,"SID",i.K),X(c,"RID",l),X(c,"TYPE","terminate"),un(i,c),l=new Ht(i,i.j,l),l.L=2,l.v=Gn(Ot(c)),c=!1,u.navigator&&u.navigator.sendBeacon)try{c=u.navigator.sendBeacon(l.v.toString(),"")}catch{}!c&&u.Image&&(new Image().src=l.v,c=!0),c||(l.g=Bo(l.j,null),l.g.ea(l.v)),l.F=Date.now(),Hn(l)}Lo(i)}function Jn(i){i.g&&(fs(i),i.g.cancel(),i.g=null)}function Do(i){Jn(i),i.u&&(u.clearTimeout(i.u),i.u=null),tr(i),i.h.cancel(),i.s&&(typeof i.s=="number"&&u.clearTimeout(i.s),i.s=null)}function Zn(i){if(!uo(i.h)&&!i.s){i.s=!0;var l=i.Ga;We||$i(),Ge||(We(),Ge=!0),Hr.add(l,i),i.B=0}}function fc(i,l){return co(i.h)>=i.h.j-(i.s?1:0)?!1:i.s?(i.i=l.D.concat(i.i),!0):i.G==1||i.G==2||i.B>=(i.Va?0:i.Wa)?!1:(i.s=Ze(v(i.Ga,i,l),xo(i,i.B)),i.B++,!0)}n.Ga=function(i){if(this.s)if(this.s=null,this.G==1){if(!i){this.U=Math.floor(1e5*Math.random()),i=this.U++;const w=new Ht(this,this.j,i);let R=this.o;if(this.S&&(R?(R=p(R),E(R,this.S)):R=this.S),this.m!==null||this.O||(w.H=R,R=null),this.P)t:{for(var l=0,c=0;c<this.i.length;c++){e:{var f=this.i[c];if("__data__"in f.map&&(f=f.map.__data__,typeof f=="string")){f=f.length;break e}f=void 0}if(f===void 0)break;if(l+=f,4096<l){l=c;break t}if(l===4096||c===this.i.length-1){l=c+1;break t}}l=1e3}else l=1e3;l=Vo(this,w,l),c=Ot(this.I),X(c,"RID",i),X(c,"CVER",22),this.D&&X(c,"X-HTTP-Session-Id",this.D),un(this,c),R&&(this.O?l="headers="+encodeURIComponent(String(Io(R)))+"&"+l:this.m&&cs(c,this.m,R)),us(this.h,w),this.Ua&&X(c,"TYPE","init"),this.P?(X(c,"$req",l),X(c,"SID","null"),w.T=!0,is(w,c,null)):is(w,c,l),this.G=2}}else this.G==3&&(i?Co(this,i):this.i.length==0||uo(this.h)||Co(this))};function Co(i,l){var c;l?c=l.l:c=i.U++;const f=Ot(i.I);X(f,"SID",i.K),X(f,"RID",c),X(f,"AID",i.T),un(i,f),i.m&&i.o&&cs(f,i.m,i.o),c=new Ht(i,i.j,c,i.B+1),i.m===null&&(c.H=i.o),l&&(i.i=l.D.concat(i.i)),l=Vo(i,c,1e3),c.I=Math.round(.5*i.wa)+Math.round(.5*i.wa*Math.random()),us(i.h,c),is(c,f,l)}function un(i,l){i.H&&x(i.H,function(c,f){X(l,f,c)}),i.l&&mo({},function(c,f){X(l,f,c)})}function Vo(i,l,c){c=Math.min(i.i.length,c);var f=i.l?v(i.l.Na,i.l,i):null;t:{var w=i.i;let R=-1;for(;;){const V=["count="+c];R==-1?0<c?(R=w[0].g,V.push("ofs="+R)):R=0:V.push("ofs="+R);let Y=!0;for(let ot=0;ot<c;ot++){let K=w[ot].g;const ft=w[ot].map;if(K-=R,0>K)R=Math.max(0,w[ot].g-100),Y=!1;else try{uc(ft,V,"req"+K+"_")}catch{f&&f(ft)}}if(Y){f=V.join("&");break t}}}return i=i.i.splice(0,c),l.D=i,f}function ko(i){if(!i.g&&!i.u){i.Y=1;var l=i.Fa;We||$i(),Ge||(We(),Ge=!0),Hr.add(l,i),i.v=0}}function ds(i){return i.g||i.u||3<=i.v?!1:(i.Y++,i.u=Ze(v(i.Fa,i),xo(i,i.v)),i.v++,!0)}n.Fa=function(){if(this.u=null,No(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var i=2*this.R;this.j.info("BP detection timer enabled: "+i),this.A=Ze(v(this.ab,this),i)}},n.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,vt(10),Jn(this),No(this))};function fs(i){i.A!=null&&(u.clearTimeout(i.A),i.A=null)}function No(i){i.g=new Ht(i,i.j,"rpc",i.Y),i.m===null&&(i.g.H=i.o),i.g.O=0;var l=Ot(i.qa);X(l,"RID","rpc"),X(l,"SID",i.K),X(l,"AID",i.T),X(l,"CI",i.F?"0":"1"),!i.F&&i.ja&&X(l,"TO",i.ja),X(l,"TYPE","xmlhttp"),un(i,l),i.m&&i.o&&cs(l,i.m,i.o),i.L&&(i.g.I=i.L);var c=i.g;i=i.ia,c.L=1,c.v=Gn(Ot(l)),c.m=null,c.P=!0,io(c,i)}n.Za=function(){this.C!=null&&(this.C=null,Jn(this),ds(this),vt(19))};function tr(i){i.C!=null&&(u.clearTimeout(i.C),i.C=null)}function Mo(i,l){var c=null;if(i.g==l){tr(i),fs(i),i.g=null;var f=2}else if(ls(i.h,l))c=l.D,ho(i.h,l),f=1;else return;if(i.G!=0){if(l.o)if(f==1){c=l.m?l.m.length:0,l=Date.now()-l.F;var w=i.B;f=qn(),Et(f,new eo(f,c)),Zn(i)}else ko(i);else if(w=l.s,w==3||w==0&&0<l.X||!(f==1&&fc(i,l)||f==2&&ds(i)))switch(c&&0<c.length&&(l=i.h,l.i=l.i.concat(c)),w){case 1:le(i,5);break;case 4:le(i,10);break;case 3:le(i,6);break;default:le(i,2)}}}function xo(i,l){let c=i.Ta+Math.floor(Math.random()*i.cb);return i.isActive()||(c*=2),c*l}function le(i,l){if(i.j.info("Error code "+l),l==2){var c=v(i.fb,i),f=i.Xa;const w=!f;f=new ae(f||"//www.google.com/images/cleardot.gif"),u.location&&u.location.protocol=="http"||Kn(f,"https"),Gn(f),w?oc(f.toString(),c):ac(f.toString(),c)}else vt(2);i.G=0,i.l&&i.l.sa(l),Lo(i),Do(i)}n.fb=function(i){i?(this.j.info("Successfully pinged google.com"),vt(2)):(this.j.info("Failed to ping google.com"),vt(1))};function Lo(i){if(i.G=0,i.ka=[],i.l){const l=fo(i.h);(l.length!=0||i.i.length!=0)&&(D(i.ka,l),D(i.ka,i.i),i.h.i.length=0,N(i.i),i.i.length=0),i.l.ra()}}function Oo(i,l,c){var f=c instanceof ae?Ot(c):new ae(c);if(f.g!="")l&&(f.g=l+"."+f.g),Wn(f,f.s);else{var w=u.location;f=w.protocol,l=l?l+"."+w.hostname:w.hostname,w=+w.port;var R=new ae(null);f&&Kn(R,f),l&&(R.g=l),w&&Wn(R,w),c&&(R.l=c),f=R}return c=i.D,l=i.ya,c&&l&&X(f,c,l),X(f,"VER",i.la),un(i,f),f}function Bo(i,l,c){if(l&&!i.J)throw Error("Can't create secondary domain capable XhrIo object.");return l=i.Ca&&!i.pa?new et(new Qn({eb:c})):new et(i.pa),l.Ha(i.J),l}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function Fo(){}n=Fo.prototype,n.ua=function(){},n.ta=function(){},n.sa=function(){},n.ra=function(){},n.isActive=function(){return!0},n.Na=function(){};function er(){}er.prototype.g=function(i,l){return new wt(i,l)};function wt(i,l){dt.call(this),this.g=new Po(l),this.l=i,this.h=l&&l.messageUrlParams||null,i=l&&l.messageHeaders||null,l&&l.clientProtocolHeaderRequired&&(i?i["X-Client-Protocol"]="webchannel":i={"X-Client-Protocol":"webchannel"}),this.g.o=i,i=l&&l.initMessageHeaders||null,l&&l.messageContentType&&(i?i["X-WebChannel-Content-Type"]=l.messageContentType:i={"X-WebChannel-Content-Type":l.messageContentType}),l&&l.va&&(i?i["X-WebChannel-Client-Profile"]=l.va:i={"X-WebChannel-Client-Profile":l.va}),this.g.S=i,(i=l&&l.Sb)&&!q(i)&&(this.g.m=i),this.v=l&&l.supportsCrossDomainXhr||!1,this.u=l&&l.sendRawJson||!1,(l=l&&l.httpSessionIdParam)&&!q(l)&&(this.g.D=l,i=this.h,i!==null&&l in i&&(i=this.h,l in i&&delete i[l])),this.j=new Ae(this)}C(wt,dt),wt.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},wt.prototype.close=function(){hs(this.g)},wt.prototype.o=function(i){var l=this.g;if(typeof i=="string"){var c={};c.__data__=i,i=c}else this.u&&(c={},c.__data__=Zr(i),i=c);l.i.push(new Yu(l.Ya++,i)),l.G==3&&Zn(l)},wt.prototype.N=function(){this.g.l=null,delete this.j,hs(this.g),delete this.g,wt.aa.N.call(this)};function Uo(i){es.call(this),i.__headers__&&(this.headers=i.__headers__,this.statusCode=i.__status__,delete i.__headers__,delete i.__status__);var l=i.__sm__;if(l){t:{for(const c in l){i=c;break t}i=void 0}(this.i=i)&&(i=this.i,l=l!==null&&i in l?l[i]:void 0),this.data=l}else this.data=i}C(Uo,es);function $o(){ns.call(this),this.status=1}C($o,ns);function Ae(i){this.g=i}C(Ae,Fo),Ae.prototype.ua=function(){Et(this.g,"a")},Ae.prototype.ta=function(i){Et(this.g,new Uo(i))},Ae.prototype.sa=function(i){Et(this.g,new $o)},Ae.prototype.ra=function(){Et(this.g,"b")},er.prototype.createWebChannel=er.prototype.g,wt.prototype.send=wt.prototype.o,wt.prototype.open=wt.prototype.m,wt.prototype.close=wt.prototype.close,rl=function(){return new er},nl=function(){return qn()},el=ie,xs={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},jn.NO_ERROR=0,jn.TIMEOUT=8,jn.HTTP_ERROR=6,lr=jn,no.COMPLETE="complete",tl=no,Xi.EventType=Xe,Xe.OPEN="a",Xe.CLOSE="b",Xe.ERROR="c",Xe.MESSAGE="d",dt.prototype.listen=dt.prototype.K,dn=Xi,et.prototype.listenOnce=et.prototype.L,et.prototype.getLastError=et.prototype.Ka,et.prototype.getLastErrorCode=et.prototype.Ba,et.prototype.getStatus=et.prototype.Z,et.prototype.getResponseJson=et.prototype.Oa,et.prototype.getResponseText=et.prototype.oa,et.prototype.send=et.prototype.ea,et.prototype.setWithCredentials=et.prototype.Ha,Za=et}).apply(typeof rr<"u"?rr:typeof self<"u"?self:typeof window<"u"?window:{});const Zo="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function B(n="Unexpected state"){const t=`FIRESTORE (${$e}) INTERNAL ASSERTION FAILED: `+n;throw qt(t),new Error(t)}function G(n,t){n||B()}function U(n,t){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sl{constructor(t,e){this.user=e,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${t}`)}}class Kh{getToken(){return Promise.resolve(null)}invalidateToken(){}start(t,e){t.enqueueRetryable(()=>e(gt.UNAUTHENTICATED))}shutdown(){}}class Wh{constructor(t){this.token=t,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(t,e){this.changeListener=e,t.enqueueRetryable(()=>e(this.token.user))}shutdown(){this.changeListener=null}}class Gh{constructor(t){this.t=t,this.currentUser=gt.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(t,e){G(this.o===void 0);let r=this.i;const s=h=>this.i!==r?(r=this.i,e(h)):Promise.resolve();let o=new Ft;this.o=()=>{this.i++,this.currentUser=this.u(),o.resolve(),o=new Ft,t.enqueueRetryable(()=>s(this.currentUser))};const a=()=>{const h=o;t.enqueueRetryable(async()=>{await h.promise,await s(this.currentUser)})},u=h=>{M("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=h,this.o&&(this.auth.addAuthTokenListener(this.o),a())};this.t.onInit(h=>u(h)),setTimeout(()=>{if(!this.auth){const h=this.t.getImmediate({optional:!0});h?u(h):(M("FirebaseAuthCredentialsProvider","Auth not yet detected"),o.resolve(),o=new Ft)}},0),a()}getToken(){const t=this.i,e=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(e).then(r=>this.i!==t?(M("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(G(typeof r.accessToken=="string"),new sl(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const t=this.auth&&this.auth.getUid();return G(t===null||typeof t=="string"),new gt(t)}}class Qh{constructor(t,e,r){this.l=t,this.h=e,this.P=r,this.type="FirstParty",this.user=gt.FIRST_PARTY,this.I=new Map}T(){return this.P?this.P():null}get headers(){this.I.set("X-Goog-AuthUser",this.l);const t=this.T();return t&&this.I.set("Authorization",t),this.h&&this.I.set("X-Goog-Iam-Authorization-Token",this.h),this.I}}class Yh{constructor(t,e,r){this.l=t,this.h=e,this.P=r}getToken(){return Promise.resolve(new Qh(this.l,this.h,this.P))}start(t,e){t.enqueueRetryable(()=>e(gt.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class Xh{constructor(t){this.value=t,this.type="AppCheck",this.headers=new Map,t&&t.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class Jh{constructor(t){this.A=t,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(t,e){G(this.o===void 0);const r=o=>{o.error!=null&&M("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${o.error.message}`);const a=o.token!==this.R;return this.R=o.token,M("FirebaseAppCheckTokenProvider",`Received ${a?"new":"existing"} token.`),a?e(o.token):Promise.resolve()};this.o=o=>{t.enqueueRetryable(()=>r(o))};const s=o=>{M("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=o,this.o&&this.appCheck.addTokenListener(this.o)};this.A.onInit(o=>s(o)),setTimeout(()=>{if(!this.appCheck){const o=this.A.getImmediate({optional:!0});o?s(o):M("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const t=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(t).then(e=>e?(G(typeof e.token=="string"),this.R=e.token,new Xh(e.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ta(n){let t=0;for(const e in n)Object.prototype.hasOwnProperty.call(n,e)&&t++;return t}function Ee(n,t){for(const e in n)Object.prototype.hasOwnProperty.call(n,e)&&t(e,n[e])}function ol(n){for(const t in n)if(Object.prototype.hasOwnProperty.call(n,t))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Le{constructor(t){this.Ln=t}next(){return this.Ln+=2,this.Ln}static Bn(){return new Le(0)}static kn(){return new Le(-1)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gf{constructor(t,e,r,s){this.remoteDocumentCache=t,this.mutationQueue=e,this.documentOverlayCache=r,this.indexManager=s}getDocument(t,e){let r=null;return this.documentOverlayCache.getOverlay(t,e).next(s=>(r=s,this.remoteDocumentCache.getEntry(t,e))).next(s=>(r!==null&&En(r.mutation,s,At.empty(),Q.now()),s))}getDocuments(t,e){return this.remoteDocumentCache.getEntries(t,e).next(r=>this.getLocalViewOfDocuments(t,r,j()).next(()=>r))}getLocalViewOfDocuments(t,e,r=j()){const s=ce();return this.populateOverlays(t,s,e).next(()=>this.computeViews(t,e,s,r).next(o=>{let a=fn();return o.forEach((u,h)=>{a=a.insert(u,h.overlayedDocument)}),a}))}getOverlayedDocuments(t,e){const r=ce();return this.populateOverlays(t,r,e).next(()=>this.computeViews(t,e,r,j()))}populateOverlays(t,e,r){const s=[];return r.forEach(o=>{e.has(o)||s.push(o)}),this.documentOverlayCache.getOverlays(t,s).next(o=>{o.forEach((a,u)=>{e.set(a,u)})})}computeViews(t,e,r,s){let o=jt();const a=_n(),u=function(){return _n()}();return e.forEach((h,d)=>{const m=r.get(d.key);s.has(d.key)&&(m===void 0||m.mutation instanceof ne)?o=o.insert(d.key,d):m!==void 0?(a.set(d.key,m.mutation.getFieldMask()),En(m.mutation,d,m.mutation.getFieldMask(),Q.now())):a.set(d.key,At.empty())}),this.recalculateAndSaveOverlays(t,o).next(h=>(h.forEach((d,m)=>a.set(d,m)),e.forEach((d,m)=>{var I;return u.set(d,new pf(m,(I=a.get(d))!==null&&I!==void 0?I:null))}),u))}recalculateAndSaveOverlays(t,e){const r=_n();let s=new tt((a,u)=>a-u),o=j();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(t,e).next(a=>{for(const u of a)u.keys().forEach(h=>{const d=e.get(h);if(d===null)return;let m=r.get(h)||At.empty();m=u.applyToLocalView(d,m),r.set(h,m);const I=(s.get(u.batchId)||j()).add(h);s=s.insert(u.batchId,I)})}).next(()=>{const a=[],u=s.getReverseIterator();for(;u.hasNext();){const h=u.getNext(),d=h.key,m=h.value,I=vl();m.forEach(v=>{if(!o.has(v)){const b=bl(e.get(v),r.get(v));b!==null&&I.set(v,b),o=o.add(v)}}),a.push(this.documentOverlayCache.saveOverlays(t,d,I))}return P.waitFor(a)}).next(()=>r)}recalculateAndSaveOverlaysForDocumentKeys(t,e){return this.remoteDocumentCache.getEntries(t,e).next(r=>this.recalculateAndSaveOverlays(t,r))}getDocumentsMatchingQuery(t,e,r,s){return function(a){return L.isDocumentKey(a.path)&&a.collectionGroup===null&&a.filters.length===0}(e)?this.getDocumentsMatchingDocumentQuery(t,e.path):pl(e)?this.getDocumentsMatchingCollectionGroupQuery(t,e,r,s):this.getDocumentsMatchingCollectionQuery(t,e,r,s)}getNextDocuments(t,e,r,s){return this.remoteDocumentCache.getAllFromCollectionGroup(t,e,r,s).next(o=>{const a=s-o.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(t,e,r.largestBatchId,s-o.size):P.resolve(ce());let u=-1,h=o;return a.next(d=>P.forEach(d,(m,I)=>(u<I.largestBatchId&&(u=I.largestBatchId),o.get(m)?P.resolve():this.remoteDocumentCache.getEntry(t,m).next(v=>{h=h.insert(m,v)}))).next(()=>this.populateOverlays(t,d,o)).next(()=>this.computeViews(t,h,d,j())).next(m=>({batchId:u,changes:El(m)})))})}getDocumentsMatchingDocumentQuery(t,e){return this.getDocument(t,new L(e)).next(r=>{let s=fn();return r.isFoundDocument()&&(s=s.insert(r.key,r)),s})}getDocumentsMatchingCollectionGroupQuery(t,e,r,s){const o=e.collectionGroup;let a=fn();return this.indexManager.getCollectionParents(t,o).next(u=>P.forEach(u,h=>{const d=function(I,v){return new qe(v,null,I.explicitOrderBy.slice(),I.filters.slice(),I.limit,I.limitType,I.startAt,I.endAt)}(e,h.child(o));return this.getDocumentsMatchingCollectionQuery(t,d,r,s).next(m=>{m.forEach((I,v)=>{a=a.insert(I,v)})})}).next(()=>a))}getDocumentsMatchingCollectionQuery(t,e,r,s){let o;return this.documentOverlayCache.getOverlaysForCollection(t,e.path,r.largestBatchId).next(a=>(o=a,this.remoteDocumentCache.getDocumentsMatchingQuery(t,e,r,o,s))).next(a=>{o.forEach((h,d)=>{const m=d.getKey();a.get(m)===null&&(a=a.insert(m,yt.newInvalidDocument(m)))});let u=fn();return a.forEach((h,d)=>{const m=o.get(h);m!==void 0&&En(m.mutation,d,At.empty(),Q.now()),Dr(e,d)&&(u=u.insert(h,d))}),u})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sf{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return Pc()?8:od(bc())>0?6:4}()}initialize(t,e){this.Ji=t,this.indexManager=e,this.Gi=!0}getDocumentsMatchingQuery(t,e,r,s){const o={result:null};return this.Yi(t,e).next(a=>{o.result=a}).next(()=>{if(!o.result)return this.Zi(t,e,s,r).next(a=>{o.result=a})}).next(()=>{if(o.result)return;const a=new bf;return this.Xi(t,e,a).next(u=>{if(o.result=u,this.zi)return this.es(t,e,a,u.size)})}).next(()=>o.result)}es(t,e,r,s){return r.documentReadCount<this.ji?(cn()<=H.DEBUG&&M("QueryEngine","SDK will not create cache indexes for query:",Se(e),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),P.resolve()):(cn()<=H.DEBUG&&M("QueryEngine","Query:",Se(e),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.Hi*s?(cn()<=H.DEBUG&&M("QueryEngine","The SDK decides to create cache indexes for query:",Se(e),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(t,Mt(e))):P.resolve())}Yi(t,e){if(ca(e))return P.resolve(null);let r=Mt(e);return this.indexManager.getIndexType(t,r).next(s=>s===0?null:(e.limit!==null&&s===1&&(e=_r(e,null,"F"),r=Mt(e)),this.indexManager.getDocumentsMatchingTarget(t,r).next(o=>{const a=j(...o);return this.Ji.getDocuments(t,a).next(u=>this.indexManager.getMinOffset(t,r).next(h=>{const d=this.ts(e,u);return this.ns(e,d,a,h.readTime)?this.Yi(t,_r(e,null,"F")):this.rs(t,d,e,h)}))})))}Zi(t,e,r,s){return ca(e)||s.isEqual(F.min())?P.resolve(null):this.Ji.getDocuments(t,r).next(o=>{const a=this.ts(e,o);return this.ns(e,a,r,s)?P.resolve(null):(cn()<=H.DEBUG&&M("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),Se(e)),this.rs(t,a,e,ed(s,-1)).next(u=>u))})}ts(t,e){let r=new ut(yl(t));return e.forEach((s,o)=>{Dr(t,o)&&(r=r.add(o))}),r}ns(t,e,r,s){if(t.limit===null)return!1;if(r.size!==e.size)return!0;const o=t.limitType==="F"?e.last():e.first();return!!o&&(o.hasPendingWrites||o.version.compareTo(s)>0)}Xi(t,e,r){return cn()<=H.DEBUG&&M("QueryEngine","Using full collection scan to execute query:",Se(e)),this.Ji.getDocumentsMatchingQuery(t,e,Jt.min(),r)}rs(t,e,r,s){return this.Ji.getDocumentsMatchingQuery(t,r,s).next(o=>(e.forEach(a=>{o=o.insert(a.key,a)}),o))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pt="WebChannelConnection";class Uf extends class{constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const r=e.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),o=encodeURIComponent(this.databaseId.database);this.Do=r+"://"+e.host,this.vo=`projects/${s}/databases/${o}`,this.Co=this.databaseId.database==="(default)"?`project_id=${s}`:`project_id=${s}&database_id=${o}`}get Fo(){return!1}Mo(e,r,s,o,a){const u=vs(),h=this.xo(e,r.toUriEncodedString());M("RestConnection",`Sending RPC '${e}' ${u}:`,h,s);const d={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(d,o,a),this.No(e,h,d,s).then(m=>(M("RestConnection",`Received RPC '${e}' ${u}: `,m),m),m=>{throw ke("RestConnection",`RPC '${e}' ${u} failed with error: `,m,"url: ",h,"request:",s),m})}Lo(e,r,s,o,a,u){return this.Mo(e,r,s,o,a)}Oo(e,r,s){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+$e}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((o,a)=>e[a]=o),s&&s.headers.forEach((o,a)=>e[a]=o)}xo(e,r){const s=Bf[e];return`${this.Do}/v1/${r}:${s}`}terminate(){}}{constructor(t){super(t),this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}No(t,e,r,s){const o=vs();return new Promise((a,u)=>{const h=new Za;h.setWithCredentials(!0),h.listenOnce(tl.COMPLETE,()=>{try{switch(h.getLastErrorCode()){case lr.NO_ERROR:const m=h.getResponseJson();M(pt,`XHR for RPC '${t}' ${o} received:`,JSON.stringify(m)),a(m);break;case lr.TIMEOUT:M(pt,`RPC '${t}' ${o} timed out`),u(new k(S.DEADLINE_EXCEEDED,"Request time out"));break;case lr.HTTP_ERROR:const I=h.getStatus();if(M(pt,`RPC '${t}' ${o} failed with status:`,I,"response text:",h.getResponseText()),I>0){let v=h.getResponseJson();Array.isArray(v)&&(v=v[0]);const b=v==null?void 0:v.error;if(b&&b.status&&b.message){const C=function(D){const O=D.toLowerCase().replace(/_/g,"-");return Object.values(S).indexOf(O)>=0?O:S.UNKNOWN}(b.status);u(new k(C,b.message))}else u(new k(S.UNKNOWN,"Server responded with status "+h.getStatus()))}else u(new k(S.UNAVAILABLE,"Connection failed."));break;default:B()}}finally{M(pt,`RPC '${t}' ${o} completed.`)}});const d=JSON.stringify(s);M(pt,`RPC '${t}' ${o} sending request:`,s),h.send(e,"POST",d,r,15)})}Bo(t,e,r){const s=vs(),o=[this.Do,"/","google.firestore.v1.Firestore","/",t,"/channel"],a=rl(),u=nl(),h={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(h.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(h.useFetchStreams=!0),this.Oo(h.initMessageHeaders,e,r),h.encodeInitMessageHeaders=!0;const m=o.join("");M(pt,`Creating RPC '${t}' stream ${s}: ${m}`,h);const I=a.createWebChannel(m,h);let v=!1,b=!1;const C=new Ff({Io:D=>{b?M(pt,`Not sending because RPC '${t}' stream ${s} is closed:`,D):(v||(M(pt,`Opening RPC '${t}' stream ${s} transport.`),I.open(),v=!0),M(pt,`RPC '${t}' stream ${s} sending:`,D),I.send(D))},To:()=>I.close()}),N=(D,O,q)=>{D.listen(O,$=>{try{q($)}catch(Z){setTimeout(()=>{throw Z},0)}})};return N(I,dn.EventType.OPEN,()=>{b||(M(pt,`RPC '${t}' stream ${s} transport opened.`),C.yo())}),N(I,dn.EventType.CLOSE,()=>{b||(b=!0,M(pt,`RPC '${t}' stream ${s} transport closed`),C.So())}),N(I,dn.EventType.ERROR,D=>{b||(b=!0,ke(pt,`RPC '${t}' stream ${s} transport errored:`,D),C.So(new k(S.UNAVAILABLE,"The operation could not be completed")))}),N(I,dn.EventType.MESSAGE,D=>{var O;if(!b){const q=D.data[0];G(!!q);const $=q,Z=$.error||((O=$[0])===null||O===void 0?void 0:O.error);if(Z){M(pt,`RPC '${t}' stream ${s} received error:`,Z);const _t=Z.status;let x=function(y){const E=rt[y];if(E!==void 0)return Pl(E)}(_t),g=Z.message;x===void 0&&(x=S.INTERNAL,g="Unknown error status: "+_t+" with message "+Z.message),b=!0,C.So(new k(x,g)),I.close()}else M(pt,`RPC '${t}' stream ${s} received:`,q),C.bo(q)}}),N(u,el.STAT_EVENT,D=>{D.stat===xs.PROXY?M(pt,`RPC '${t}' stream ${s} detected buffering proxy`):D.stat===xs.NOPROXY&&M(pt,`RPC '${t}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{C.wo()},0),C}}function Ts(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ve{constructor(t){this.comparator=t?(e,r)=>t(e,r)||L.comparator(e.key,r.key):(e,r)=>L.comparator(e.key,r.key),this.keyedMap=fn(),this.sortedSet=new tt(this.comparator)}static emptySet(t){return new Ve(t.comparator)}has(t){return this.keyedMap.get(t)!=null}get(t){return this.keyedMap.get(t)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(t){const e=this.keyedMap.get(t);return e?this.sortedSet.indexOf(e):-1}get size(){return this.sortedSet.size}forEach(t){this.sortedSet.inorderTraversal((e,r)=>(t(e),!1))}add(t){const e=this.delete(t.key);return e.copy(e.keyedMap.insert(t.key,t),e.sortedSet.insert(t,null))}delete(t){const e=this.get(t);return e?this.copy(this.keyedMap.remove(t),this.sortedSet.remove(e)):this}isEqual(t){if(!(t instanceof Ve)||this.size!==t.size)return!1;const e=this.sortedSet.getIterator(),r=t.sortedSet.getIterator();for(;e.hasNext();){const s=e.getNext().key,o=r.getNext().key;if(!s.isEqual(o))return!1}return!0}toString(){const t=[];return this.forEach(e=>{t.push(e.toString())}),t.length===0?"DocumentSet ()":`DocumentSet (
  `+t.join(`  
`)+`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ra{constructor(){this.W_=new tt(L.comparator)}track(t){const e=t.doc.key,r=this.W_.get(e);r?t.type!==0&&r.type===3?this.W_=this.W_.insert(e,t):t.type===3&&r.type!==1?this.W_=this.W_.insert(e,{type:r.type,doc:t.doc}):t.type===2&&r.type===2?this.W_=this.W_.insert(e,{type:2,doc:t.doc}):t.type===2&&r.type===0?this.W_=this.W_.insert(e,{type:0,doc:t.doc}):t.type===1&&r.type===0?this.W_=this.W_.remove(e):t.type===1&&r.type===2?this.W_=this.W_.insert(e,{type:1,doc:r.doc}):t.type===0&&r.type===1?this.W_=this.W_.insert(e,{type:2,doc:t.doc}):B():this.W_=this.W_.insert(e,t)}G_(){const t=[];return this.W_.inorderTraversal((e,r)=>{t.push(r)}),t}}class Oe{constructor(t,e,r,s,o,a,u,h,d){this.query=t,this.docs=e,this.oldDocs=r,this.docChanges=s,this.mutatedKeys=o,this.fromCache=a,this.syncStateChanged=u,this.excludesMetadataChanges=h,this.hasCachedResults=d}static fromInitialDocuments(t,e,r,s,o){const a=[];return e.forEach(u=>{a.push({type:0,doc:u})}),new Oe(t,e,Ve.emptySet(e),a,r,s,!0,!1,o)}get hasPendingWrites(){return!this.mutatedKeys.isEmpty()}isEqual(t){if(!(this.fromCache===t.fromCache&&this.hasCachedResults===t.hasCachedResults&&this.syncStateChanged===t.syncStateChanged&&this.mutatedKeys.isEqual(t.mutatedKeys)&&Pr(this.query,t.query)&&this.docs.isEqual(t.docs)&&this.oldDocs.isEqual(t.oldDocs)))return!1;const e=this.docChanges,r=t.docChanges;if(e.length!==r.length)return!1;for(let s=0;s<e.length;s++)if(e[s].type!==r[s].type||!e[s].doc.isEqual(r[s].doc))return!1;return!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class re{constructor(t,e,r){this.converter=e,this._query=r,this.type="query",this.firestore=t}withConverter(t){return new re(this.firestore,t,this._query)}}class Tt{constructor(t,e,r){this.converter=e,this._key=r,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Xt(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new Tt(this.firestore,t,this._key)}}class Xt extends re{constructor(t,e,r){super(t,e,ai(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new Tt(this.firestore,null,new L(t))}withConverter(t){return new Xt(this.firestore,t,this._path)}}function ee(n,t,...e){if(n=Ut(n),uu("collection","path",t),n instanceof Or){const r=J.fromString(t,...e);return Na(r),new Xt(n,null,r)}{if(!(n instanceof Tt||n instanceof Xt))throw new k(S.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(J.fromString(t,...e));return Na(r),new Xt(n.firestore,null,r)}}function He(n,t,...e){if(n=Ut(n),arguments.length===1&&(t=il.newId()),uu("doc","path",t),n instanceof Or){const r=J.fromString(t,...e);return ka(r),new Tt(n,null,new L(r))}{if(!(n instanceof Tt||n instanceof Xt))throw new k(S.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(J.fromString(t,...e));return ka(r),new Tt(n.firestore,n instanceof Xt?n.converter:null,new L(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function Tu(n){n=Ct(n,Tt);const t=Ct(n.firestore,Te);return Sm(Ai(t),n._key).then(e=>Qm(t,n,e))}class Iu extends qm{constructor(t){super(),this.firestore=t}convertBytes(t){return new Be(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new Tt(this.firestore,null,e)}}function Ke(n){n=Ct(n,re);const t=Ct(n.firestore,Te),e=Ai(t),r=new Iu(t);return $m(n._query),Pm(e,n._query).then(s=>new jm(t,r,n,s))}function Hm(n,t,e){n=Ct(n,Tt);const r=Ct(n.firestore,Te),s=Eu(n.converter,t);return jr(r,[du(Fr(r),"setDoc",n._key,s,n.converter!==null,e).toMutation(n._key,St.none())])}function Km(n,t,e,...r){n=Ct(n,Tt);const s=Ct(n.firestore,Te),o=Fr(s);let a;return a=typeof(t=Ut(t))=="string"||t instanceof Br?Om(o,"updateDoc",n._key,t,e,r):Lm(o,"updateDoc",n._key,t),jr(s,[a.toMutation(n._key,St.exists(!0))])}function Wm(n){return jr(Ct(n.firestore,Te),[new ui(n._key,St.none())])}function Gm(n,t){const e=Ct(n.firestore,Te),r=He(n),s=Eu(n.converter,t);return jr(e,[du(Fr(n.firestore),"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,St.exists(!1))]).then(()=>r)}function jr(n,t){return function(r,s){const o=new Ft;return r.asyncQueue.enqueueAndForget(async()=>gm(await bm(r),s,o)),o.promise}(Ai(n),t)}function Qm(n,t,e){const r=e.docs.get(t._key),s=new Iu(n);return new vu(n,s,t._key,r,new pn(e.hasPendingWrites,e.fromCache),t.converter)}(function(t,e=!0){(function(s){$e=s})(Nh),pr(new Tn("firestore",(r,{instanceIdentifier:s,options:o})=>{const a=r.getProvider("app").getImmediate(),u=new Te(new Gh(r.getProvider("auth-internal")),new Jh(r.getProvider("app-check-internal")),function(d,m){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new k(S.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Rn(d.options.projectId,m)}(a,s),a);return o=Object.assign({useFetchStreams:e},o),u._setSettings(o),u},"PUBLIC").setMultipleInstances(!0)),Ce(Zo,"4.7.3",t),Ce(Zo,"4.7.3","esm2017")})();const Ym="55555",Ys="baby-tracker-auth",Xm=24*60*60*1e3,Jm={apiKey:"AIzaSyA66X3tR-oquob5ZbBrrHv_EAmhwEHTi48",authDomain:"baby-tracker-b0936.firebaseapp.com",projectId:"baby-tracker-b0936",storageBucket:"baby-tracker-b0936.firebasestorage.app",messagingSenderId:"931756532206",appId:"1:931756532206:web:bf90d10dc3e3837383eeff"},Zm=Qa(Jm),Rt=Vm(Zm);function tp(){const n=localStorage.getItem(Ys);if(!n)return!1;try{const{timestamp:t}=JSON.parse(n);return Date.now()-t<Xm?!0:(localStorage.removeItem(Ys),!1)}catch{return!1}}function ep(){const n={timestamp:Date.now()};localStorage.setItem(Ys,JSON.stringify(n))}let kt=Fe(new Date),Rr=null,ws=null,As=null,Rs=null,bs=null,Ss=null;function Fe(n){const t=new Date(n),e=t.getDay(),r=t.getDate()-e;return t.setDate(r),t.setHours(0,0,0,0),t}function np(n){const t=new Date(n);return t.setDate(t.getDate()+6),t.setHours(23,59,59,999),t}function vn(n){const t=n.getFullYear(),e=String(n.getMonth()+1).padStart(2,"0"),r=String(n.getDate()).padStart(2,"0"),s=String(n.getHours()).padStart(2,"0"),o=String(n.getMinutes()).padStart(2,"0");return`${t}-${e}-${r}T${s}:${o}`}function Vt(n){const t=n.getFullYear(),e=String(n.getMonth()+1).padStart(2,"0"),r=String(n.getDate()).padStart(2,"0");return`${t}-${e}-${r}`}function rp(n){const t=String(n.getMonth()+1).padStart(2,"0"),e=String(n.getDate()).padStart(2,"0"),r=n.getFullYear(),s=n.getHours(),o=String(n.getMinutes()).padStart(2,"0"),a=s>=12?"PM":"AM",u=s%12||12;return`${t}/${e}/${r} ${u}:${o} ${a}`}function Xs(n){const t=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],e=String(n.getMonth()+1).padStart(2,"0"),r=String(n.getDate()).padStart(2,"0"),s=n.getFullYear();return`${t[n.getDay()]}, ${e}/${r}/${s}`}function br(n){const t=n.getFullYear(),e=String(n.getMonth()+1).padStart(2,"0"),r=String(n.getDate()).padStart(2,"0");return`${t}-${e}-${r}`}async function Li(){const n=document.getElementById("vitamin-d-checkbox"),t=document.getElementById("vitamin-d-status"),e=document.getElementById("vitamin-d-label-text");if(!n||!t||!e)return;const s=br(new Date);try{const o=await Tu(He(Rt,"vitaminD",s));if(o.exists()){const a=o.data();n.checked=a.given===!0}else n.checked=!1;e.textContent=n.checked?"Vitamin D drop given":"Record Vitamin D drop",t.textContent="",t.style.display="none"}catch(o){console.error("Error loading vitamin D status:",o),t.className="error",t.textContent="Failed to load vitamin D status",t.style.display="block"}}function wu(){Ss&&clearTimeout(Ss);const n=new Date,t=new Date(n);t.setDate(t.getDate()+1),t.setHours(0,0,0,0);const e=t.getTime()-n.getTime();Ss=window.setTimeout(()=>{Li(),wu()},e)}async function sp(n){const t=n.target,e=document.getElementById("vitamin-d-status"),r=document.getElementById("vitamin-d-label-text");if(!e||!r)return;const s=new Date,o=br(s);try{await Hm(He(Rt,"vitaminD",o),{given:t.checked,date:Q.fromDate(s)}),r.textContent=t.checked?"Vitamin D drop given":"Record Vitamin D drop",e.style.display="none"}catch(a){console.error("Error saving vitamin D status:",a),e.className="error",e.textContent="Failed to save vitamin D status",e.style.display="block",t.checked=!t.checked,r.textContent=t.checked?"Vitamin D drop given":"Record Vitamin D drop"}}function Au(){const n=document.getElementById("passcode-input"),t=document.getElementById("passcode-error"),e=document.getElementById("passcode-screen"),r=document.getElementById("app");n.value===Ym?(n.blur(),ep(),e.style.display="none",r.style.display="block",setTimeout(()=>{window.scrollTo(0,0),document.body.scrollTop=0,document.documentElement.scrollTop=0},0),Ru()):(t.textContent="Incorrect passcode",t.style.display="block",n.value="")}function Ru(){lp(),Oi(),ip(),_p(),op(),ap(),Li(),wu(),window.scrollTo(0,0)}function ip(){const n=new Date,t=document.getElementById("start-date-filter"),e=document.getElementById("end-date-filter");t&&(t.value=Vt(n)),e&&(e.value=Vt(n))}function op(){[document.getElementById("bottle-amount"),document.getElementById("pump-amount"),document.getElementById("edit-bottle-amount"),document.getElementById("edit-pump-amount")].forEach(t=>{t&&(t.addEventListener("keypress",e=>{const r=e.key,s=t.value;e.key==="Backspace"||e.key==="Delete"||e.key==="Tab"||e.key==="Escape"||e.key==="Enter"||e.ctrlKey||e.metaKey||r>="0"&&r<="9"||r==="."&&s.indexOf(".")===-1||e.preventDefault()}),t.addEventListener("paste",e=>{var u;e.preventDefault();const s=(((u=e.clipboardData)==null?void 0:u.getData("text"))||"").replace(/[^0-9.]/g,""),o=s.split("."),a=o.length>2?o[0]+"."+o.slice(1).join(""):s;document.execCommand("insertText",!1,a)}))})}function ap(){const n=document.getElementById("bottle-unit"),t=document.getElementById("bottle-amount"),e=document.getElementById("pump-unit"),r=document.getElementById("pump-amount"),s=document.getElementById("edit-bottle-unit"),o=document.getElementById("edit-bottle-amount"),a=document.getElementById("edit-pump-unit"),u=document.getElementById("edit-pump-amount");n&&t&&n.addEventListener("change",()=>{ar(t,n.value)}),e&&r&&e.addEventListener("change",()=>{ar(r,e.value)}),s&&o&&s.addEventListener("change",()=>{ar(o,s.value)}),a&&u&&a.addEventListener("change",()=>{ar(u,a.value)})}function ar(n,t){const e=parseFloat(n.value);if(isNaN(e)||e<=0)return;const r=n.dataset.lastUnit||"oz";if(r===t)return;let s;if(t==="ml"&&r==="oz")s=e*29.5735;else if(t==="oz"&&r==="ml")s=e*.033814;else return;n.value=s.toFixed(2),n.dataset.lastUnit=t}function Ba(n){if(!n.value)return!0;const t=new Date(n.value),e=new Date;return t>e?(alert("Cannot select future times. Please select a time in the past."),n.value=vn(e),!1):!0}function be(n){const t=document.getElementById(n);t&&(t.addEventListener("blur",()=>{Ba(t)}),t.addEventListener("change",()=>{Ba(t)}))}function lp(){const n=document.getElementById("entry-type"),t=document.getElementById("submit-entry");n.addEventListener("change",up),t.addEventListener("click",cp);const e=document.getElementById("vitamin-d-checkbox");e&&e.addEventListener("change",sp);const r=document.getElementById("refresh-button");r&&r.addEventListener("click",()=>{window.location.reload()});const s=document.getElementById("entry-tab"),o=document.getElementById("timeline-tab"),a=document.getElementById("weekly-tab");s.addEventListener("click",()=>Ps("entry")),o.addEventListener("click",()=>Ps("timeline")),a.addEventListener("click",()=>Ps("weekly"));const u=document.getElementById("prev-week"),h=document.getElementById("next-week"),d=document.getElementById("current-week");u.addEventListener("click",()=>Fa(-1)),h.addEventListener("click",()=>Fa(1)),d&&d.addEventListener("click",fp);const m=document.getElementById("save-edit"),I=document.getElementById("cancel-edit");m.addEventListener("click",gp),I.addEventListener("click",bu);const v=document.getElementById("start-date-filter"),b=document.getElementById("end-date-filter"),C=document.getElementById("type-filter"),N=document.getElementById("today-button"),D=document.getElementById("yesterday-button"),O=document.getElementById("two-days-ago-button"),q=document.getElementById("three-days-ago-button"),$=document.getElementById("all-time-button");v.addEventListener("change",()=>de()),b.addEventListener("change",()=>de()),C.addEventListener("change",()=>de()),N.addEventListener("click",()=>hn("today")),D.addEventListener("click",()=>hn("yesterday")),O.addEventListener("click",()=>hn("two-days-ago")),q.addEventListener("click",()=>hn("three-days-ago")),$.addEventListener("click",()=>hn("all-time")),be("bottle-time"),be("diaper-time"),be("pump-start-time"),be("edit-bottle-time"),be("edit-diaper-time"),be("edit-pump-start-time")}function Oi(){const t=vn(new Date),e=document.getElementById("bottle-time"),r=document.getElementById("diaper-time"),s=document.getElementById("pump-start-time");e&&(e.value=t),r&&(r.value=t),s&&(s.value=t)}function up(n){const e=n.target.value,r=document.getElementById("bottle-fields"),s=document.getElementById("diaper-fields"),o=document.getElementById("pump-fields"),a=document.getElementById("submit-entry");if(r.style.display="none",s.style.display="none",o.style.display="none",e==="bottle-breast-milk"||e==="bottle-formula"){r.style.display="block",a.style.display="block";const u=document.getElementById("bottle-unit"),h=document.getElementById("bottle-amount");h.dataset.lastUnit=u.value}else if(e==="diaper")s.style.display="block",a.style.display="block";else if(e==="pump"){o.style.display="block",a.style.display="block";const u=document.getElementById("pump-unit"),h=document.getElementById("pump-amount");h.dataset.lastUnit=u.value}else a.style.display="none";Oi()}async function cp(){const n=document.getElementById("entry-type").value,t=document.getElementById("submit-status");try{let e=null;const r=new Date;if(n==="bottle-breast-milk"||n==="bottle-formula"){const s=document.getElementById("bottle-time"),o=s.value,a=parseFloat(document.getElementById("bottle-amount").value),u=document.getElementById("bottle-unit").value,h=document.getElementById("bottle-notes").value;if(!o)throw new Error("Start time is required");const d=new Date(s.value);if(d>r)throw new Error("Cannot add entries in the future");if(isNaN(a)||a<=0)throw new Error("Amount must be greater than 0");e={type:"Feed",subType:n==="bottle-breast-milk"?"Breast Milk":"Formula",startTime:d,amount:a,unit:u,notes:h}}else if(n==="diaper"){const s=document.getElementById("diaper-time"),o=s.value,a=document.getElementById("diaper-type").value,u=document.getElementById("diaper-notes").value;if(!o)throw new Error("Start time is required");const h=new Date(s.value);if(h>r)throw new Error("Cannot add entries in the future");if(!a)throw new Error("Diaper type is required");e={type:"Diaper",diaperType:a,startTime:h,notes:u}}else if(n==="pump"){const s=document.getElementById("pump-start-time"),o=s.value,a=parseFloat(document.getElementById("pump-amount").value),u=document.getElementById("pump-unit").value,h=document.getElementById("pump-notes").value;if(!o)throw new Error("Start time is required");const d=new Date(s.value);if(d>r)throw new Error("Cannot add entries in the future");if(isNaN(a)||a<=0)throw new Error("Amount must be greater than 0");e={type:"Pump",startTime:d,amount:a,unit:u,notes:h}}e&&(await Gm(ee(Rt,"entries"),{...e,startTime:Q.fromDate(e.startTime),endTime:e.endTime?Q.fromDate(e.endTime):null}),t.className="success",t.textContent="Entry added successfully!",t.style.display="block",hp(),e.type==="Feed"?await Su():e.type==="Diaper"?await Pu():e.type==="Pump"&&await Du(),setTimeout(()=>{t.style.display="none"},3e3))}catch(e){t.className="error",t.textContent=e instanceof Error?e.message:"Failed to add entry",t.style.display="block"}}function hp(){document.getElementById("entry-type").value="",document.getElementById("bottle-amount").value="",document.getElementById("bottle-notes").value="",document.getElementById("diaper-notes").value="",document.getElementById("pump-amount").value="",document.getElementById("pump-notes").value="",document.getElementById("bottle-fields").style.display="none",document.getElementById("diaper-fields").style.display="none",document.getElementById("pump-fields").style.display="none",document.getElementById("submit-entry").style.display="none",Oi()}function Ps(n){var t,e,r;document.querySelectorAll(".tab-button").forEach(s=>s.classList.remove("active")),document.querySelectorAll(".view").forEach(s=>s.style.display="none"),n==="entry"?((t=document.getElementById("entry-tab"))==null||t.classList.add("active"),document.getElementById("entry-view").style.display="block",Li()):n==="timeline"?((e=document.getElementById("timeline-tab"))==null||e.classList.add("active"),document.getElementById("timeline-view").style.display="block",de()):n==="weekly"&&((r=document.getElementById("weekly-tab"))==null||r.classList.add("active"),document.getElementById("weekly-view").style.display="block",Bi()),window.scrollTo(0,0)}function hn(n){const t=document.getElementById("start-date-filter"),e=document.getElementById("end-date-filter"),r=new Date;if(r.setHours(0,0,0,0),n==="all-time")t.value="",e.value="";else if(n==="today")t.value=Vt(r),e.value=Vt(r);else if(n==="yesterday"){const s=new Date(r);s.setDate(s.getDate()-1),t.value=Vt(s),e.value=Vt(s)}else if(n==="two-days-ago"){const s=new Date(r);s.setDate(s.getDate()-2),t.value=Vt(s),e.value=Vt(s)}else if(n==="three-days-ago"){const s=new Date(r);s.setDate(s.getDate()-3),t.value=Vt(s),e.value=Vt(s)}de()}async function de(){const n=document.getElementById("timeline-list"),t=document.getElementById("timeline-loading"),e=document.getElementById("start-date-filter").value,r=document.getElementById("end-date-filter").value,s=document.getElementById("type-filter").value;t.style.display="block",n.innerHTML="";const o=document.querySelector(".filter-summary");o&&o.remove();try{let a=ge(ee(Rt,"entries"),_e("startTime","desc"));if(e&&r){const[d,m,I]=e.split("-").map(Number),v=new Date(d,m-1,I,0,0,0,0),[b,C,N]=r.split("-").map(Number),D=new Date(b,C-1,N,23,59,59,999);a=ge(ee(Rt,"entries"),ye("startTime",">=",Q.fromDate(v)),ye("startTime","<=",Q.fromDate(D)),_e("startTime","desc"))}const u=await Ke(a),h={bottles:{total:0,breastMilk:0,formula:0,sessions:0},diapers:{total:0,pee:0,poo:0,mixed:0},pumps:{total:0,sessions:0}};if(u.empty)n.innerHTML="<p>No entries found.</p>";else{let d="",m=!1;if(u.forEach(I=>{const v=I.data(),b=I.id;if(s!=="all"){let g="";if(v.type==="Feed"&&v.subType==="Breast Milk"?g="bottle-breast-milk":v.type==="Feed"&&v.subType==="Formula"?g="bottle-formula":v.type==="Diaper"?g="diaper":v.type==="Pump"&&(g="pump"),s==="bottle-all"){if(v.type!=="Feed")return}else if(g!==s)return}if(v.type==="Feed"){const g=Cn(v.amount,v.unit);h.bottles.total+=g,h.bottles.sessions++,v.subType==="Breast Milk"?h.bottles.breastMilk+=g:v.subType==="Formula"&&(h.bottles.formula+=g)}else if(v.type==="Diaper")h.diapers.total++,v.diaperType==="Pee"?h.diapers.pee++:v.diaperType==="Poo"?h.diapers.poo++:v.diaperType==="Mixed"&&h.diapers.mixed++;else if(v.type==="Pump"){const g=Cn(v.amount,v.unit);h.pumps.total+=g,h.pumps.sessions++}m=!0;const C=v.startTime.toDate(),N=Xs(C);if(N!==d){d=N;const g=document.createElement("div");g.className="timeline-date-header",g.textContent=N,n.appendChild(g)}const D=document.createElement("div");D.className="timeline-entry";let O=v.type,q="",$="";v.type==="Feed"?(O=`Bottle - ${v.subType}`,q=`<div class="timeline-entry-details">Amount: ${Nt(v.amount,v.unit)}</div>`,$="#d9ebf2"):v.type==="Breast Feed"?(O="Breast Feed",q="",$="#d9ebf2"):v.type==="Diaper"?(q=`<div class="timeline-entry-details">Type: ${v.diaperType}</div>`,$="#fce2d4"):v.type==="Pump"&&(q=`<div class="timeline-entry-details">Amount: ${Nt(v.amount,v.unit)}</div>`,$="#e2daf2"),D.style.backgroundColor=$;const Z=v.notes?`<div class="timeline-entry-notes">${v.notes}</div>`:"";D.innerHTML=`
                ...
                `;const _t=D.querySelector(".edit-button"),x=D.querySelector(".delete-button");_t.addEventListener("click",()=>pp(b,v)),x.addEventListener("click",()=>yp(b)),n.appendChild(D)}),!m)n.innerHTML="<p>No entries match the selected filters.</p>";else{const I=document.createElement("div");I.className="filter-summary";let v='<div class="summary-header">Summary</div><div class="summary-stats">';if((s==="all"||s==="bottle-breast-milk"||s==="bottle-formula"||s==="bottle-all")&&(v+=`
                    ...
                    `),s==="all"||s==="diaper"){const C=h.diapers.pee+h.diapers.mixed,N=h.diapers.poo+h.diapers.mixed;v+=`
                        <div class="stat-group">
                            <div class="stat-group-title">Diapers</div>
                            <div class="stat-line">Pee: ${C}</div>
                    ...
                    `),v+="</div>",I.innerHTML=v;const b=document.querySelector(".filter-section");b&&b.parentNode&&b.parentNode.insertBefore(I,n)}}}catch{n.innerHTML='<p class="error">Failed to load timeline</p>'}finally{t.style.display="none"}}async function Bi(){const n=document.getElementById("weekly-stats"),t=document.getElementById("weekly-loading"),e=document.getElementById("week-range"),r=document.getElementById("prev-week"),s=document.getElementById("next-week"),o=document.getElementById("current-week"),u=Fe(new Date("2025-11-05")),d=Fe(new Date),m=new Date(kt);m.setHours(0,0,0,0),m<u&&(kt=new Date(u)),m.getTime()<=u.getTime()?r.disabled=!0:r.disabled=!1,m.getTime()>=d.getTime()?s.disabled=!0:s.disabled=!1,o&&(m.getTime()===d.getTime()?(o.disabled=!0,o.style.backgroundColor="#999",o.style.color="#ccc",o.style.cursor="default"):(o.disabled=!1,o.style.backgroundColor="",o.style.color="",o.style.cursor="pointer"));const I=np(kt);e.textContent=`${Xs(kt).split(",")[1].trim()} - ${Xs(I).split(",")[1].trim()}`,t.style.display="block",n.innerHTML="";try{const v=ge(ee(Rt,"entries"),ye("startTime",">=",Q.fromDate(kt)),ye("startTime","<=",Q.fromDate(I)),_e("startTime","asc")),b=await Ke(v),C=new Date("2025-11-11");C.setHours(0,0,0,0);const N={},D=[];for(let x=0;x<7;x++){const g=new Date(kt);if(g.setDate(g.getDate()+x),g.setHours(0,0,0,0),g>=C){const p=br(g);D.push(p)}}if(D.length>0){const x=await Promise.all(D.map(g=>Tu(He(Rt,"vitaminD",g))));D.forEach((g,p)=>{var E;const y=x[p];N[g]=y.exists()&&((E=y.data())==null?void 0:E.given)===!0})}const O={};for(let x=0;x<7;x++){const g=new Date(kt);g.setDate(g.getDate()+x),g.setHours(0,0,0,0);const p=`${g.getFullYear()}-${g.getMonth()}-${g.getDate()}`,y=br(g);O[p]={date:new Date(g),vitaminD:g>=C?N[y]===!0:null,bottles:{total:0,breastMilk:0,formula:0,sessions:0},diapers:{total:0,pee:0,poo:0,mixed:0},pumps:{total:0,sessions:0}}}b.forEach(x=>{const g=x.data(),p=g.startTime.toDate(),y=new Date(p);y.setHours(0,0,0,0);const E=`${y.getFullYear()}-${y.getMonth()}-${y.getDate()}`;if(O[E]){if(g.type==="Feed"){const T=Cn(g.amount,g.unit);O[E].bottles.total+=T,O[E].bottles.sessions++,g.subType==="Breast Milk"?O[E].bottles.breastMilk+=T:g.subType==="Formula"&&(O[E].bottles.formula+=T)}else if(g.type==="Breast Feed")O[E].bottles.sessions++;else if(g.type==="Diaper")O[E].diapers.total++,g.diaperType==="Pee"?O[E].diapers.pee++:g.diaperType==="Poo"?O[E].diapers.poo++:g.diaperType==="Mixed"&&O[E].diapers.mixed++;else if(g.type==="Pump"){const T=Cn(g.amount,g.unit);O[E].pumps.total+=T,O[E].pumps.sessions++}}});const q=Object.keys(O).map(x=>O[x]).sort((x,g)=>x.date.getTime()-g.date.getTime()),$=document.createElement("div");$.className="weekly-scroll-container";const Z=new Date;Z.setHours(0,0,0,0);let _t=-1;q.forEach((x,g)=>{const p=document.createElement("div");p.className="day-stats";const y=new Date(x.date);y.setHours(0,0,0,0),Z.getTime()===y.getTime()&&(p.classList.add("current-day"),_t=g);const E=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"][x.date.getDay()],T=`${x.date.getMonth()+1}/${x.date.getDate()}`,A=x.diapers.pee+x.diapers.mixed,_=x.diapers.poo+x.diapers.mixed;let bt="";if(x.vitaminD!==null){const se=x.vitaminD?"Yes":"No";bt=`
                    <div class="stat-group">
            ...
            `,$.appendChild(p)}),n.appendChild($),_t!==-1&&setTimeout(()=>{const x=$.children[_t];if(x){const g=$.offsetWidth,p=x.offsetWidth,y=x.offsetLeft-g/2+p/2;$.scrollTo({left:Math.max(0,y),behavior:"smooth"})}},100)}catch{n.innerHTML='<p class="error">Failed to load weekly view</p>'}finally{t.style.display="none",await dp()}}async function dp(){var r,s;const n=document.getElementById("json-content"),t=document.getElementById("toggle-json"),e=document.getElementById("copy-json");if(!(!n||!t||!e))try{const o=ge(ee(Rt,"entries"),_e("startTime","desc")),u=(await Ke(o)).docs.map(I=>{const v=I.data();return{id:I.id,type:v.type,subType:v.subType||null,startTime:v.startTime.toDate().toISOString(),endTime:v.endTime?v.endTime.toDate().toISOString():null,amount:v.amount||null,unit:v.unit||null,diaperType:v.diaperType||null,notes:v.notes||""}}),h=JSON.stringify(u,null,2);n.textContent=h;const d=t.cloneNode(!0),m=e.cloneNode(!0);(r=t.parentNode)==null||r.replaceChild(d,t),(s=e.parentNode)==null||s.replaceChild(m,e),d.addEventListener("click",()=>{const I=n.style.display==="none";n.style.display=I?"block":"none",m.style.display=I?"block":"none",d.textContent=I?"Hide JSON Data":"Show JSON Data"}),m.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(h);const I=m.textContent;m.textContent="✓",setTimeout(()=>{m.textContent=I},2e3)}catch{alert("Failed to copy to clipboard")}})}catch{n.textContent="Failed to load data"}}function Fa(n){const e=Fe(new Date("2025-11-05")),s=Fe(new Date),o=new Date(kt);o.setDate(o.getDate()+n*7),o.setHours(0,0,0,0);const a=new Date(e);a.setHours(0,0,0,0);const u=new Date(s);u.setHours(0,0,0,0),!(o.getTime()<a.getTime())&&(o.getTime()>u.getTime()||(kt=o,Bi()))}function fp(){kt=Fe(new Date),Bi()}function Cn(n,t){return t==="ml"?n*.033814:n}function mp(n,t){return t==="oz"?n*29.5735:n}function Nt(n,t){const e=Cn(n,t),r=mp(n,t);return`${e.toFixed(1)} oz / ${r.toFixed(0)} ml`}function pp(n,t){Rr=n;const e=document.getElementById("edit-modal"),r=document.getElementById("edit-bottle-fields"),s=document.getElementById("edit-diaper-fields"),o=document.getElementById("edit-pump-fields");r.style.display="none",s.style.display="none",o.style.display="none";const a=t.startTime.toDate();if(t.type==="Feed"){r.style.display="block";const u=document.getElementById("edit-bottle-unit"),h=document.getElementById("edit-bottle-amount");document.getElementById("edit-bottle-time").value=vn(a),h.value=t.amount.toFixed(2),u.value=t.unit||"oz",h.dataset.lastUnit=t.unit||"oz",document.getElementById("edit-bottle-notes").value=t.notes||""}else if(t.type==="Diaper")s.style.display="block",document.getElementById("edit-diaper-time").value=vn(a),document.getElementById("edit-diaper-type").value=t.diaperType,document.getElementById("edit-diaper-notes").value=t.notes||"";else if(t.type==="Pump"){o.style.display="block";const u=document.getElementById("edit-pump-unit"),h=document.getElementById("edit-pump-amount");document.getElementById("edit-pump-start-time").value=vn(a),h.value=t.amount.toFixed(2),u.value=t.unit||"oz",h.dataset.lastUnit=t.unit||"oz",document.getElementById("edit-pump-notes").value=t.notes||""}e.style.display="block"}function bu(){const n=document.getElementById("edit-modal");n.style.display="none",Rr=null;const t=document.getElementById("edit-status");t.style.display="none"}async function gp(){if(!Rr)return;const n=document.getElementById("edit-status");try{const t=document.getElementById("edit-bottle-fields"),e=document.getElementById("edit-diaper-fields"),r=document.getElementById("edit-pump-fields");let s={};const o=new Date;if(t.style.display==="block"){const a=document.getElementById("edit-bottle-time"),u=a.value,h=parseFloat(document.getElementById("edit-bottle-amount").value),d=document.getElementById("edit-bottle-unit").value,m=document.getElementById("edit-bottle-notes").value;if(!u)throw new Error("Start time is required");const I=new Date(a.value);if(I>o)throw new Error("Cannot set time in the future");if(isNaN(h)||h<=0)throw new Error("Amount must be greater than 0");s={startTime:Q.fromDate(I),amount:h,unit:d,notes:m}}else if(e.style.display==="block"){const a=document.getElementById("edit-diaper-time"),u=a.value,h=document.getElementById("edit-diaper-type").value,d=document.getElementById("edit-diaper-notes").value;if(!u)throw new Error("Start time is required");const m=new Date(a.value);if(m>o)throw new Error("Cannot set time in the future");if(!h)throw new Error("Diaper type is required");s={startTime:Q.fromDate(m),diaperType:h,notes:d}}else if(r.style.display==="block"){const a=document.getElementById("edit-pump-start-time"),u=a.value,h=parseFloat(document.getElementById("edit-pump-amount").value),d=document.getElementById("edit-pump-unit").value,m=document.getElementById("edit-pump-notes").value;if(!u)throw new Error("Start time is required");const I=new Date(a.value);if(I>o)throw new Error("Cannot set time in the future");if(isNaN(h)||h<=0)throw new Error("Amount must be greater than 0");s={startTime:Q.fromDate(I),amount:h,unit:d,notes:m}}await Km(He(Rt,"entries",Rr),s),n.className="success",n.textContent="Entry updated successfully!",n.style.display="block",setTimeout(async()=>{bu(),de(),await Fi()},1e3)}catch(t){n.className="error",n.textContent=t instanceof Error?t.message:"Failed to update entry",n.style.display="block"}}async function yp(n){if(confirm("Are you sure you want to delete this entry?"))try{await Wm(He(Rt,"entries",n)),de(),await Fi()}catch{alert("Failed to delete entry")}}async function _p(){await Fi(),ws&&clearInterval(ws),As&&clearInterval(As),Rs&&clearInterval(Rs),bs&&clearInterval(bs),ws=window.setInterval(()=>Cu(),1e3),As=window.setInterval(()=>Vu(),1e3),Rs=window.setInterval(()=>ku(),1e3),bs=window.setInterval(()=>Nu(),1e3)}async function Fi(){await Promise.all([Su(),Pu(),Du()])}async function Su(){try{const n=ge(ee(Rt,"entries"),ye("type","==","Feed"),_e("startTime","desc"),yu(1)),t=await Ke(n);if(t.empty)localStorage.removeItem("lastBottleTime");else{const r=t.docs[0].data().startTime.toDate();localStorage.setItem("lastBottleTime",r.toISOString())}Cu()}catch(n){console.error("Error fetching last bottle time:",n)}}async function Pu(){try{const n=ge(ee(Rt,"entries"),ye("type","==","Diaper"),_e("startTime","desc")),t=await Ke(n);let e,r;t.forEach(s=>{const o=s.data(),a=o.startTime.toDate();(o.diaperType==="Pee"||o.diaperType==="Mixed")&&e===void 0&&(e=a),(o.diaperType==="Poo"||o.diaperType==="Mixed")&&r===void 0&&(r=a)}),e!==void 0?localStorage.setItem("lastPeeTime",e.toISOString()):localStorage.removeItem("lastPeeTime"),r!==void 0?localStorage.setItem("lastPooTime",r.toISOString()):localStorage.removeItem("lastPooTime"),Vu(),ku()}catch(n){console.error("Error fetching last diaper times:",n)}}async function Du(){try{const n=ge(ee(Rt,"entries"),ye("type","==","Pump"),_e("startTime","desc"),yu(1)),t=await Ke(n);if(t.empty)localStorage.removeItem("lastPumpTime");else{const r=t.docs[0].data().startTime.toDate();localStorage.setItem("lastPumpTime",r.toISOString())}Nu()}catch(n){console.error("Error fetching last pump time:",n)}}function zr(n,t){if(!n)return t;const e=new Date(n),s=new Date().getTime()-e.getTime(),o=Math.floor(s/(1e3*60*60)),a=Math.floor(s%(1e3*60*60)/(1e3*60)),u=Math.floor(s%(1e3*60)/1e3);return o>0?`${o}h ${a}m ${u}s`:a>0?`${a}m ${u}s`:`${u}s`}function Cu(){const n=document.getElementById("last-bottle-value");if(!n)return;const t=localStorage.getItem("lastBottleTime");if(!t){n.innerHTML="No bottles recorded";return}const e=zr(t,"No bottles recorded"),r=new Date(t),s=[];for(let o=1;o<=3;o++){const a=new Date(r.getTime()+o*2.5*60*60*1e3),u=a.getHours(),h=String(a.getMinutes()).padStart(2,"0"),d=u>=12?"pm":"am",m=u%12||12;s.push(`${m}:${h} ${d}`)}n.innerHTML=`${e}<br><span style="font-size: 12px; color: #666;">(Next feeds: ${s.join(", ")})</span>`}function Vu(){const n=document.getElementById("last-pee-value");if(!n)return;const t=localStorage.getItem("lastPeeTime");n.textContent=zr(t,"No pee recorded")}function ku(){const n=document.getElementById("last-poo-value");if(!n)return;const t=localStorage.getItem("lastPooTime");n.textContent=zr(t,"No poo recorded")}function Nu(){const n=document.getElementById("last-pump-value");if(!n)return;const t=localStorage.getItem("lastPumpTime");if(!t){n.innerHTML="No pumps recorded";return}const e=zr(t,"No pumps recorded"),r=new Date(t),s=[];for(let o=1;o<=3;o++){const a=new Date(r.getTime()+o*2.5*60*60*1e3),u=a.getHours(),h=String(a.getMinutes()).padStart(2,"0"),d=u>=12?"pm":"am",m=u%12||12;s.push(`${m}:${h} ${d}`)}n.innerHTML=`${e}<br><span style="font-size: 12px; color: #666;">(Next pumps: ${s.join(", ")})</span>`}var Ua;(Ua=document.getElementById("passcode-submit"))==null||Ua.addEventListener("click",Au);var $a;($a=document.getElementById("passcode-input"))==null||$a.addEventListener("keypress",n=>{n.key==="Enter"&&Au()});window.addEventListener("DOMContentLoaded",()=>{if(tp()){const n=document.getElementById("passcode-screen"),t=document.getElementById("app");n.style.display="none",t.style.display="block",setTimeout(()=>{window.scrollTo(0,0),document.body.scrollTop=0,document.documentElement.scrollTop=0},0),Ru()}});
