 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _t{constructor(t,e,r,s,o,a,u){this.key=t,this.documentType=e,this.version=r,this.readTime=s,this.createTime=o,this.data=a,this.documentState=u}static newInvalidDocument(t){return new _t(t,0,$.min(),$.min(),$.min(),wt.empty(),0)}static newFoundDocument(t,e,r,s){return new _t(t,1,e,$.min(),r,s,0)}static newNoDocument(t,e){return new _t(t,2,e,$.min(),$.min(),wt.empty(),0)}static newUnknownDocument(t,e){return new _t(t,3,e,$.min(),$.min(),wt.empty(),2)}convertToFoundDocument(t,e){return!this.createTime.isEqual($.min())||this.documentType!==2&&this.documentType!==0||(this.createTime=t),this.version=t,this.documentType=1,this.data=e,this.documentState=0,this}convertToNoDocument(t){return this.version=t,this.documentType=2,this.data=wt.empty(),this.documentState=0,this}convertToUnknownDocument(t){return this.version=t,this.documentType=3,this.data=wt.empty(),this.documentState=2,this}setHasCommittedMutations(){return this.documentState=2,this}setHasLocalMutations(){return this.documentState=1,this.version=$.min(),this}setReadTime(t){return this.readTime=t,this}get hasLocalMutations(){return this.documentState===1}get hasCommittedMutations(){return this.documentState===2}get hasPendingWrites(){return this.hasLocalMutations||this.hasCommittedMutations}isValidDocument(){return this.documentType!==0}isFoundDocument(){return this.documentType===1}isNoDocument(){return this.documentType===2}isUnknownDocument(){return this.documentType===3}isEqual(t){return t instanceof _t&&this.key.isEqual(t.key)&&this.version.isEqual(t.version)&&this.documentType===t.documentType&&this.documentState===t.documentState&&this.data.isEqual(t.data)}mutableCopy(){return new _t(this.key,this.documentType,this.version,this.readTime,this.createTime,this.data.clone(),this.documentState)}toString(){return`Document(${this.key}, ${this.version}, ${JSON.stringify(this.data.value)}, {createTime: ${this.createTime}}), {documentType: ${this.documentType}}), {documentState: ${this.documentState}})`}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ff{constructor(){this.changes=new He(t=>t.toString(),(t,e)=>t.isEqual(e)),this.changesApplied=!1}addEntry(t){this.assertNotApplied(),this.changes.set(t.key,t)}removeEntry(t,e){this.assertNotApplied(),this.changes.set(t,_t.newInvalidDocument(t).setReadTime(e))}getEntry(t,e){this.assertNotApplied();const r=this.changes.get(e);return r!==void 0?C.resolve(r):this.getFromCache(t,e)}getEntries(t,e){return this.getAllFromCache(t,e)}apply(t){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(t)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ae{constructor(t,e,r){this.converter=e,this._query=r,this.type="query",this.firestore=t}withConverter(t){return new ae(this.firestore,t,this._query)}}class Tt{constructor(t,e,r){this.converter=e,this._key=r,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Zt(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new Tt(this.firestore,t,this._key)}}class Zt extends ae{constructor(t,e,r){super(t,e,ui(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new Tt(this.firestore,null,new O(t))}withConverter(t){return new Zt(this.firestore,t,this._path)}}function zt(n,t,...e){if(n=Ut(n),uu("collection","path",t),n instanceof Or){const r=tt.fromString(t,...e);return xa(r),new Zt(n,null,r)}{if(!(n instanceof Tt||n instanceof Zt))throw new L(S.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(tt.fromString(t,...e));return xa(r),new Zt(n.firestore,null,r)}}function We(n,t,...e){if(n=Ut(n),arguments.length===1&&(t=il.newId()),uu("doc","path",t),n instanceof Or){const r=tt.fromString(t,...e);return Na(r),new Tt(n,null,new O(r))}{if(!(n instanceof Tt||n instanceof Zt))throw new L(S.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(tt.fromString(t,...e));return Na(r),new Tt(n.firestore,n instanceof Zt?n.converter:null,new O(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`+h,s.selectionStart=a+2,s.selectionEnd=a+2}else if(e.key.length===1){const u=s.value.substring(0,a+1),h=s.value.substring(a+1);s.value=u+e.key+h,s.selectionStart=a+2,s.selectionEnd=a+2}return}}}),n.addEventListener("paste",e=>{const r=t.value;if(!r)return;const o=e.target.selectionStart,a=r.length;if(o<=a){e.preventDefault();return}}))}async function fp(){const n=document.getElementById("entry-type").value,t=document.getElementById("submit-status");try{let e=null;const r=new Date;if(n==="bottle-breast-milk"||n==="bottle-formula"){const s=document.getElementById("bottle-time"),o=s.value,a=parseFloat(document.getElementById("bottle-amount").value),u=document.getElementById("bottle-unit").value,h=document.getElementById("bottle-notes").value;if(!o)throw new Error("Start time is required");const d=new Date(s.value);if(d>r)throw new Error("Cannot add entries in the future");if(isNaN(a)||a<=0)throw new Error("Amount must be greater than 0");if(n==="bottle-formula"&&!document.getElementById("bottle-type").value)throw new Error("Formula type is required");e={type:"Feed",subType:n==="bottle-breast-milk"?"Breast Milk":"Formula",startTime:d,amount:a,unit:u,notes:h}}else if(n==="diaper"){const s=document.getElementById("diaper-time"),o=s.value,a=document.getElementById("diaper-type").value,u=document.getElementById("diaper-notes").value;if(!o)throw new Error("Start time is required");const h=new Date(s.value);if(h>r)throw new Error("Cannot add entries in the future");if(!a)throw new Error("Diaper type is required");e={type:"Diaper",diaperType:a,startTime:h,notes:u}}else if(n==="pump"){const s=document.getElementById("pump-start-time"),o=s.value,a=parseFloat(document.getElementById("pump-amount").value),u=document.getElementById("pump-unit").value,h=document.getElementById("pump-notes").value;if(!o)throw new Error("Start time is required");const d=new Date(s.value);if(d>r)throw new Error("Cannot add entries in the future");if(isNaN(a)||a<=0)throw new Error("Amount must be greater than 0");e={type:"Pump",startTime:d,amount:a,unit:u,notes:h}}e&&(await Wm(zt(At,"entries"),{...e,startTime:Q.fromDate(e.startTime),endTime:e.endTime?Q.fromDate(e.endTime):null}),t.className="success",t.textContent="Entry added successfully!",t.style.display="block",mp(),e.type==="Feed"?await Ru():e.type==="Diaper"?await Su():e.type==="Pump"&&await Du(),setTimeout(()=>{t.style.display="none"},3e3))}catch(e){t.className="error",t.textContent=e instanceof Error?e.message:"Failed to add entry",t.style.display="block"}}function mp(){document.getElementById("entry-type").value="",document.getElementById("bottle-amount").value="",document.getElementById("bottle-type").value="",document.getElementById("bottle-notes").value="",document.getElementById("diaper-notes").value="",document.getElementById("pump-amount").value="",document.getElementById("pump-notes").value="",document.getElementById("bottle-fields").style.display="none",document.getElementById("bottle-type-container").style.display="none",document.getElementById("diaper-fields").style.display="none",document.getElementById("pump-fields").style.display="none",document.getElementById("submit-entry").style.display="none",Fi()}function Cs(n){var t,e,r;document.querySelectorAll(".tab-button").forEach(s=>s.classList.remove("active")),document.querySelectorAll(".view").forEach(s=>s.style.display="none"),n==="entry"?((t=document.getElementById("entry-tab"))==null||t.classList.add("active"),document.getElementById("entry-view").style.display="block",Oi()):n==="timeline"?((e=document.getElementById("timeline-tab"))==null||e.classList.add("active"),document.getElementById("timeline-view").style.display="block",Sr(),ge()):n==="weekly"&&((r=document.getElementById("weekly-tab"))==null||r.classList.add("active"),document.getElementById("weekly-view").style.display="block",Sr()),window.scrollTo(0,0)}function dn(n){const t=document.getElementById("start-date-filter"),e=document.getElementById("end-date-filter"),r=new Date;if(r.setHours(0,0,0,0),n==="all-time")t.value="",e.value="";else if(n==="today")t.value=It(r),e.value=It(r);else if(n==="yesterday"){const s=new Date(r);s.setDate(s.getDate()-1),t.value=It(s),e.value=It(s)}else if(n==="two-days-ago"){const s=new Date(r);s.setDate(s.getDate()-2),t.value=It(s),e.value=It(s)}else if(n==="three-days-ago"){const s=new Date(r);s.setDate(s.getDate()-3),t.value=It(s),e.value=It(s)}ge()}async function ge(){const n=document.getElementById("timeline-list"),t=document.getElementById("timeline-loading"),e=document.getElementById("start-date-filter").value,r=document.getElementById("end-date-filter").value,s=document.getElementById("type-filter").value;t.style.display="block",n.innerHTML="";const o=document.querySelector(".filter-summary");o&&o.remove();try{let a=se(zt(At,"entries"),ie("startTime","desc"));if(e&&r){const[d,m,T]=e.split("-").map(Number),v=new Date(d,m-1,T,0,0,0,0),[R,P,N]=r.split("-").map(Number),D=new Date(R,P-1,N,23,59,59,999);a=se(zt(At,"entries"),Ht("startTime",">=",Q.fromDate(v)),Ht("startTime","<=",Q.fromDate(D)),ie("startTime","desc"))}const u=await we(a),h={bottles:{total:0,breastMilk:0,formula:0,sessions:0},diapers:{total:0,pee:0,poo:0,mixed:0},pumps:{total:0,sessions:0}};if(u.empty)n.innerHTML="<p>No entries found.</p>";else{let d="",m=!1;if(u.forEach(T=>{const v=T.data(),R=T.id;if(s!=="all"){let p="";if(v.type==="Feed"&&v.subType==="Breast Milk"?p="bottle-breast-milk":v.type==="Feed"&&v.subType==="Formula"?p="bottle-formula":v.type==="Diaper"?p="diaper-all":v.type==="Pump"&&(p="pump"),s==="bottle-all"){if(v.type!=="Feed")return}else if(s==="diaper-all"){if(v.type!=="Diaper")return}else if(s==="diaper-pee"){if(v.type!=="Diaper"||v.diaperType!=="Pee"&&v.diaperType!=="Mixed")return}else if(s==="diaper-poo"){if(v.type!=="Diaper"||v.diaperType!=="Poo"&&v.diaperType!=="Mixed")return}else if(p!==s)return}if(v.type==="Feed"){const p=te(v.amount,v.unit);h.bottles.total+=p,h.bottles.sessions++,v.subType==="Breast Milk"?h.bottles.breastMilk+=p:v.subType==="Formula"&&(h.bottles.formula+=p)}else if(v.type==="Diaper")h.diapers.total++,v.diaperType==="Pee"?h.diapers.pee++:v.diaperType==="Poo"?h.diapers.poo++:v.diaperType==="Mixed"&&h.diapers.mixed++;else if(v.type==="Pump"){const p=te(v.amount,v.unit);h.pumps.total+=p,h.pumps.sessions++}m=!0;const P=v.startTime.toDate(),N=Zs(P);if(N!==d){d=N;const p=document.createElement("div");p.className="timeline-date-header",p.textContent=N,n.appendChild(p)}const D=document.createElement("div");D.className="timeline-entry";let k=v.type,F="",B="";v.type==="Feed"?(k=`Bottle - ${v.subType}`,F=`<div class="timeline-entry-details">Amount: ${Nt(v.amount,v.unit)}</div>`,B="#d9ebf2"):v.type==="Breast Feed"?(k="Breast Feed",F="",B="#d9ebf2"):v.type==="Diaper"?(F=`<div class="timeline-entry-details">Type: ${v.diaperType}</div>`,B="#fce2d4"):v.type==="Pump"&&(F=`<div class="timeline-entry-details">Amount: ${Nt(v.amount,v.unit)}</div>`,B="#e2daf2"),D.style.backgroundColor=B;const j=v.notes?`<div class="timeline-entry-notes">${v.notes.replace(/\n/g,"<br>")}</div>`:"";let J="";if(s==="diaper-poo"&&v.type==="Diaper"&&(v.diaperType==="Poo"||v.diaperType==="Mixed")){const p=P.getTime(),g=[];u.forEach(I=>{const w=I.data();w.type==="Diaper"&&(w.diaperType==="Poo"||w.diaperType==="Mixed")&&g.push({time:w.startTime.toDate().getTime()})}),g.sort((I,w)=>w.time-I.time);const y=g.findIndex(I=>I.time===p);if(y<g.length-1){const I=g[y+1].time;J=`<div class="timeline-entry-details" style="color: #666; font-style: italic;">${((p-I)/(1e3*60*60)).toFixed(1)} hours since previous poo</div>`}}D.innerHTML=`
                ...
                `;const x=D.querySelector(".edit-button"),_=D.querySelector(".delete-button");x.addEventListener("click",()=>Ep(R,v)),_.addEventListener("click",()=>Tp(R)),n.appendChild(D)}),!m)n.innerHTML="<p>No entries match the selected filters.</p>";else{const T=document.createElement("div");T.className="filter-summary";let v='<div class="summary-header">Summary</div><div class="summary-stats">';if((s==="all"||s==="bottle-breast-milk"||s==="bottle-formula"||s==="bottle-all")&&(v+=`
                    ...
                    `),v+="</div>",T.innerHTML=v;const R=document.querySelector(".filter-section");R&&R.parentNode&&R.parentNode.insertBefore(T,n)}}}catch{n.innerHTML='<p class="error">Failed to load timeline</p>'}finally{t.style.display="none"}}async function Sr(){const n=document.getElementById("weekly-stats"),t=document.getElementById("weekly-loading"),e=document.getElementById("week-range"),r=document.getElementById("prev-week"),s=document.getElementById("next-week"),o=document.getElementById("current-week"),u=$e(new Date("2025-11-05")),d=$e(new Date),m=new Date(kt);m.setHours(0,0,0,0),m<u&&(kt=new Date(u)),m.getTime()<=u.getTime()?r.disabled=!0:r.disabled=!1,m.getTime()>=d.getTime()?s.disabled=!0:s.disabled=!1,o&&(m.getTime()===d.getTime()?(o.disabled=!0,o.style.backgroundColor="#999",o.style.color="#ccc",o.style.cursor="default"):(o.disabled=!1,o.style.backgroundColor="",o.style.color="",o.style.cursor="pointer"));const T=ep(kt);e.textContent=`${Zs(kt).split(",")[1].trim()} - ${Zs(T).split(",")[1].trim()}`,t.style.display="block",n.innerHTML="";try{const v=se(zt(At,"entries"),Ht("startTime",">=",Q.fromDate(kt)),Ht("startTime","<=",Q.fromDate(T)),ie("startTime","asc")),R=await we(v),P=new Date("2025-11-11");P.setHours(0,0,0,0);const N={},D=[];for(let x=0;x<7;x++){const _=new Date(kt);if(_.setDate(_.getDate()+x),_.setHours(0,0,0,0),_>=P){const p=Rr(_);D.push(p)}}if(D.length>0){const x=await Promise.all(D.map(_=>Tu(We(At,"vitaminD",_))));D.forEach((_,p)=>{var y;const g=x[p];N[_]=g.exists()&&((y=g.data())==null?void 0:y.given)===!0})}const k={};for(let x=0;x<7;x++){const _=new Date(kt);_.setDate(_.getDate()+x),_.setHours(0,0,0,0);const p=`${_.getFullYear()}-${_.getMonth()}-${_.getDate()}`,g=Rr(_);k[p]={date:new Date(_),vitaminD:_>=P?N[g]===!0:null,bottles:{total:0,breastMilk:0,formula:0,sessions:0},diapers:{total:0,pee:0,poo:0,mixed:0},pumps:{total:0,sessions:0}}}R.forEach(x=>{const _=x.data(),p=_.startTime.toDate(),g=new Date(p);g.setHours(0,0,0,0);const y=`${g.getFullYear()}-${g.getMonth()}-${g.getDate()}`;if(k[y]){if(_.type==="Feed"){const I=te(_.amount,_.unit);k[y].bottles.total+=I,k[y].bottles.sessions++,_.subType==="Breast Milk"?k[y].bottles.breastMilk+=I:_.subType==="Formula"&&(k[y].bottles.formula+=I)}else if(_.type==="Breast Feed")k[y].bottles.sessions++;else if(_.type==="Diaper")k[y].diapers.total++,_.diaperType==="Pee"?k[y].diapers.pee++:_.diaperType==="Poo"?k[y].diapers.poo++:_.diaperType==="Mixed"&&k[y].diapers.mixed++;else if(_.type==="Pump"){const I=te(_.amount,_.unit);k[y].pumps.total+=I,k[y].pumps.sessions++}}});const F=Object.keys(k).map(x=>k[x]).sort((x,_)=>x.date.getTime()-_.date.getTime()),B=document.createElement("div");B.className="weekly-scroll-container";const j=new Date;j.setHours(0,0,0,0);let J=-1;F.forEach((x,_)=>{const p=document.createElement("div");p.className="day-stats";const g=new Date(x.date);g.setHours(0,0,0,0),j.getTime()===g.getTime()&&(p.classList.add("current-day"),J=_);const y=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"][x.date.getDay()],I=`${x.date.getMonth()+1}/${x.date.getDate()}`,w=x.diapers.pee+x.diapers.mixed,E=x.diapers.poo+x.diapers.mixed;let St="";if(x.vitaminD!==null){const le=x.vitaminD?"Yes":"No";St=`
                    <div class="stat-group">
