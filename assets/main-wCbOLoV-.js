 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xu="FirebaseError";class Ce extends Error{constructor(t,e,r){super(e),this.code=t,this.customData=r,this.name=Xu,Object.setPrototypeOf(this,Ce.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Sa.prototype.create)}}class Sa{constructor(t,e,r){this.service=t,this.serviceName=e,this.errors=r}create(t,...e){const r=e[0]||{},s=`${this.service}/${t}`,o=this.errors[t],a=o?Ju(o,r):"Error",u=`${this.serviceName}: ${a} (${s}).`;return new Ce(s,u,r)}}function Ju(n,t){return n.replace(Zu,(e,r)=>{const s=t[r];return s!=null?String(s):`<${r}?>`})}const Zu=/\{\$([^}]+)}/g;function us(n,t){if(n===t)return!0;const e=Object.keys(n),r=Object.keys(t);for(const s of e){if(!r.includes(s))return!1;const o=n[s],a=t[s];if(Ao(o)&&Ao(a)){if(!us(o,a))return!1}else if(o!==a)return!1}for(const s of r)if(!e.includes(s))return!1;return!0}function Ao(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ot=new ba("@firebase/app"),Tc="@firebase/app-compat",Ic="@firebase/analytics-compat",wc="@firebase/analytics",Ac="@firebase/app-check-compat",Rc="@firebase/app-check",Sc="@firebase/auth",bc="@firebase/auth-compat",Pc="@firebase/database",Vc="@firebase/data-connect",Cc="@firebase/database-compat",Dc="@firebase/functions",kc="@firebase/functions-compat",Nc="@firebase/installations",Mc="@firebase/installations-compat",xc="@firebase/messaging",Oc="@firebase/messaging-compat",Lc="@firebase/performance",Fc="@firebase/performance-compat",Bc="@firebase/remote-config",Uc="@firebase/remote-config-compat",qc="@firebase/storage",$c="@firebase/storage-compat",jc="@firebase/firestore",zc="@firebase/vertexai-preview",Kc="@firebase/firestore-compat",Wc="firebase",Hc="10.14.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fs="[DEFAULT]",Gc={[ds]:"fire-core",[Tc]:"fire-core-compat",[wc]:"fire-analytics",[Ic]:"fire-analytics-compat",[Rc]:"fire-app-check",[Ac]:"fire-app-check-compat",[Sc]:"fire-auth",[bc]:"fire-auth-compat",[Pc]:"fire-rtdb",[Vc]:"fire-data-connect",[Cc]:"fire-rtdb-compat",[Dc]:"fire-fn",[kc]:"fire-fn-compat",[Nc]:"fire-iid",[Mc]:"fire-iid-compat",[xc]:"fire-fcm",[Oc]:"fire-fcm-compat",[Lc]:"fire-perf",[Fc]:"fire-perf-compat",[Bc]:"fire-rc",[Uc]:"fire-rc-compat",[qc]:"fire-gcs",[$c]:"fire-gcs-compat",[jc]:"fire-fst",[Kc]:"fire-fst-compat",[zc]:"fire-vertex","fire-js":"fire-js",[Wc]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nr=new Map,Qc=new Map,ms=new Map;function Vo(n,t){try{n.container.addComponent(t)}catch(e){Ot.debug(`Component ${t.name} failed to register with FirebaseApp ${n.name}`,e)}}function rr(n){const t=n.name;if(ms.has(t))return Ot.debug(`There were multiple attempts to register component ${t}.`),!1;ms.set(t,n);for(const e of nr.values())Vo(e,n);for(const e of Qc.values())Vo(e,n);return!0}function Yc(n,t){const e=n.container.getProvider("heartbeat").getImmediate({optional:!0});return e&&e.triggerHeartbeat(),n.container.getProvider(t)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zc=Hc;function Ca(n,t={}){let e=n;typeof t!="object"&&(t={name:t});const r=Object.assign({name:fs,automaticDataCollectionEnabled:!1},t),s=r.name;if(typeof s!="string"||!s)throw Kt.create("bad-app-name",{appName:String(s)});if(e||(e=Ra()),!e)throw Kt.create("no-options");const o=nr.get(s);if(o){if(us(e,o.options)&&us(r,o.config))return o;throw Kt.create("duplicate-app",{appName:s})}const a=new rc(s);for(const h of ms.values())a.addComponent(h);const u=new Jc(e,r,a);return nr.set(s,u),u}function th(n=fs){const t=nr.get(n);if(!t&&n===fs&&Ra())return Ca();if(!t)throw Kt.create("no-app",{appName:n});return t}function Ee(n,t,e){var r;let s=(r=Gc[n])!==null&&r!==void 0?r:n;e&&(s+=`-${e}`);const o=s.match(/\s|\//),a=t.match(/\s|\//);if(o||a){const u=[`Unable to register library "${s}" with version "${t}":`];o&&u.push(`library name "${s}" contains illegal characters (whitespace or "/")`),o&&a&&u.push("and"),a&&u.push(`version name "${t}" contains illegal characters (whitespace or "/")`),Ot.warn(u.join(" "));return}rr(new un(`${s}-version`,()=>({library:s,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const eh="firebase-heartbeat-database",nh=1,cn="firebase-heartbeat-store";let ns=null;function Da(){return ns||(ns=gc(eh,nh,{upgrade:(n,t)=>{switch(t){case 0:try{n.createObjectStore(cn)}catch(e){console.warn(e)}}}}).catch(n=>{throw Kt.create("idb-open",{originalErrorMessage:n.message})})),ns}async function rh(n){try{const e=(await Da()).transaction(cn),r=await e.objectStore(cn).get(ka(n));return await e.done,r}catch(t){if(t instanceof Ce)Ot.warn(t.message);else{const e=Kt.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});Ot.warn(e.message)}}}async function Co(n,t){try{const r=(await Da()).transaction(cn,"readwrite");await r.objectStore(cn).put(t,ka(n)),await r.done}catch(e){if(e instanceof Ce)Ot.warn(e.message);else{const r=Kt.create("idb-set",{originalErrorMessage:e==null?void 0:e.message});Ot.warn(r.message)}}}function ka(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function uh(n){rr(new un("platform-logger",t=>new Ec(t),"PRIVATE")),rr(new un("heartbeat",t=>new oh(t),"PRIVATE")),Ee(ds,Po,n),Ee(ds,Po,"esm2017"),Ee("fire-js","")}uh("");var ch="firebase",hh="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Ee(ch,hh,"app");var No=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ie=new ba("@firebase/firestore");function Ze(){return ie.logLevel}function M(n,...t){if(ie.logLevel<=z.DEBUG){const e=t.map(Ms);ie.debug(`Firestore (${De}): ${n}`,...e)}}function Lt(n,...t){if(ie.logLevel<=z.ERROR){const e=t.map(Ms);ie.error(`Firestore (${De}): ${n}`,...e)}}function Te(n,...t){if(ie.logLevel<=z.WARN){const e=t.map(Ms);ie.warn(`Firestore (${De}): ${n}`,...e)}}function Ms(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function O(n="Unexpected state"){const t=`FIRESTORE (${De}) INTERNAL ASSERTION FAILED: `+n;throw Lt(t),new Error(t)}function H(n,t){n||O()}function B(n,t){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function yn(n){if(n.code!==S.FAILED_PRECONDITION||n.message!==Ah)throw n;M("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xs{constructor(t,e){this.previousValue=t,e&&(e.sequenceNumberHandler=r=>this.ie(r),this.se=r=>e.writeSequenceNumber(r))}ie(t){return this.previousValue=Math.max(t,this.previousValue),this.previousValue}next(){const t=++this.previousValue;return this.se&&this.se(t),t}}xs.oe=-1;function fr(n){return n==null}function sr(n){return n===0&&1/n==-1/0}function bh(n){return typeof n=="number"&&Number.isInteger(n)&&!sr(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vt{constructor(t){this.value=t}static empty(){return new vt({mapValue:{}})}field(t){if(t.isEmpty())return this.value;{let e=this.value;for(let r=0;r<t.length-1;++r)if(e=(e.mapValue.fields||{})[t.get(r)],!Xn(e))return null;return e=(e.mapValue.fields||{})[t.lastSegment()],e||null}}set(t,e){this.getFieldsMap(t.popLast())[t.lastSegment()]=sn(e)}setAll(t){let e=lt.emptyPath(),r={},s=[];t.forEach((a,u)=>{if(!e.isImmediateParentOf(u)){const h=this.getFieldsMap(e);this.applyChanges(h,r,s),r={},s=[],e=u.popLast()}a?r[u.lastSegment()]=sn(a):s.push(u.lastSegment())});const o=this.getFieldsMap(e);this.applyChanges(o,r,s)}delete(t){const e=this.field(t.popLast());Xn(e)&&e.mapValue.fields&&delete e.mapValue.fields[t.lastSegment()]}isEqual(t){return Ct(this.value,t.value)}getFieldsMap(t){let e=this.value;e.mapValue.fields||(e.mapValue={fields:{}});for(let r=0;r<t.length;++r){let s=e.mapValue.fields[t.get(r)];Xn(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},e.mapValue.fields[t.get(r)]=s),e=s}return e.mapValue.fields}applyChanges(t,e,r){ue(e,(s,o)=>t[s]=o);for(const s of r)delete t[s]}clone(){return new vt(sn(this.value))}}function ja(n){const t=[];return ue(n.fields,(e,r)=>{const s=new lt([e]);if(Xn(r)){const o=ja(r.mapValue).fields;if(o.length===0)t.push(s);else for(const a of o)t.push(s.child(a))}else t.push(s)}),new It(t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qs(n,t){if(n.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:sr(t)?"-0":t}}function rl(n){return{integerValue:""+n}}function Xh(n,t){return bh(t)?rl(t):qs(n,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gr{constructor(){this._=void 0}}function Jh(n,t,e){return n instanceof or?function(s,o){const a={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return o&&Os(o)&&(o=Ls(o)),o&&(a.fields.__previous_value__=o),{mapValue:a}}(e,t):n instanceof gn?il(n,t):n instanceof _n?ol(n,t):function(s,o){const a=sl(s,o),u=Wo(a)+Wo(s.Pe);return _s(a)&&_s(s.Pe)?rl(u):qs(s.serializer,u)}(n,t)}function Zh(n,t,e){return n instanceof gn?il(n,t):n instanceof _n?ol(n,t):e}function sl(n,t){return n instanceof ar?function(r){return _s(r)||function(o){return!!o&&"doubleValue"in o}(r)}(t)?t:{integerValue:0}:null}class or extends gr{}class gn extends gr{constructor(t){super(),this.elements=t}}function il(n,t){const e=al(t);for(const r of n.elements)e.some(s=>Ct(s,r))||e.push(r);return{arrayValue:{values:e}}}class _n extends gr{constructor(t){super(),this.elements=t}}function ol(n,t){let e=al(t);for(const r of n.elements)e=e.filter(s=>!Ct(s,r));return{arrayValue:{values:e}}}class ar extends gr{constructor(t,e){super(),this.serializer=t,this.Pe=e}}function Wo(n){return tt(n.integerValue||n.doubleValue)}function al(n){return Fs(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}function td(n,t){return n.field.isEqual(t.field)&&function(r,s){return r instanceof gn&&s instanceof gn||r instanceof _n&&s instanceof _n?Ie(r.elements,s.elements,Ct):r instanceof ar&&s instanceof ar?Ct(r.Pe,s.Pe):r instanceof or&&s instanceof or}(n.transform,t.transform)}class ed{constructor(t,e){this.version=t,this.transformResults=e}}class St{constructor(t,e){this.updateTime=t,this.exists=e}static none(){return new St}static exists(t){return new St(void 0,t)}static updateTime(t){return new St(t)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(t){return this.exists===t.exists&&(this.updateTime?!!t.updateTime&&this.updateTime.isEqual(t.updateTime):!t.updateTime)}}function Jn(n,t){return n.updateTime!==void 0?t.isFoundDocument()&&t.version.isEqual(n.updateTime):n.exists===void 0||n.exists===t.isFoundDocument()}class _r{}function ll(n,t){if(!n.hasLocalMutations||t&&t.fields.length===0)return null;if(t===null)return n.isNoDocument()?new $s(n.key,St.none()):new vn(n.key,n.data,St.none());{const e=n.data,r=vt.empty();let s=new ut(lt.comparator);for(let o of t.fields)if(!s.has(o)){let a=e.field(o);a===null&&o.length>1&&(o=o.popLast(),a=e.field(o)),a===null?r.delete(o):r.set(o,a),s=s.add(o)}return new Xt(n.key,r,new It(s.toArray()),St.none())}}function nd(n,t,e){n instanceof vn?function(s,o,a){const u=s.value.clone(),h=Go(s.fieldTransforms,o,a.transformResults);u.setAll(h),o.convertToFoundDocument(a.version,u).setHasCommittedMutations()}(n,t,e):n instanceof Xt?function(s,o,a){if(!Jn(s.precondition,o))return void o.convertToUnknownDocument(a.version);const u=Go(s.fieldTransforms,o,a.transformResults),h=o.data;h.setAll(ul(s)),h.setAll(u),o.convertToFoundDocument(a.version,h).setHasCommittedMutations()}(n,t,e):function(s,o,a){o.convertToNoDocument(a.version).setHasCommittedMutations()}(0,t,e)}function ln(n,t,e,r){return n instanceof vn?function(o,a,u,h){if(!Jn(o.precondition,a))return u;const f=o.value.clone(),m=Qo(o.fieldTransforms,h,a);return f.setAll(m),a.convertToFoundDocument(a.version,f).setHasLocalMutations(),null}(n,t,e,r):n instanceof Xt?function(o,a,u,h){if(!Jn(o.precondition,a))return u;const f=Qo(o.fieldTransforms,h,a),m=a.data;return m.setAll(ul(o)),m.setAll(f),a.convertToFoundDocument(a.version,m).setHasLocalMutations(),u===null?null:u.unionWith(o.fieldMask.fields).unionWith(o.fieldTransforms.map(w=>w.field))}(n,t,e,r):function(o,a,u){return Jn(o.precondition,a)?(a.convertToNoDocument(a.version).setHasLocalMutations(),null):u}(n,t,e)}function rd(n,t){let e=null;for(const r of n.fieldTransforms){const s=t.data.field(r.field),o=sl(r.transform,s||null);o!=null&&(e===null&&(e=vt.empty()),e.set(r.field,o))}return e||null}function Ho(n,t){return n.type===t.type&&!!n.key.isEqual(t.key)&&!!n.precondition.isEqual(t.precondition)&&!!function(r,s){return r===void 0&&s===void 0||!(!r||!s)&&Ie(r,s,(o,a)=>td(o,a))}(n.fieldTransforms,t.fieldTransforms)&&(n.type===0?n.value.isEqual(t.value):n.type!==1||n.data.isEqual(t.data)&&n.fieldMask.isEqual(t.fieldMask))}class vn extends _r{constructor(t,e,r,s=[]){super(),this.key=t,this.value=e,this.precondition=r,this.fieldTransforms=s,this.type=0}getFieldMask(){return null}}class Xt extends _r{constructor(t,e,r,s,o=[]){super(),this.key=t,this.data=e,this.fieldMask=r,this.precondition=s,this.fieldTransforms=o,this.type=1}getFieldMask(){return this.fieldMask}}function ul(n){const t=new Map;return n.fieldMask.fields.forEach(e=>{if(!e.isEmpty()){const r=n.data.field(e);t.set(e,r)}}),t}function Go(n,t,e){const r=new Map;H(n.length===e.length);for(let s=0;s<e.length;s++){const o=n[s],a=o.transform,u=t.data.field(o.field);r.set(o.field,Zh(a,u,e[s]))}return r}function Qo(n,t,e){const r=new Map;for(const s of n){const o=s.transform,a=e.data.field(s.field);r.set(s.field,Jh(o,a,t))}return r}class $s extends _r{constructor(t,e){super(),this.key=t,this.precondition=e,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class sd extends _r{constructor(t,e){super(),this.key=t,this.precondition=e,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yr{constructor(t,e,r,s,o){this.snapshotVersion=t,this.targetChanges=e,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=o}static createSynthesizedRemoteEventForCurrentChange(t,e,r){const s=new Map;return s.set(t,Tn.createSynthesizedTargetChangeForCurrentChange(t,e,r)),new yr(F.min(),s,new J(W),Ft(),q())}}class Tn{constructor(t,e,r,s,o){this.resumeToken=t,this.current=e,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=o}static createSynthesizedTargetChangeForCurrentChange(t,e,r){return new Tn(r,e,q(),q(),q())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nd{constructor(){this.changes=new Ne(t=>t.toString(),(t,e)=>t.isEqual(e)),this.changesApplied=!1}addEntry(t){this.assertNotApplied(),this.changes.set(t.key,t)}removeEntry(t,e){this.assertNotApplied(),this.changes.set(t,_t.newInvalidDocument(t).setReadTime(e))}getEntry(t,e){this.assertNotApplied();const r=this.changes.get(e);return r!==void 0?V.resolve(r):this.getFromCache(t,e)}getEntries(t,e){return this.getAllFromCache(t,e)}apply(t){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(t)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wd{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return Gu()?8:Sh(Wu())>0?6:4}()}initialize(t,e){this.Ji=t,this.indexManager=e,this.Gi=!0}getDocumentsMatchingQuery(t,e,r,s){const o={result:null};return this.Yi(t,e).next(a=>{o.result=a}).next(()=>{if(!o.result)return this.Zi(t,e,s,r).next(a=>{o.result=a})}).next(()=>{if(o.result)return;const a=new Kd;return this.Xi(t,e,a).next(u=>{if(o.result=u,this.zi)return this.es(t,e,a,u.size)})}).next(()=>o.result)}es(t,e,r,s){return r.documentReadCount<this.ji?(Ze()<=z.DEBUG&&M("QueryEngine","SDK will not create cache indexes for query:",ge(e),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),V.resolve()):(Ze()<=z.DEBUG&&M("QueryEngine","Query:",ge(e),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.Hi*s?(Ze()<=z.DEBUG&&M("QueryEngine","The SDK decides to create cache indexes for query:",ge(e),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(t,Pt(e))):V.resolve())}Yi(t,e){if(Ko(e))return V.resolve(null);let r=Pt(e);return this.indexManager.getIndexType(t,r).next(s=>s===0?null:(e.limit!==null&&s===1&&(e=Ts(e,null,"F"),r=Pt(e)),this.indexManager.getDocumentsMatchingTarget(t,r).next(o=>{const a=q(...o);return this.Ji.getDocuments(t,a).next(u=>this.indexManager.getMinOffset(t,r).next(h=>{const f=this.ts(e,u);return this.ns(e,f,a,h.readTime)?this.Yi(t,Ts(e,null,"F")):this.rs(t,f,e,h)}))})))}Zi(t,e,r,s){return Ko(e)||s.isEqual(F.min())?V.resolve(null):this.Ji.getDocuments(t,r).next(o=>{const a=this.ts(e,o);return this.ns(e,a,r,s)?V.resolve(null):(Ze()<=z.DEBUG&&M("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),ge(e)),this.rs(t,a,e,Th(s,-1)).next(u=>u))})}ts(t,e){let r=new ut(Za(t));return e.forEach((s,o)=>{pr(t,o)&&(r=r.add(o))}),r}ns(t,e,r,s){if(t.limit===null)return!1;if(r.size!==e.size)return!0;const o=t.limitType==="F"?e.last():e.first();return!!o&&(o.hasPendingWrites||o.version.compareTo(s)>0)}Xi(t,e,r){return Ze()<=z.DEBUG&&M("QueryEngine","Using full collection scan to execute query:",ge(e)),this.Ji.getDocumentsMatchingQuery(t,e,Gt.min(),r)}rs(t,e,r,s){return this.Ji.getDocumentsMatchingQuery(t,r,s).next(o=>(e.forEach(a=>{o=o.insert(a.key,a)}),o))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pt="WebChannelConnection";class of extends class{constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const r=e.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),o=encodeURIComponent(this.databaseId.database);this.Do=r+"://"+e.host,this.vo=`projects/${s}/databases/${o}`,this.Co=this.databaseId.database==="(default)"?`project_id=${s}`:`project_id=${s}&database_id=${o}`}get Fo(){return!1}Mo(e,r,s,o,a){const u=ss(),h=this.xo(e,r.toUriEncodedString());M("RestConnection",`Sending RPC '${e}' ${u}:`,h,s);const f={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(f,o,a),this.No(e,h,f,s).then(m=>(M("RestConnection",`Received RPC '${e}' ${u}: `,m),m),m=>{throw Te("RestConnection",`RPC '${e}' ${u} failed with error: `,m,"url: ",h,"request:",s),m})}Lo(e,r,s,o,a,u){return this.Mo(e,r,s,o,a)}Oo(e,r,s){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+De}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((o,a)=>e[a]=o),s&&s.headers.forEach((o,a)=>e[a]=o)}xo(e,r){const s=rf[e];return`${this.Do}/v1/${r}:${s}`}terminate(){}}{constructor(t){super(t),this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}No(t,e,r,s){const o=ss();return new Promise((a,u)=>{const h=new Ma;h.setWithCredentials(!0),h.listenOnce(xa.COMPLETE,()=>{try{switch(h.getLastErrorCode()){case Yn.NO_ERROR:const m=h.getResponseJson();M(pt,`XHR for RPC '${t}' ${o} received:`,JSON.stringify(m)),a(m);break;case Yn.TIMEOUT:M(pt,`RPC '${t}' ${o} timed out`),u(new N(S.DEADLINE_EXCEEDED,"Request time out"));break;case Yn.HTTP_ERROR:const w=h.getStatus();if(M(pt,`RPC '${t}' ${o} failed with status:`,w,"response text:",h.getResponseText()),w>0){let A=h.getResponseJson();Array.isArray(A)&&(A=A[0]);const b=A==null?void 0:A.error;if(b&&b.status&&b.message){const k=function(P){const U=P.toLowerCase().replace(/_/g,"-");return Object.values(S).indexOf(U)>=0?U:S.UNKNOWN}(b.status);u(new N(k,b.message))}else u(new N(S.UNKNOWN,"Server responded with status "+h.getStatus()))}else u(new N(S.UNAVAILABLE,"Connection failed."));break;default:O()}}finally{M(pt,`RPC '${t}' ${o} completed.`)}});const f=JSON.stringify(s);M(pt,`RPC '${t}' ${o} sending request:`,s),h.send(e,"POST",f,r,15)})}Bo(t,e,r){const s=ss(),o=[this.Do,"/","google.firestore.v1.Firestore","/",t,"/channel"],a=Fa(),u=La(),h={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},f=this.longPollingOptions.timeoutSeconds;f!==void 0&&(h.longPollingTimeout=Math.round(1e3*f)),this.useFetchStreams&&(h.useFetchStreams=!0),this.Oo(h.initMessageHeaders,e,r),h.encodeInitMessageHeaders=!0;const m=o.join("");M(pt,`Creating RPC '${t}' stream ${s}: ${m}`,h);const w=a.createWebChannel(m,h);let A=!1,b=!1;const k=new sf({Io:P=>{b?M(pt,`Not sending because RPC '${t}' stream ${s} is closed:`,P):(A||(M(pt,`Opening RPC '${t}' stream ${s} transport.`),w.open(),A=!0),M(pt,`RPC '${t}' stream ${s} sending:`,P),w.send(P))},To:()=>w.close()}),D=(P,U,L)=>{P.listen(U,$=>{try{L($)}catch(et){setTimeout(()=>{throw et},0)}})};return D(w,tn.EventType.OPEN,()=>{b||(M(pt,`RPC '${t}' stream ${s} transport opened.`),k.yo())}),D(w,tn.EventType.CLOSE,()=>{b||(b=!0,M(pt,`RPC '${t}' stream ${s} transport closed`),k.So())}),D(w,tn.EventType.ERROR,P=>{b||(b=!0,Te(pt,`RPC '${t}' stream ${s} transport errored:`,P),k.So(new N(S.UNAVAILABLE,"The operation could not be completed")))}),D(w,tn.EventType.MESSAGE,P=>{var U;if(!b){const L=P.data[0];H(!!L);const $=L,et=$.error||((U=$[0])===null||U===void 0?void 0:U.error);if(et){M(pt,`RPC '${t}' stream ${s} received error:`,et);const Dt=et.status;let it=function(_){const y=nt[_];if(y!==void 0)return cl(y)}(Dt),v=et.message;it===void 0&&(it=S.INTERNAL,v="Unknown error status: "+Dt+" with message "+et.message),b=!0,k.So(new N(it,v)),w.close()}else M(pt,`RPC '${t}' stream ${s} received:`,L),k.bo(L)}}),D(u,Oa.STAT_EVENT,P=>{P.stat===ps.PROXY?M(pt,`RPC '${t}' stream ${s} detected buffering proxy`):P.stat===ps.NOPROXY&&M(pt,`RPC '${t}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{k.wo()},0),k}}function is(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Er(n){return new pd(n,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hf{constructor(t,e,r,s,o){this.localStore=t,this.datastore=e,this.asyncQueue=r,this.remoteSyncer={},this.O_=[],this.N_=new Map,this.L_=new Set,this.B_=[],this.k_=o,this.k_._o(a=>{r.enqueueAndForget(async()=>{ce(this)&&(M("RemoteStore","Restarting streams for network reachability change."),await async function(h){const f=B(h);f.L_.add(4),await In(f),f.q_.set("Unknown"),f.L_.delete(4),await vr(f)}(this))})}),this.q_=new cf(r,s)}}async function vr(n){if(ce(n))for(const t of n.B_)await t(!0)}async function In(n){for(const t of n.B_)await t(!1)}function Al(n,t){const e=B(n);e.N_.has(t.targetId)||(e.N_.set(t.targetId,t),Js(e)?Xs(e):Me(e).r_()&&Ys(e,t))}function Qs(n,t){const e=B(n),r=Me(e);e.N_.delete(t),r.r_()&&Rl(e,t),e.N_.size===0&&(r.r_()?r.o_():ce(e)&&e.q_.set("Unknown"))}function Ys(n,t){if(n.Q_.xe(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(F.min())>0){const e=n.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(e)}Me(n).A_(t)}function Rl(n,t){n.Q_.xe(t),Me(n).R_(t)}function Xs(n){n.Q_=new hd({getRemoteKeysForTarget:t=>n.remoteSyncer.getRemoteKeysForTarget(t),ot:t=>n.N_.get(t)||null,tt:()=>n.datastore.serializer.databaseId}),Me(n).start(),n.q_.v_()}function Js(n){return ce(n)&&!Me(n).n_()&&n.N_.size>0}function ce(n){return B(n).L_.size===0}function Sl(n){n.Q_=void 0}async function df(n){n.q_.set("Online")}async function ff(n){n.N_.forEach((t,e)=>{Ys(n,t)})}async function mf(n,t){Sl(n),Js(n)?(n.q_.M_(t),Xs(n)):n.q_.set("Unknown")}async function pf(n,t,e){if(n.q_.set("Online"),t instanceof dl&&t.state===2&&t.cause)try{await async function(s,o){const a=o.cause;for(const u of o.targetIds)s.N_.has(u)&&(await s.remoteSyncer.rejectListen(u,a),s.N_.delete(u),s.Q_.removeTarget(u))}(n,t)}catch(r){M("RemoteStore","Failed to remove targets %s: %s ",t.targetIds.join(","),r),await ur(n,r)}else if(t instanceof Zn?n.Q_.Ke(t):t instanceof hl?n.Q_.He(t):n.Q_.We(t),!e.isEqual(F.min()))try{const r=await Tl(n.localStore);e.compareTo(r)>=0&&await function(o,a){const u=o.Q_.rt(a);return u.targetChanges.forEach((h,f)=>{if(h.resumeToken.approximateByteSize()>0){const m=o.N_.get(f);m&&o.N_.set(f,m.withResumeToken(h.resumeToken,a))}}),u.targetMismatches.forEach((h,f)=>{const m=o.N_.get(h);if(!m)return;o.N_.set(h,m.withResumeToken(ct.EMPTY_BYTE_STRING,m.snapshotVersion)),Rl(o,h);const w=new jt(m.target,h,f,m.sequenceNumber);Ys(o,w)}),o.remoteSyncer.applyRemoteEvent(u)}(n,e)}catch(r){M("RemoteStore","Failed to raise snapshot:",r),await ur(n,r)}}async function ur(n,t,e){if(!En(t))throw t;n.L_.add(1),await In(n),n.q_.set("Offline"),e||(e=()=>Tl(n.localStore)),n.asyncQueue.enqueueRetryable(async()=>{M("RemoteStore","Retrying IndexedDB access"),await e(),n.L_.delete(1),await vr(n)})}function bl(n,t){return t().catch(e=>ur(n,e,t))}async function Tr(n){const t=B(n),e=Yt(t);let r=t.O_.length>0?t.O_[t.O_.length-1].batchId:-1;for(;gf(t);)try{const s=await Jd(t.localStore,r);if(s===null){t.O_.length===0&&e.o_();break}r=s.batchId,_f(t,s)}catch(s){await ur(t,s)}Pl(t)&&Vl(t)}function gf(n){return ce(n)&&n.O_.length<10}function _f(n,t){n.O_.push(t);const e=Yt(n);e.r_()&&e.V_&&e.m_(t.mutations)}function Pl(n){return ce(n)&&!Yt(n).n_()&&n.O_.length>0}function Vl(n){Yt(n).start()}async function yf(n){Yt(n).p_()}async function Ef(n){const t=Yt(n);for(const e of n.O_)t.m_(e.mutations)}async function vf(n,t,e){const r=n.O_.shift(),s=js.from(r,t,e);await bl(n,()=>n.remoteSyncer.applySuccessfulWrite(s)),await Tr(n)}async function Tf(n,t){t&&Yt(n).V_&&await async function(r,s){if(function(a){return ld(a)&&a!==S.ABORTED}(s.code)){const o=r.O_.shift();Yt(r).s_(),await bl(r,()=>r.remoteSyncer.rejectFailedWrite(o.batchId,s)),await Tr(r)}}(n,t),Pl(n)&&Vl(n)}async function ia(n,t){const e=B(n);e.asyncQueue.verifyOperationInProgress(),M("RemoteStore","RemoteStore received new credentials");const r=ce(e);e.L_.add(3),await In(e),r&&e.q_.set("Unknown"),await e.remoteSyncer.handleCredentialChange(t),e.L_.delete(3),await vr(e)}async function If(n,t){const e=B(n);t?(e.L_.delete(2),await vr(e)):t||(e.L_.add(2),await In(e),e.q_.set("Unknown"))}function Me(n){return n.K_||(n.K_=function(e,r,s){const o=B(e);return o.w_(),new af(r,o.connection,o.authCredentials,o.appCheckCredentials,o.serializer,s)}(n.datastore,n.asyncQueue,{Eo:df.bind(null,n),Ro:ff.bind(null,n),mo:mf.bind(null,n),d_:pf.bind(null,n)}),n.B_.push(async t=>{t?(n.K_.s_(),Js(n)?Xs(n):n.q_.set("Unknown")):(await n.K_.stop(),Sl(n))})),n.K_}function Yt(n){return n.U_||(n.U_=function(e,r,s){const o=B(e);return o.w_(),new lf(r,o.connection,o.authCredentials,o.appCheckCredentials,o.serializer,s)}(n.datastore,n.asyncQueue,{Eo:()=>Promise.resolve(),Ro:yf.bind(null,n),mo:Tf.bind(null,n),f_:Ef.bind(null,n),g_:vf.bind(null,n)}),n.B_.push(async t=>{t?(n.U_.s_(),await Tr(n)):(await n.U_.stop(),n.O_.length>0&&(M("RemoteStore",`Stopping write stream with ${n.O_.length} pending writes`),n.O_=[]))})),n.U_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ve{constructor(t){this.comparator=t?(e,r)=>t(e,r)||x.comparator(e.key,r.key):(e,r)=>x.comparator(e.key,r.key),this.keyedMap=en(),this.sortedSet=new J(this.comparator)}static emptySet(t){return new ve(t.comparator)}has(t){return this.keyedMap.get(t)!=null}get(t){return this.keyedMap.get(t)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(t){const e=this.keyedMap.get(t);return e?this.sortedSet.indexOf(e):-1}get size(){return this.sortedSet.size}forEach(t){this.sortedSet.inorderTraversal((e,r)=>(t(e),!1))}add(t){const e=this.delete(t.key);return e.copy(e.keyedMap.insert(t.key,t),e.sortedSet.insert(t,null))}delete(t){const e=this.get(t);return e?this.copy(this.keyedMap.remove(t),this.sortedSet.remove(e)):this}isEqual(t){if(!(t instanceof ve)||this.size!==t.size)return!1;const e=this.sortedSet.getIterator(),r=t.sortedSet.getIterator();for(;e.hasNext();){const s=e.getNext().key,o=r.getNext().key;if(!s.isEqual(o))return!1}return!0}toString(){const t=[];return this.forEach(e=>{t.push(e.toString())}),t.length===0?"DocumentSet ()":`DocumentSet (
  `+t.join(`  
`)+`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rr{constructor(...t){for(let e=0;e<t.length;++e)if(t[e].length===0)throw new N(S.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new lt(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ii{constructor(t,e){if(!isFinite(t)||t<-90||t>90)throw new N(S.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+t);if(!isFinite(e)||e<-180||e>180)throw new N(S.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+e);this._lat=t,this._long=e}get latitude(){return this._lat}get longitude(){return this._long}isEqual(t){return this._lat===t._lat&&this._long===t._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(t){return W(this._lat,t._lat)||W(this._long,t._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qn{constructor(t,e){this.hasPendingWrites=t,this.fromCache=e}isEqual(t){return this.hasPendingWrites===t.hasPendingWrites&&this.fromCache===t.fromCache}}class pm extends Hl{constructor(t,e,r,s,o,a){super(t,e,r,s,a),this._firestore=t,this._firestoreImpl=t,this.metadata=o}exists(){return super.exists()}data(t={}){if(this._document){if(this._converter){const e=new tr(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(e,t)}return this._userDataWriter.convertValue(this._document.data.value,t.serverTimestamps)}}get(t,e={}){if(this._document){const r=this._document.data.field(br("DocumentSnapshot.get",t));if(r!==null)return this._userDataWriter.convertValue(r,e.serverTimestamps)}}}class tr extends pm{data(t={}){return super.data(t)}}class gm{constructor(t,e,r,s){this._firestore=t,this._userDataWriter=e,this._snapshot=s,this.metadata=new Qn(s.hasPendingWrites,s.fromCache),this.query=r}get docs(){const t=[];return this.forEach(e=>t.push(e)),t}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(t,e){this._snapshot.docs.forEach(r=>{t.call(e,new tr(this._firestore,this._userDataWriter,r.key,r,new Qn(this._snapshot.mutatedKeys.has(r.key),this._snapshot.fromCache),this.query.converter))})}docChanges(t={}){const e=!!t.includeMetadataChanges;if(e&&this._snapshot.excludesMetadataChanges)throw new N(S.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===e||(this._cachedChanges=function(s,o){if(s._snapshot.oldDocs.isEmpty()){let a=0;return s._snapshot.docChanges.map(u=>{const h=new tr(s._firestore,s._userDataWriter,u.doc.key,u.doc,new Qn(s._snapshot.mutatedKeys.has(u.doc.key),s._snapshot.fromCache),s.query.converter);return u.doc,{type:"added",doc:h,oldIndex:-1,newIndex:a++}})}{let a=s._snapshot.oldDocs;return s._snapshot.docChanges.filter(u=>o||u.type!==3).map(u=>{const h=new tr(s._firestore,s._userDataWriter,u.doc.key,u.doc,new Qn(s._snapshot.mutatedKeys.has(u.doc.key),s._snapshot.fromCache),s.query.converter);let f=-1,m=-1;return u.type!==0&&(f=a.indexOf(u.doc.key),a=a.delete(u.doc.key)),u.type!==1&&(a=a.add(u.doc),m=a.indexOf(u.doc.key)),{type:_m(u.type),doc:h,oldIndex:f,newIndex:m}})}}(this,e),this._cachedChangesIncludeMetadataChanges=e),this._cachedChanges}}function _m(n){switch(n){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return O()}}class ym extends fm{constructor(t){super(),this.firestore=t}convertBytes(t){return new be(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new wt(this.firestore,null,e)}}function gi(n){n=le(n,he);const t=le(n.firestore,An),e=ql(t),r=new ym(t);return dm(n._query),Jf(e,n._query).then(s=>new gm(t,r,n,s))}function Em(n,t,e,...r){n=le(n,wt);const s=le(n.firestore,An),o=li(s);let a;return a=typeof(t=xt(t))=="string"||t instanceof Rr?lm(o,"updateDoc",n._key,t,e,r):am(o,"updateDoc",n._key,t),_i(s,[a.toMutation(n._key,St.exists(!0))])}function vm(n){return _i(le(n.firestore,An),[new $s(n._key,St.none())])}function Tm(n,t){const e=le(n.firestore,An),r=ri(n),s=mm(n.converter,t);return _i(e,[om(li(n.firestore),"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,St.exists(!1))]).then(()=>r)}function _i(n,t){return function(r,s){const o=new Wt;return r.asyncQueue.enqueueAndForget(async()=>Bf(await Yf(r),s,o)),o.promise}(ql(n),t)}(function(t,e=!0){(function(s){De=s})(Zc),rr(new un("firestore",(r,{instanceIdentifier:s,options:o})=>{const a=r.getProvider("app").getImmediate(),u=new An(new mh(r.getProvider("auth-internal")),new yh(r.getProvider("app-check-internal")),function(f,m){if(!Object.prototype.hasOwnProperty.apply(f.options,["projectId"]))throw new N(S.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new fn(f.options.projectId,m)}(a,s),a);return o=Object.assign({useFetchStreams:e},o),u._setSettings(o),u},"PUBLIC").setMultipleInstances(!0)),Ee(Mo,"4.7.3",t),Ee(Mo,"4.7.3","esm2017")})();const Im={apiKey:"AIzaSyA66X3tR-oquob5ZbBrrHv_EAmhwEHTi48",authDomain:"baby-tracker-b0936.firebaseapp.com",projectId:"baby-tracker-b0936",storageBucket:"baby-tracker-b0936.firebasestorage.app",messagingSenderId:"931756532206",appId:"1:931756532206:web:bf90d10dc3e3837383eeff"},wm=Ca(Im),xe=em(wm),Am="1234";let Rt=Pe(new Date),dr=null,as=null;function Pe(n){const t=new Date(n),e=t.getDay(),r=t.getDate()-e;return new Date(t.setDate(r))}function Rm(n){const t=new Date(n);return t.setDate(t.getDate()+6),t.setHours(23,59,59,999),t}function rn(n){const t=n.getFullYear(),e=String(n.getMonth()+1).padStart(2,"0"),r=String(n.getDate()).padStart(2,"0"),s=String(n.getHours()).padStart(2,"0"),o=String(n.getMinutes()).padStart(2,"0");return`${t}-${e}-${r}T${s}:${o}`}function Sm(n){const t=String(n.getMonth()+1).padStart(2,"0"),e=String(n.getDate()).padStart(2,"0"),r=n.getFullYear(),s=n.getHours(),o=String(n.getMinutes()).padStart(2,"0"),a=s>=12?"PM":"AM",u=s%12||12;return`${t}/${e}/${r} ${u}:${o} ${a}`}function Ds(n){const t=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],e=String(n.getMonth()+1).padStart(2,"0"),r=String(n.getDate()).padStart(2,"0"),s=n.getFullYear();return`${t[n.getDay()]}, ${e}/${r}/${s}`}function Yl(){const n=document.getElementById("passcode-input"),t=document.getElementById("passcode-error"),e=document.getElementById("passcode-screen"),r=document.getElementById("app");n.value===Am?(e.style.display="none",r.style.display="block",bm()):(t.textContent="Incorrect passcode",t.style.display="block",n.value="")}function bm(){Pm(),yi(),Om()}function Pm(){const n=document.getElementById("entry-type"),t=document.getElementById("submit-entry");n.addEventListener("change",Vm),t.addEventListener("click",Cm);const e=document.getElementById("entry-tab"),r=document.getElementById("timeline-tab"),s=document.getElementById("weekly-tab");e.addEventListener("click",()=>ls("entry")),r.addEventListener("click",()=>ls("timeline")),s.addEventListener("click",()=>ls("weekly"));const o=document.getElementById("prev-week"),a=document.getElementById("next-week"),u=document.getElementById("current-week");o.addEventListener("click",()=>va(-1)),a.addEventListener("click",()=>va(1)),u&&u.addEventListener("click",km);const h=document.getElementById("save-edit"),f=document.getElementById("cancel-edit");h.addEventListener("click",Mm),f.addEventListener("click",Xl)}function yi(){const t=rn(new Date),e=document.getElementById("bottle-time"),r=document.getElementById("diaper-time"),s=document.getElementById("pump-start-time"),o=document.getElementById("pump-end-time");e&&(e.value=t,e.max=t),r&&(r.value=t,r.max=t),s&&(s.value=t,s.max=t),o&&(o.value=t,o.max=t)}function Vm(n){const e=n.target.value,r=document.getElementById("bottle-fields"),s=document.getElementById("diaper-fields"),o=document.getElementById("pump-fields"),a=document.getElementById("submit-entry");r.style.display="none",s.style.display="none",o.style.display="none",e==="bottle-breast-milk"||e==="bottle-formula"?(r.style.display="block",a.style.display="block"):e==="diaper"?(s.style.display="block",a.style.display="block"):e==="pump"?(o.style.display="block",a.style.display="block"):a.style.display="none",yi()}async function Cm(){const n=document.getElementById("entry-type").value,t=document.getElementById("submit-status");try{let e=null;const r=new Date;if(n==="bottle-breast-milk"||n==="bottle-formula"){const s=document.getElementById("bottle-time").value,o=parseFloat(document.getElementById("bottle-amount").value),a=document.getElementById("bottle-notes").value;if(!s)throw new Error("Start time is required");const u=new Date(s);if(u>r)throw new Error("Start time cannot be in the future");if(isNaN(o)||o<=0)throw new Error("Amount must be greater than 0");e={type:"Feed",subType:n==="bottle-breast-milk"?"Breast Milk":"Formula",startTime:u,amount:o,unit:"oz",notes:a}}else if(n==="diaper"){const s=document.getElementById("diaper-time").value,o=document.getElementById("diaper-type").value,a=document.getElementById("diaper-notes").value;if(!s)throw new Error("Start time is required");const u=new Date(s);if(u>r)throw new Error("Start time cannot be in the future");if(!o)throw new Error("Diaper type is required");e={type:"Diaper",diaperType:o,startTime:u,notes:a}}else if(n==="pump"){const s=document.getElementById("pump-start-time").value,o=document.getElementById("pump-end-time").value,a=parseFloat(document.getElementById("pump-amount").value),u=document.getElementById("pump-notes").value;if(!s)throw new Error("Start time is required");if(!o)throw new Error("End time is required");const h=new Date(s),f=new Date(o);if(h>r)throw new Error("Start time cannot be in the future");if(f>r)throw new Error("End time cannot be in the future");if(isNaN(a)||a<=0)throw new Error("Amount must be greater than 0");e={type:"Pump",startTime:h,endTime:f,amount:a,unit:"oz",notes:u}}e&&(await Tm(Ar(xe,"entries"),{...e,startTime:Q.fromDate(e.startTime),endTime:e.endTime?Q.fromDate(e.endTime):null}),t.className="success",t.textContent="Entry added successfully!",t.style.display="block",Dm(),e.type==="Feed"&&Ti(),setTimeout(()=>{t.style.display="none"},3e3))}catch(e){t.className="error",t.textContent=e instanceof Error?e.message:"Failed to add entry",t.style.display="block"}}function Dm(){document.getElementById("entry-type").value="",document.getElementById("bottle-amount").value="",document.getElementById("bottle-notes").value="",document.getElementById("diaper-notes").value="",document.getElementById("pump-amount").value="",document.getElementById("pump-notes").value="",document.getElementById("bottle-fields").style.display="none",document.getElementById("diaper-fields").style.display="none",document.getElementById("pump-fields").style.display="none",document.getElementById("submit-entry").style.display="none",yi()}function ls(n){var t,e,r;document.querySelectorAll(".tab-button").forEach(s=>s.classList.remove("active")),document.querySelectorAll(".view").forEach(s=>s.style.display="none"),n==="entry"?((t=document.getElementById("entry-tab"))==null||t.classList.add("active"),document.getElementById("entry-view").style.display="block"):n==="timeline"?((e=document.getElementById("timeline-tab"))==null||e.classList.add("active"),document.getElementById("timeline-view").style.display="block",Ei()):n==="weekly"&&((r=document.getElementById("weekly-tab"))==null||r.classList.add("active"),document.getElementById("weekly-view").style.display="block",vi())}async function Ei(){const n=document.getElementById("timeline-list"),t=document.getElementById("timeline-loading");t.style.display="block",n.innerHTML="";try{const e=di(Ar(xe,"entries"),pi("startTime","desc")),r=await gi(e);if(r.empty)n.innerHTML="<p>No entries found.</p>";else{let s="";r.forEach(o=>{const a=o.data(),u=o.id,h=a.startTime.toDate(),f=Ds(h);if(f!==s){s=f;const P=document.createElement("div");P.className="timeline-date-header",P.textContent=f,n.appendChild(P)}const m=document.createElement("div");m.className="timeline-entry";let w=a.type,A="";if(a.type==="Feed")w=`Bottle - ${a.subType}`,A=`<div class="timeline-entry-details">Amount: ${Ve(a.amount,a.unit).toFixed(2)} oz</div>`;else if(a.type==="Breast Feed")w="Breast Feed",A="";else if(a.type==="Diaper")A=`<div class="timeline-entry-details">Type: ${a.diaperType}</div>`;else if(a.type==="Pump"){const P=Ve(a.amount,a.unit),U=a.endTime?a.endTime.toDate():null,L=U?Math.round((U.getTime()-h.getTime())/6e4):0;A=`<div class="timeline-entry-details">Amount: ${P.toFixed(2)} oz<br>Duration: ${L} minutes</div>`}const b=a.notes?`<div class="timeline-entry-notes">${a.notes}</div>`:"";m.innerHTML=`
                    <div class="timeline-entry-header">
                        <span class="timeline-entry-type">${w}</span>
                        <span class="timeline-entry-time">${Sm(h)}</span>
                    </div>
                    ${A}
                    ${b}
                ...
                `;const k=m.querySelector(".edit-button"),D=m.querySelector(".delete-button");k.addEventListener("click",()=>Nm(u,a)),D.addEventListener("click",()=>xm(u)),n.appendChild(m)})}}catch{n.innerHTML='<p class="error">Failed to load timeline</p>'}finally{t.style.display="none"}}async function vi(){const n=document.getElementById("weekly-stats"),t=document.getElementById("weekly-loading"),e=document.getElementById("week-range"),r=document.getElementById("next-week"),s=document.getElementById("current-week"),a=Pe(new Date("2025-11-05")),h=Pe(new Date);Rt<a&&(Rt=new Date(a)),Rt>=h?r.disabled=!0:r.disabled=!1,s&&(Rt.getTime()===h.getTime()?s.style.display="none":s.style.display="block");const f=Rm(Rt);e.textContent=`${Ds(Rt).split(",")[1].trim()} - ${Ds(f).split(",")[1].trim()}`,t.style.display="block",n.innerHTML="";try{const m=di(Ar(xe,"entries"),_a("startTime",">=",Q.fromDate(Rt)),_a("startTime","<=",Q.fromDate(f)),pi("startTime","asc")),w=await gi(m),A={};for(let D=0;D<7;D++){const P=new Date(Rt);P.setDate(P.getDate()+D);const U=P.toDateString();A[U]={date:P,bottles:{total:0,breastMilk:0,formula:0,sessions:0},diapers:{total:0,pee:0,poo:0,mixed:0},pumps:{total:0,sessions:0}}}w.forEach(D=>{const P=D.data(),L=P.startTime.toDate().toDateString();if(A[L]){if(P.type==="Feed"){const $=Ve(P.amount,P.unit);A[L].bottles.total+=$,A[L].bottles.sessions++,P.subType==="Breast Milk"?A[L].bottles.breastMilk+=$:P.subType==="Formula"&&(A[L].bottles.formula+=$)}else if(P.type==="Diaper")A[L].diapers.total++,P.diaperType==="Pee"?A[L].diapers.pee++:P.diaperType==="Poo"?A[L].diapers.poo++:P.diaperType==="Mixed"&&A[L].diapers.mixed++;else if(P.type==="Pump"){const $=Ve(P.amount,P.unit);A[L].pumps.total+=$,A[L].pumps.sessions++}}});const b=Object.keys(A).map(D=>A[D]),k=document.createElement("div");k.className="weekly-scroll-container",b.forEach(D=>{const P=document.createElement("div");P.className="day-stats";const U=new Date;U.setHours(0,0,0,0);const L=new Date(D.date);L.setHours(0,0,0,0),U.getTime()===L.getTime()&&P.classList.add("current-day");const $=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"][D.date.getDay()],et=`${D.date.getMonth()+1}/${D.date.getDate()}`;P.innerHTML=`
            ...
            `,k.appendChild(P)}),n.appendChild(k)}catch{n.innerHTML='<p class="error">Failed to load weekly view</p>'}finally{t.style.display="none"}}function va(n){const e=Pe(new Date("2025-11-05")),s=Pe(new Date),o=new Date(Rt);o.setDate(o.getDate()+n*7),o.setHours(0,0,0,0);const a=new Date(e);a.setHours(0,0,0,0);const u=new Date(s);u.setHours(0,0,0,0),!(o.getTime()<a.getTime())&&(o.getTime()>u.getTime()||(Rt=o,vi()))}function km(){Rt=Pe(new Date),vi()}function Ve(n,t){return t==="ml"?n*.033814:n}function Nm(n,t){dr=n;const e=document.getElementById("edit-modal"),r=document.getElementById("edit-bottle-fields"),s=document.getElementById("edit-diaper-fields"),o=document.getElementById("edit-pump-fields");r.style.display="none",s.style.display="none",o.style.display="none";const a=t.startTime.toDate();if(t.type==="Feed")r.style.display="block",document.getElementById("edit-bottle-time").value=rn(a),document.getElementById("edit-bottle-amount").value=Ve(t.amount,t.unit).toFixed(2),document.getElementById("edit-bottle-notes").value=t.notes||"";else if(t.type==="Diaper")s.style.display="block",document.getElementById("edit-diaper-time").value=rn(a),document.getElementById("edit-diaper-type").value=t.diaperType,document.getElementById("edit-diaper-notes").value=t.notes||"";else if(t.type==="Pump"){o.style.display="block";const u=t.endTime?t.endTime.toDate():a;document.getElementById("edit-pump-start-time").value=rn(a),document.getElementById("edit-pump-end-time").value=rn(u),document.getElementById("edit-pump-amount").value=Ve(t.amount,t.unit).toFixed(2),document.getElementById("edit-pump-notes").value=t.notes||""}e.style.display="block"}function Xl(){const n=document.getElementById("edit-modal");n.style.display="none",dr=null;const t=document.getElementById("edit-status");t.style.display="none"}async function Mm(){if(!dr)return;const n=document.getElementById("edit-status");try{const t=document.getElementById("edit-bottle-fields"),e=document.getElementById("edit-diaper-fields"),r=document.getElementById("edit-pump-fields");let s={};if(t.style.display==="block"){const o=document.getElementById("edit-bottle-time").value,a=parseFloat(document.getElementById("edit-bottle-amount").value),u=document.getElementById("edit-bottle-notes").value;if(!o)throw new Error("Start time is required");if(isNaN(a)||a<=0)throw new Error("Amount must be greater than 0");s={startTime:Q.fromDate(new Date(o)),amount:a,unit:"oz",notes:u}}else if(e.style.display==="block"){const o=document.getElementById("edit-diaper-time").value,a=document.getElementById("edit-diaper-type").value,u=document.getElementById("edit-diaper-notes").value;if(!o)throw new Error("Start time is required");if(!a)throw new Error("Diaper type is required");s={startTime:Q.fromDate(new Date(o)),diaperType:a,notes:u}}else if(r.style.display==="block"){const o=document.getElementById("edit-pump-start-time").value,a=document.getElementById("edit-pump-end-time").value,u=parseFloat(document.getElementById("edit-pump-amount").value),h=document.getElementById("edit-pump-notes").value;if(!o)throw new Error("Start time is required");if(!a)throw new Error("End time is required");if(isNaN(u)||u<=0)throw new Error("Amount must be greater than 0");s={startTime:Q.fromDate(new Date(o)),endTime:Q.fromDate(new Date(a)),amount:u,unit:"oz",notes:h}}await Em(ri(xe,"entries",dr),s),n.className="success",n.textContent="Entry updated successfully!",n.style.display="block",setTimeout(()=>{Xl(),Ei()},1e3)}catch(t){n.className="error",n.textContent=t instanceof Error?t.message:"Failed to update entry",n.style.display="block"}}async function xm(n){if(confirm("Are you sure you want to delete this entry?"))try{await vm(ri(xe,"entries",n)),Ei(),Ti()}catch{alert("Failed to delete entry")}}async function Om(){await Ti(),as&&clearInterval(as),as=window.setInterval(Jl,1e3)}async function Ti(){try{const n=di(Ar(xe,"entries"),pi("startTime","desc")),e=(await gi(n)).docs.find(r=>r.data().type==="Feed");if(e){const s=e.data().startTime.toDate();localStorage.setItem("lastBottleTime",s.toISOString())}else localStorage.removeItem("lastBottleTime");Jl()}catch(n){console.error("Error fetching last bottle time:",n);const t=document.querySelector(".last-bottle-value");t&&(t.textContent="Error loading")}}function Jl(){const n=document.querySelector(".last-bottle-value");if(!n)return;const t=localStorage.getItem("lastBottleTime");if(!t){n.textContent="No bottles recorded";return}const e=new Date(t),s=new Date().getTime()-e.getTime(),o=Math.floor(s/(1e3*60*60)),a=Math.floor(s%(1e3*60*60)/(1e3*60)),u=Math.floor(s%(1e3*60)/1e3);o>0?n.textContent=`${o}h ${a}m ${u}s`:a>0?n.textContent=`${a}m ${u}s`:n.textContent=`${u}s`}var Ta;(Ta=document.getElementById("passcode-submit"))==null||Ta.addEventListener("click",Yl);var Ia;(Ia=document.getElementById("passcode-input"))==null||Ia.addEventListener("keypress",n=>{n.key==="Enter"&&Yl()});
