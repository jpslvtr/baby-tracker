...
*/var de,Ja;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function t(g,p){function y(){}y.prototype=p.prototype,g.D=p.prototype,g.prototype=new y,g.prototype.constructor=g,g.C=function(v,T,A){for(var _=Array(arguments.length-2),bt=2;bt<arguments.length;bt++)_[bt-2]=arguments[bt];return p.prototype[T].apply(v,_)}}function e(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}t(r,e),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(g,p,y){y||(y=0);var v=Array(16);if(typeof p=="string")for(var T=0;16>T;++T)v[T]=p.charCodeAt(y++)|p.charCodeAt(y++)<<8|p.charCodeAt(y++)<<16|p.charCodeAt(y++)<<24;else for(T=0;16>T;++T)v[T]=p[y++]|p[y++]<<8|p[y++]<<16|p[y++]<<24;p=g.g[0],y=g.g[1],T=g.g[2];var A=g.g[3],_=p+(A^y&(T^A))+v[0]+3614090360&4294967295;p=y+(_<<7&4294967295|_>>>25),_=A+(T^p&(y^T))+v[1]+3905402710&4294967295,A=p+(_<<12&4294967295|_>>>20),_=T+(y^A&(p^y))+v[2]+606105819&4294967295,T=A+(_<<17&4294967295|_>>>15),_=y+(p^T&(A^p))+v[3]+3250441966&4294967295,y=T+(_<<22&4294967295|_>>>10),_=p+(A^y&(T^A))+v[4]+4118548399&4294967295,p=y+(_<<7&4294967295|_>>>25),_=A+(T^p&(y^T))+v[5]+1200080426&4294967295,A=p+(_<<12&4294967295|_>>>20),_=T+(y^A&(p^y))+v[6]+2821735955&4294967295,T=A+(_<<17&4294967295|_>>>15),_=y+(p^T&(A^p))+v[7]+4249261313&4294967295,y=T+(_<<22&4294967295|_>>>10),_=p+(A^y&(T^A))+v[8]+1770035416&4294967295,p=y+(_<<7&4294967295|_>>>25),_=A+(T^p&(y^T))+v[9]+2336552879&4294967295,A=p+(_<<12&4294967295|_>>>20),_=T+(y^A&(p^y))+v[10]+4294925233&4294967295,T=A+(_<<17&4294967295|_>>>15),_=y+(p^T&(A^p))+v[11]+2304563134&4294967295,y=T+(_<<22&4294967295|_>>>10),_=p+(A^y&(T^A))+v[12]+1804603682&4294967295,p=y+(_<<7&4294967295|_>>>25),_=A+(T^p&(y^T))+v[13]+4254626195&4294967295,A=p+(_<<12&4294967295|_>>>20),_=T+(y^A&(p^y))+v[14]+2792965006&4294967295,T=A+(_<<17&4294967295|_>>>15),_=y+(p^T&(A^p))+v[15]+1236535329&4294967295,y=T+(_<<22&4294967295|_>>>10),_=p+(T^A&(y^T))+v[1]+4129170786&4294967295,p=y+(_<<5&4294967295|_>>>27),_=A+(y^T&(p^y))+v[6]+3225465664&4294967295,A=p+(_<<9&4294967295|_>>>23),_=T+(p^y&(A^p))+v[11]+643717713&4294967295,T=A+(_<<14&4294967295|_>>>18),_=y+(A^p&(T^A))+v[0]+3921069994&4294967295,y=T+(_<<20&4294967295|_>>>12),_=p+(T^A&(y^T))+v[5]+3593408605&4294967295,p=y+(_<<5&4294967295|_>>>27),_=A+(y^T&(p^y))+v[10]+38016083&4294967295,A=p+(_<<9&4294967295|_>>>23),_=T+(p^y&(A^p))+v[15]+3634488961&4294967295,T=A+(_<<14&4294967295|_>>>18),_=y+(A^p&(T^A))+v[4]+3889429448&4294967295,y=T+(_<<20&4294967295|_>>>12),_=p+(T^A&(y^T))+v[9]+568446438&4294967295,p=y+(_<<5&4294967295|_>>>27),_=A+(y^T&(p^y))+v[14]+3275163606&4294967295,A=p+(_<<9&4294967295|_>>>23),_=T+(p^y&(A^p))+v[3]+4107603335&4294967295,T=A+(_<<14&4294967295|_>>>18),_=y+(A^p&(T^A))+v[8]+1163531501&4294967295,y=T+(_<<20&4294967295|_>>>12),_=p+(T^A&(y^T))+v[13]+2850285829&4294967295,p=y+(_<<5&4294967295|_>>>27),_=A+(y^T&(p^y))+v[2]+4243563512&4294967295,A=p+(_<<9&4294967295|_>>>23),_=T+(p^y&(A^p))+v[7]+1735328473&4294967295,T=A+(_<<14&4294967295|_>>>18),_=y+(A^p&(T^A))+v[12]+2368359562&4294967295,y=T+(_<<20&4294967295|_>>>12),_=p+(y^T^A)+v[5]+4294588738&4294967295,p=y+(_<<4&4294967295|_>>>28),_=A+(p^y^T)+v[8]+2272392833&4294967295,A=p+(_<<11&4294967295|_>>>21),_=T+(A^p^y)+v[11]+1839030562&4294967295,T=A+(_<<16&4294967295|_>>>16),_=y+(T^A^p)+v[14]+4259657740&4294967295,y=T+(_<<23&4294967295|_>>>9),_=p+(y^T^A)+v[1]+2763975236&4294967295,p=y+(_<<4&4294967295|_>>>28),_=A+(p^y^T)+v[4]+1272893353&4294967295,A=p+(_<<11&4294967295|_>>>21),_=T+(A^p^y)+v[7]+4139469664&4294967295,T=A+(_<<16&4294967295|_>>>16),_=y+(T^A^p)+v[10]+3200236656&4294967295,y=T+(_<<23&4294967295|_>>>9),_=p+(y^T^A)+v[13]+681279174&4294967295,p=y+(_<<4&4294967295|_>>>28),_=A+(p^y^T)+v[0]+3936430074&4294967295,A=p+(_<<11&4294967295|_>>>21),_=T+(A^p^y)+v[3]+3572445317&4294967295,T=A+(_<<16&4294967295|_>>>16),_=y+(T^A^p)+v[6]+76029189&4294967295,y=T+(_<<23&4294967295|_>>>9),_=p+(y^T^A)+v[9]+3654602809&4294967295,p=y+(_<<4&4294967295|_>>>28),_=A+(p^y^T)+v[12]+3873151461&4294967295,A=p+(_<<11&4294967295|_>>>21),_=T+(A^p^y)+v[15]+530742520&4294967295,T=A+(_<<16&4294967295|_>>>16),_=y+(T^A^p)+v[2]+3299628645&4294967295,y=T+(_<<23&4294967295|_>>>9),_=p+(T^(y|~A))+v[0]+4096336452&4294967295,p=y+(_<<6&4294967295|_>>>26),_=A+(y^(p|~T))+v[7]+1126891415&4294967295,A=p+(_<<10&4294967295|_>>>22),_=T+(p^(A|~y))+v[14]+2878612391&4294967295,T=A+(_<<15&4294967295|_>>>17),_=y+(A^(T|~p))+v[5]+4237533241&4294967295,y=T+(_<<21&4294967295|_>>>11),_=p+(T^(y|~A))+v[12]+1700485571&4294967295,p=y+(_<<6&4294967295|_>>>26),_=A+(y^(p|~T))+v[3]+2399980690&4294967295,A=p+(_<<10&4294967295|_>>>22),_=T+(p^(A|~y))+v[10]+4293915773&4294967295,T=A+(_<<15&4294967295|_>>>17),_=y+(A^(T|~p))+v[1]+2240044497&4294967295,y=T+(_<<21&4294967295|_>>>11),_=p+(T^(y|~A))+v[8]+1873313359&4294967295,p=y+(_<<6&4294967295|_>>>26),_=A+(y^(p|~T))+v[15]+4264355552&4294967295,A=p+(_<<10&4294967295|_>>>22),_=T+(p^(A|~y))+v[6]+2734768916&4294967295,T=A+(_<<15&4294967295|_>>>17),_=y+(A^(T|~p))+v[13]+1309151649&4294967295,y=T+(_<<21&4294967295|_>>>11),_=p+(T^(y|~A))+v[4]+4149444226&4294967295,p=y+(_<<6&4294967295|_>>>26),_=A+(y^(p|~T))+v[11]+3174756917&4294967295,A=p+(_<<10&4294967295|_>>>22),_=T+(p^(A|~y))+v[2]+718787259&4294967295,T=A+(_<<15&4294967295|_>>>17),_=y+(A^(T|~p))+v[9]+3951481745&4294967295,g.g[0]=g.g[0]+p&4294967295,g.g[1]=g.g[1]+(T+(_<<21&4294967295|_>>>11))&4294967295,g.g[2]=g.g[2]+T&4294967295,g.g[3]=g.g[3]+A&4294967295}r.prototype.u=function(g,p){p===void 0&&(p=g.length);for(var y=p-this.blockSize,v=this.B,T=this.h,A=0;A<p;){if(T==0)for(;A<=y;)s(this,g,A),A+=this.blockSize;if(typeof g=="string"){for(;A<p;)if(v[T++]=g.charCodeAt(A++),T==this.blockSize){s(this,v),T=0;break}}else for(;A<p;)if(v[T++]=g[A++],T==this.blockSize){s(this,v),T=0;break}}this.h=T,this.o+=p},r.prototype.v=function(){var g=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);g[0]=128;for(var p=1;p<g.length-8;++p)g[p]=0;var y=8*this.o;for(p=g.length-8;p<g.length;++p)g[p]=y&255,y/=256;for(this.u(g),g=Array(16),p=y=0;4>p;++p)for(var v=0;32>v;v+=8)g[y++]=this.g[p]>>>v&255;return g};function o(g,p){var y=u;return Object.prototype.hasOwnProperty.call(y,g)?y[g]:y[g]=p(g)}function a(g,p){this.h=p;for(var y=[],v=!0,T=g.length-1;0<=T;T--){var A=g[T]|0;v&&A==p||(y[T]=A,v=!1)}this.g=y}var u={};function h(g){return-128<=g&&128>g?o(g,function(p){return new a([p|0],0>p?-1:0)}):new a([g|0],0>g?-1:0)}function d(g){if(isNaN(g)||!isFinite(g))return I;if(0>g)return C(d(-g));for(var p=[],y=1,v=0;g>=y;v++)p[v]=g/y|0,y*=4294967296;return new a(p,0)}function m(g,p){if(g.length==0)throw Error("number format error: empty string");if(p=p||10,2>p||36<p)throw Error("radix out of range: "+p);if(g.charAt(0)=="-")return C(m(g.substring(1),p));if(0<=g.indexOf("-"))throw Error('number format error: interior "-" character');for(var y=d(Math.pow(p,8)),v=I,T=0;T<g.length;T+=8){var A=Math.min(8,g.length-T),_=parseInt(g.substring(T,T+A),p);8>A?(A=d(Math.pow(p,A)),v=v.j(A).add(d(_))):(v=v.j(y),v=v.add(d(_)))}return v}var I=h(0),E=h(1),b=h(16777216);n=a.prototype,n.m=function(){if(N(this))return-C(this).m();for(var g=0,p=1,y=0;y<this.g.length;y++){var v=this.i(y);g+=(0<=v?v:4294967296+v)*p,p*=4294967296}return g},n.toString=function(g){if(g=g||10,2>g||36<g)throw Error("radix out of range: "+g);if(D(this))return"0";if(N(this))return"-"+C(this).toString(g);for(var p=d(Math.pow(g,6)),y=this,v="";;){var T=Z(y,p).g;y=O(y,T.j(p));var A=((0<y.g.length?y.g[0]:y.h)>>>0).toString(g);if(y=T,D(y))return A+v;for(;6>A.length;)A="0"+A;v=A+v}},n.i=function(g){return 0>g?0:g<this.g.length?this.g[g]:this.h};function D(g){if(g.h!=0)return!1;for(var p=0;p<g.g.length;p++)if(g.g[p]!=0)return!1;return!0}function N(g){return g.h==-1}n.l=function(g){return g=O(this,g),N(g)?-1:D(g)?0:1};function C(g){for(var p=g.g.length,y=[],v=0;v<p;v++)y[v]=~g.g[v];return new a(y,~g.h).add(E)}n.abs=function(){return N(this)?C(this):this},n.add=function(g){for(var p=Math.max(this.g.length,g.g.length),y=[],v=0,T=0;T<=p;T++){var A=v+(this.i(T)&65535)+(g.i(T)&65535),_=(A>>>16)+(this.i(T)>>>16)+(g.i(T)>>>16);v=_>>>16,A&=65535,_&=65535,y[T]=_<<16|A}return new a(y,y[y.length-1]&-2147483648?-1:0)};function O(g,p){return g.add(C(p))}n.j=function(g){if(D(this)||D(g))return I;if(N(this))return N(g)?C(this).j(C(g)):C(C(this).j(g));if(N(g))return C(this.j(C(g)));if(0>this.l(b)&&0>g.l(b))return d(this.m()*g.m());for(var p=this.g.length+g.g.length,y=[],v=0;v<2*p;v++)y[v]=0;for(v=0;v<this.g.length;v++)for(var T=0;T<g.g.length;T++){var A=this.i(v)>>>16,_=this.i(v)&65535,bt=g.i(T)>>>16,ie=g.i(T)&65535;y[2*v+2*T]+=_*ie,q(y,2*v+2*T),y[2*v+2*T+1]+=A*ie,q(y,2*v+2*T+1),y[2*v+2*T+1]+=_*bt,q(y,2*v+2*T+1),y[2*v+2*T+2]+=A*bt,q(y,2*v+2*T+2)}for(v=0;v<p;v++)y[v]=y[2*v+1]<<16|y[2*v];for(v=p;v<2*p;v++)y[v]=0;return new a(y,0)};function q(g,p){for(;(g[p]&65535)!=g[p];)g[p+1]+=g[p]>>>16,g[p]&=65535,p++}function $(g,p){this.g=g,this.h=p}function Z(g,p){if(D(p))throw Error("division by zero");if(D(g))return new $(I,I);if(N(g))return p=Z(C(g),p),new $(C(p.g),C(p.h));if(N(p))return p=Z(g,C(p)),new $(C(p.g),p.h);if(30<g.g.length){if(N(g)||N(p))throw Error("slowDivide_ only works with positive integers.");for(var y=E,v=p;0>=v.l(g);)y=_t(y),v=_t(v);var T=x(y,1),A=x(v,1);for(v=x(v,2),y=x(y,2);!D(v);){var _=A.add(v);0>=_.l(g)&&(T=T.add(y),A=_),v=x(v,1),y=x(y,1)}return p=O(g,T.j(p)),new $(T,p)}for(T=I;0<=g.l(p);){for(y=Math.max(1,Math.floor(g.m()/p.m())),v=Math.ceil(Math.log(y)/Math.LN2),v=48>=v?1:Math.pow(2,v-48),A=d(y),_=A.j(p);N(_)||0<_.l(g);)y-=v,A=d(y),_=A.j(p);D(A)&&(A=E),T=T.add(A),g=O(g,_)}return new $(T,g)}n.A=function(g){return Z(this,g).h},n.and=function(g){for(var p=Math.max(this.g.length,g.g.length),y=[],v=0;v<p;v++)y[v]=this.i(v)&g.i(v);return new a(y,this.h&g.h)},n.or=function(g){for(var p=Math.max(this.g.length,g.g.length),y=[],v=0;v<p;v++)y[v]=this.i(v)|g.i(v);return new a(y,this.h|g.h)},n.xor=function(g){for(var p=Math.max(this.g.length,g.g.length),y=[],v=0;v<p;v++)y[v]=this.i(v)^g.i(v);return new a(y,this.h^g.h)};function _t(g){for(var p=g.g.length+1,y=[],v=0;v<p;v++)y[v]=g.i(v)<<1|g.i(v-1)>>>31;return new a(y,g.h)}function x(g,p){var y=p>>5;p%=32;for(var v=g.g.length-y,T=[],A=0;A<v;A++)T[A]=0<p?g.i(A+y)>>>p|g.i(A+y+1)<<32-p:g.i(A+y);return new a(T,g.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,Ja=r,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.A,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=d,a.fromString=m,de=a}).apply(typeof Jo<"u"?Jo:typeof self<"u"?self:typeof window<"u"?window:{});var rr=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gf{constructor(t,e,r,s){this.remoteDocumentCache=t,this.mutationQueue=e,this.documentOverlayCache=r,this.indexManager=s}getDocument(t,e){let r=null;return this.documentOverlayCache.getOverlay(t,e).next(s=>(r=s,this.remoteDocumentCache.getEntry(t,e))).next(s=>(r!==null&&vn(r.mutation,s,At.empty(),G.now()),s))}getDocuments(t,e){return this.remoteDocumentCache.getEntries(t,e).next(r=>this.getLocalViewOfDocuments(t,r,j()).next(()=>r))}getLocalViewOfDocuments(t,e,r=j()){const s=he();return this.populateOverlays(t,s,e).next(()=>this.computeViews(t,e,s,r).next(o=>{let a=mn();return o.forEach((u,h)=>{a=a.insert(u,h.overlayedDocument)}),a}))}getOverlayedDocuments(t,e){const r=he();return this.populateOverlays(t,r,e).next(()=>this.computeViews(t,e,r,j()))}populateOverlays(t,e,r){const s=[];return r.forEach(o=>{e.has(o)||s.push(o)}),this.documentOverlayCache.getOverlays(t,s).next(o=>{o.forEach((a,u)=>{e.set(a,u)})})}computeViews(t,e,r,s){let o=jt();const a=En(),u=function(){return En()}();return e.forEach((h,d)=>{const m=r.get(d.key);s.has(d.key)&&(m===void 0||m.mutation instanceof re)?o=o.insert(d.key,d):m!==void 0?(a.set(d.key,m.mutation.getFieldMask()),vn(m.mutation,d,m.mutation.getFieldMask(),G.now())):a.set(d.key,At.empty())}),this.recalculateAndSaveOverlays(t,o).next(h=>(h.forEach((d,m)=>a.set(d,m)),e.forEach((d,m)=>{var I;return u.set(d,new pf(m,(I=a.get(d))!==null&&I!==void 0?I:null))}),u))}recalculateAndSaveOverlays(t,e){const r=En();let s=new tt((a,u)=>a-u),o=j();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(t,e).next(a=>{for(const u of a)u.keys().forEach(h=>{const d=e.get(h);if(d===null)return;let m=r.get(h)||At.empty();m=u.applyToLocalView(d,m),r.set(h,m);const I=(s.get(u.batchId)||j()).add(h);s=s.insert(u.batchId,I)})}).next(()=>{const a=[],u=s.getReverseIterator();for(;u.hasNext();){const h=u.getNext(),d=h.key,m=h.value,I=vl();m.forEach(E=>{if(!o.has(E)){const b=bl(e.get(E),r.get(E));b!==null&&I.set(E,b),o=o.add(E)}}),a.push(this.documentOverlayCache.saveOverlays(t,d,I))}return P.waitFor(a)}).next(()=>r)}recalculateAndSaveOverlaysForDocumentKeys(t,e){return this.remoteDocumentCache.getEntries(t,e).next(r=>this.recalculateAndSaveOverlays(t,r))}getDocumentsMatchingQuery(t,e,r,s){return function(a){return L.isDocumentKey(a.path)&&a.collectionGroup===null&&a.filters.length===0}(e)?this.getDocumentsMatchingDocumentQuery(t,e.path):pl(e)?this.getDocumentsMatchingCollectionGroupQuery(t,e,r,s):this.getDocumentsMatchingCollectionQuery(t,e,r,s)}getNextDocuments(t,e,r,s){return this.remoteDocumentCache.getAllFromCollectionGroup(t,e,r,s).next(o=>{const a=s-o.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(t,e,r.largestBatchId,s-o.size):P.resolve(he());let u=-1,h=o;return a.next(d=>P.forEach(d,(m,I)=>(u<I.largestBatchId&&(u=I.largestBatchId),o.get(m)?P.resolve():this.remoteDocumentCache.getEntry(t,m).next(E=>{h=h.insert(m,E)}))).next(()=>this.populateOverlays(t,d,o)).next(()=>this.computeViews(t,h,d,j())).next(m=>({batchId:u,changes:El(m)})))})}getDocumentsMatchingDocumentQuery(t,e){return this.getDocument(t,new L(e)).next(r=>{let s=mn();return r.isFoundDocument()&&(s=s.insert(r.key,r)),s})}getDocumentsMatchingCollectionGroupQuery(t,e,r,s){const o=e.collectionGroup;let a=mn();return this.indexManager.getCollectionParents(t,o).next(u=>P.forEach(u,h=>{const d=function(I,E){return new je(E,null,I.explicitOrderBy.slice(),I.filters.slice(),I.limit,I.limitType,I.startAt,I.endAt)}(e,h.child(o));return this.getDocumentsMatchingCollectionQuery(t,d,r,s).next(m=>{m.forEach((I,E)=>{a=a.insert(I,E)})})}).next(()=>a))}getDocumentsMatchingCollectionQuery(t,e,r,s){let o;return this.documentOverlayCache.getOverlaysForCollection(t,e.path,r.largestBatchId).next(a=>(o=a,this.remoteDocumentCache.getDocumentsMatchingQuery(t,e,r,o,s))).next(a=>{o.forEach((h,d)=>{const m=d.getKey();a.get(m)===null&&(a=a.insert(m,yt.newInvalidDocument(m)))});let u=mn();return a.forEach((h,d)=>{const m=o.get(h);m!==void 0&&vn(m.mutation,d,At.empty(),G.now()),Dr(e,d)&&(u=u.insert(h,d))}),u})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pt="WebChannelConnection";class Uf extends class{constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const r=e.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),o=encodeURIComponent(this.databaseId.database);this.Do=r+"://"+e.host,this.vo=`projects/${s}/databases/${o}`,this.Co=this.databaseId.database==="(default)"?`project_id=${s}`:`project_id=${s}&database_id=${o}`}get Fo(){return!1}Mo(e,r,s,o,a){const u=vs(),h=this.xo(e,r.toUriEncodedString());M("RestConnection",`Sending RPC '${e}' ${u}:`,h,s);const d={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(d,o,a),this.No(e,h,d,s).then(m=>(M("RestConnection",`Received RPC '${e}' ${u}: `,m),m),m=>{throw Ne("RestConnection",`RPC '${e}' ${u} failed with error: `,m,"url: ",h,"request:",s),m})}Lo(e,r,s,o,a,u){return this.Mo(e,r,s,o,a)}Oo(e,r,s){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+qe}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((o,a)=>e[a]=o),s&&s.headers.forEach((o,a)=>e[a]=o)}xo(e,r){const s=Bf[e];return`${this.Do}/v1/${r}:${s}`}terminate(){}}{constructor(t){super(t),this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}No(t,e,r,s){const o=vs();return new Promise((a,u)=>{const h=new Za;h.setWithCredentials(!0),h.listenOnce(tl.COMPLETE,()=>{try{switch(h.getLastErrorCode()){case lr.NO_ERROR:const m=h.getResponseJson();M(pt,`XHR for RPC '${t}' ${o} received:`,JSON.stringify(m)),a(m);break;case lr.TIMEOUT:M(pt,`RPC '${t}' ${o} timed out`),u(new k(S.DEADLINE_EXCEEDED,"Request time out"));break;case lr.HTTP_ERROR:const I=h.getStatus();if(M(pt,`RPC '${t}' ${o} failed with status:`,I,"response text:",h.getResponseText()),I>0){let E=h.getResponseJson();Array.isArray(E)&&(E=E[0]);const b=E==null?void 0:E.error;if(b&&b.status&&b.message){const D=function(C){const O=C.toLowerCase().replace(/_/g,"-");return Object.values(S).indexOf(O)>=0?O:S.UNKNOWN}(b.status);u(new k(D,b.message))}else u(new k(S.UNKNOWN,"Server responded with status "+h.getStatus()))}else u(new k(S.UNAVAILABLE,"Connection failed."));break;default:B()}}finally{M(pt,`RPC '${t}' ${o} completed.`)}});const d=JSON.stringify(s);M(pt,`RPC '${t}' ${o} sending request:`,s),h.send(e,"POST",d,r,15)})}Bo(t,e,r){const s=vs(),o=[this.Do,"/","google.firestore.v1.Firestore","/",t,"/channel"],a=rl(),u=nl(),h={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(h.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(h.useFetchStreams=!0),this.Oo(h.initMessageHeaders,e,r),h.encodeInitMessageHeaders=!0;const m=o.join("");M(pt,`Creating RPC '${t}' stream ${s}: ${m}`,h);const I=a.createWebChannel(m,h);let E=!1,b=!1;const D=new Ff({Io:C=>{b?M(pt,`Not sending because RPC '${t}' stream ${s} is closed:`,C):(E||(M(pt,`Opening RPC '${t}' stream ${s} transport.`),I.open(),E=!0),M(pt,`RPC '${t}' stream ${s} sending:`,C),I.send(C))},To:()=>I.close()}),N=(C,O,q)=>{C.listen(O,$=>{try{q($)}catch(Z){setTimeout(()=>{throw Z},0)}})};return N(I,fn.EventType.OPEN,()=>{b||(M(pt,`RPC '${t}' stream ${s} transport opened.`),D.yo())}),N(I,fn.EventType.CLOSE,()=>{b||(b=!0,M(pt,`RPC '${t}' stream ${s} transport closed`),D.So())}),N(I,fn.EventType.ERROR,C=>{b||(b=!0,Ne(pt,`RPC '${t}' stream ${s} transport errored:`,C),D.So(new k(S.UNAVAILABLE,"The operation could not be completed")))}),N(I,fn.EventType.MESSAGE,C=>{var O;if(!b){const q=C.data[0];Q(!!q);const $=q,Z=$.error||((O=$[0])===null||O===void 0?void 0:O.error);if(Z){M(pt,`RPC '${t}' stream ${s} received error:`,Z);const _t=Z.status;let x=function(y){const v=rt[y];if(v!==void 0)return Pl(v)}(_t),g=Z.message;x===void 0&&(x=S.INTERNAL,g="Unknown error status: "+_t+" with message "+Z.message),b=!0,D.So(new k(x,g)),I.close()}else M(pt,`RPC '${t}' stream ${s} received:`,q),D.bo(q)}}),N(u,el.STAT_EVENT,C=>{C.stat===xs.PROXY?M(pt,`RPC '${t}' stream ${s} detected buffering proxy`):C.stat===xs.NOPROXY&&M(pt,`RPC '${t}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{D.wo()},0),D}}function Ts(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function Tu(n){n=Ct(n,Tt);const t=Ct(n.firestore,Ie);return Sm(Ai(t),n._key).then(e=>Qm(t,n,e))}class Iu extends qm{constructor(t){super(),this.firestore=t}convertBytes(t){return new Fe(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new Tt(this.firestore,null,e)}}function We(n){n=Ct(n,se);const t=Ct(n.firestore,Ie),e=Ai(t),r=new Iu(t);return $m(n._query),Pm(e,n._query).then(s=>new jm(t,r,n,s))}function Hm(n,t,e){n=Ct(n,Tt);const r=Ct(n.firestore,Ie),s=Eu(n.converter,t);return jr(r,[du(Fr(r),"setDoc",n._key,s,n.converter!==null,e).toMutation(n._key,St.none())])}function Km(n,t,e,...r){n=Ct(n,Tt);const s=Ct(n.firestore,Ie),o=Fr(s);let a;return a=typeof(t=Ut(t))=="string"||t instanceof Br?Om(o,"updateDoc",n._key,t,e,r):Lm(o,"updateDoc",n._key,t),jr(s,[a.toMutation(n._key,St.exists(!0))])}function Wm(n){return jr(Ct(n.firestore,Ie),[new ui(n._key,St.none())])}function Gm(n,t){const e=Ct(n.firestore,Ie),r=Ke(n),s=Eu(n.converter,t);return jr(e,[du(Fr(n.firestore),"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,St.exists(!1))]).then(()=>r)}function jr(n,t){return function(r,s){const o=new Ft;return r.asyncQueue.enqueueAndForget(async()=>gm(await bm(r),s,o)),o.promise}(Ai(n),t)}function Qm(n,t,e){const r=e.docs.get(t._key),s=new Iu(n);return new vu(n,s,t._key,r,new gn(e.hasPendingWrites,e.fromCache),t.converter)}(function(t,e=!0){(function(s){qe=s})(Nh),pr(new Tn("firestore",(r,{instanceIdentifier:s,options:o})=>{const a=r.getProvider("app").getImmediate(),u=new Ie(new Gh(r.getProvider("auth-internal")),new Jh(r.getProvider("app-check-internal")),function(d,m){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new k(S.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Rn(d.options.projectId,m)}(a,s),a);return o=Object.assign({useFetchStreams:e},o),u._setSettings(o),u},"PUBLIC").setMultipleInstances(!0)),Ve(Zo,"4.7.3",t),Ve(Zo,"4.7.3","esm2017")})();const Ym="55555",Ys="baby-tracker-auth",Xm=24*60*60*1e3,Jm={apiKey:"AIzaSyA66X3tR-oquob5ZbBrrHv_EAmhwEHTi48",authDomain:"baby-tracker-b0936.firebaseapp.com",projectId:"baby-tracker-b0936",storageBucket:"baby-tracker-b0936.firebasestorage.app",messagingSenderId:"931756532206",appId:"1:931756532206:web:bf90d10dc3e3837383eeff"},Zm=Qa(Jm),Rt=Vm(Zm);function tp(){const n=localStorage.getItem(Ys);if(!n)return!1;try{const{timestamp:t}=JSON.parse(n);return Date.now()-t<Xm?!0:(localStorage.removeItem(Ys),!1)}catch{return!1}}function ep(){const n={timestamp:Date.now()};localStorage.setItem(Ys,JSON.stringify(n))}let kt=Ue(new Date),Rr=null,ws=null,As=null,Rs=null,bs=null,Ss=null;function Ue(n){const t=new Date(n),e=t.getDay(),r=t.getDate()-e;return t.setDate(r),t.setHours(0,0,0,0),t}function np(n){const t=new Date(n);return t.setDate(t.getDate()+6),t.setHours(23,59,59,999),t}function Ce(n){const t=n.getFullYear(),e=String(n.getMonth()+1).padStart(2,"0"),r=String(n.getDate()).padStart(2,"0"),s=String(n.getHours()).padStart(2,"0"),o=String(n.getMinutes()).padStart(2,"0");return`${t}-${e}-${r}T${s}:${o}`}function Vt(n){const t=n.getFullYear(),e=String(n.getMonth()+1).padStart(2,"0"),r=String(n.getDate()).padStart(2,"0");return`${t}-${e}-${r}`}function rp(n){const t=String(n.getMonth()+1).padStart(2,"0"),e=String(n.getDate()).padStart(2,"0"),r=n.getFullYear(),s=n.getHours(),o=String(n.getMinutes()).padStart(2,"0"),a=s>=12?"PM":"AM",u=s%12||12;return`${t}/${e}/${r} ${u}:${o} ${a}`}function Xs(n){const t=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],e=String(n.getMonth()+1).padStart(2,"0"),r=String(n.getDate()).padStart(2,"0"),s=n.getFullYear();return`${t[n.getDay()]}, ${e}/${r}/${s}`}function br(n){const t=n.getFullYear(),e=String(n.getMonth()+1).padStart(2,"0"),r=String(n.getDate()).padStart(2,"0");return`${t}-${e}-${r}`}async function Li(){const n=document.getElementById("vitamin-d-checkbox"),t=document.getElementById("vitamin-d-status"),e=document.getElementById("vitamin-d-label-text");if(!n||!t||!e)return;const s=br(new Date);try{const o=await Tu(Ke(Rt,"vitaminD",s));if(o.exists()){const a=o.data();n.checked=a.given===!0}else n.checked=!1;e.textContent=n.checked?"Vitamin D drop given":"Record Vitamin D drop",t.textContent="",t.style.display="none"}catch(o){console.error("Error loading vitamin D status:",o),t.className="error",t.textContent="Failed to load vitamin D status",t.style.display="block"}}function wu(){Ss&&clearTimeout(Ss);const n=new Date,t=new Date(n);t.setDate(t.getDate()+1),t.setHours(0,0,0,0);const e=t.getTime()-n.getTime();Ss=window.setTimeout(()=>{Li(),wu()},e)}async function sp(n){const t=n.target,e=document.getElementById("vitamin-d-status"),r=document.getElementById("vitamin-d-label-text");if(!e||!r)return;const s=new Date,o=br(s);try{await Hm(Ke(Rt,"vitaminD",o),{given:t.checked,date:G.fromDate(s)}),r.textContent=t.checked?"Vitamin D drop given":"Record Vitamin D drop",e.style.display="none"}catch(a){console.error("Error saving vitamin D status:",a),e.className="error",e.textContent="Failed to save vitamin D status",e.style.display="block",t.checked=!t.checked,r.textContent=t.checked?"Vitamin D drop given":"Record Vitamin D drop"}}function Au(){const n=document.getElementById("passcode-input"),t=document.getElementById("passcode-error"),e=document.getElementById("passcode-screen"),r=document.getElementById("app");n.value===Ym?(n.blur(),ep(),e.style.display="none",r.style.display="block",setTimeout(()=>{window.scrollTo(0,0),document.body.scrollTop=0,document.documentElement.scrollTop=0},0),Ru()):(t.textContent="Incorrect passcode",t.style.display="block",n.value="")}function Ru(){lp(),Oi(),ip(),_p(),op(),ap(),Li(),wu(),window.scrollTo(0,0)}function ip(){const n=new Date,t=document.getElementById("start-date-filter"),e=document.getElementById("end-date-filter");t&&(t.value=Vt(n)),e&&(e.value=Vt(n))}function op(){[document.getElementById("bottle-amount"),document.getElementById("pump-amount"),document.getElementById("edit-bottle-amount"),document.getElementById("edit-pump-amount")].forEach(t=>{t&&(t.addEventListener("keypress",e=>{const r=e.key,s=t.value;e.key==="Backspace"||e.key==="Delete"||e.key==="Tab"||e.key==="Escape"||e.key==="Enter"||e.ctrlKey||e.metaKey||r>="0"&&r<="9"||r==="."&&s.indexOf(".")===-1||e.preventDefault()}),t.addEventListener("paste",e=>{var u;e.preventDefault();const s=(((u=e.clipboardData)==null?void 0:u.getData("text"))||"").replace(/[^0-9.]/g,""),o=s.split("."),a=o.length>2?o[0]+"."+o.slice(1).join(""):s;document.execCommand("insertText",!1,a)}))})}function ap(){const n=document.getElementById("bottle-unit"),t=document.getElementById("bottle-amount"),e=document.getElementById("pump-unit"),r=document.getElementById("pump-amount"),s=document.getElementById("edit-bottle-unit"),o=document.getElementById("edit-bottle-amount"),a=document.getElementById("edit-pump-unit"),u=document.getElementById("edit-pump-amount");n&&t&&n.addEventListener("change",()=>{ar(t,n.value)}),e&&r&&e.addEventListener("change",()=>{ar(r,e.value)}),s&&o&&s.addEventListener("change",()=>{ar(o,s.value)}),a&&u&&a.addEventListener("change",()=>{ar(u,a.value)})}function ar(n,t){const e=parseFloat(n.value);if(isNaN(e)||e<=0)return;const r=n.dataset.lastUnit||"oz";if(r===t)return;let s;if(t==="ml"&&r==="oz")s=e*29.5735;else if(t==="oz"&&r==="ml")s=e*.033814;else return;n.value=s.toFixed(2),n.dataset.lastUnit=t}function Ba(n){if(!n.value)return!0;const t=new Date(n.value),e=new Date;return t>e?(alert("Cannot select future times. Please select a time in the past."),n.value=Ce(e),!1):!0}function Gt(n){const t=document.getElementById(n);t&&(n==="pump-end-time"||n==="edit-pump-end-time"||(t.addEventListener("blur",()=>{Ba(t)}),t.addEventListener("change",()=>{Ba(t)})))}function lp(){const n=document.getElementById("entry-type"),t=document.getElementById("submit-entry");n.addEventListener("change",up),t.addEventListener("click",cp);const e=document.getElementById("vitamin-d-checkbox");e&&e.addEventListener("change",sp);const r=document.getElementById("refresh-button");r&&r.addEventListener("click",()=>{window.location.reload()});const s=document.getElementById("entry-tab"),o=document.getElementById("timeline-tab"),a=document.getElementById("weekly-tab");s.addEventListener("click",()=>Ps("entry")),o.addEventListener("click",()=>Ps("timeline")),a.addEventListener("click",()=>Ps("weekly"));const u=document.getElementById("prev-week"),h=document.getElementById("next-week"),d=document.getElementById("current-week");u.addEventListener("click",()=>Fa(-1)),h.addEventListener("click",()=>Fa(1)),d&&d.addEventListener("click",fp);const m=document.getElementById("save-edit"),I=document.getElementById("cancel-edit");m.addEventListener("click",gp),I.addEventListener("click",bu);const E=document.getElementById("start-date-filter"),b=document.getElementById("end-date-filter"),D=document.getElementById("type-filter"),N=document.getElementById("today-button"),C=document.getElementById("last-48-button"),O=document.getElementById("last-72-button"),q=document.getElementById("last-week-button"),$=document.getElementById("all-time-button");E.addEventListener("change",()=>fe()),b.addEventListener("change",()=>fe()),D.addEventListener("change",()=>fe()),N.addEventListener("click",()=>dn("today")),C.addEventListener("click",()=>dn("last-48")),O.addEventListener("click",()=>dn("last-72")),q.addEventListener("click",()=>dn("last-week")),$.addEventListener("click",()=>dn("all-time")),Gt("bottle-time"),Gt("diaper-time"),Gt("pump-start-time"),Gt("pump-end-time"),Gt("edit-bottle-time"),Gt("edit-diaper-time"),Gt("edit-pump-start-time"),Gt("edit-pump-end-time")}function Oi(){const t=Ce(new Date),e=document.getElementById("bottle-time"),r=document.getElementById("diaper-time"),s=document.getElementById("pump-start-time"),o=document.getElementById("pump-end-time");e&&(e.value=t),r&&(r.value=t),s&&(s.value=t),o&&(o.value=t)}function up(n){const e=n.target.value,r=document.getElementById("bottle-fields"),s=document.getElementById("diaper-fields"),o=document.getElementById("pump-fields"),a=document.getElementById("submit-entry");if(r.style.display="none",s.style.display="none",o.style.display="none",e==="bottle-breast-milk"||e==="bottle-formula"){r.style.display="block",a.style.display="block";const u=document.getElementById("bottle-unit"),h=document.getElementById("bottle-amount");h.dataset.lastUnit=u.value}else if(e==="diaper")s.style.display="block",a.style.display="block";else if(e==="pump"){o.style.display="block",a.style.display="block";const u=document.getElementById("pump-unit"),h=document.getElementById("pump-amount");h.dataset.lastUnit=u.value}else a.style.display="none";Oi()}async function cp(){const n=document.getElementById("entry-type").value,t=document.getElementById("submit-status");try{let e=null;const r=new Date;if(n==="bottle-breast-milk"||n==="bottle-formula"){const s=document.getElementById("bottle-time"),o=s.value,a=parseFloat(document.getElementById("bottle-amount").value),u=document.getElementById("bottle-unit").value,h=document.getElementById("bottle-notes").value;if(!o)throw new Error("Start time is required");const d=new Date(s.value);if(d>r)throw new Error("Cannot add entries in the future");if(isNaN(a)||a<=0)throw new Error("Amount must be greater than 0");e={type:"Feed",subType:n==="bottle-breast-milk"?"Breast Milk":"Formula",startTime:d,amount:a,unit:u,notes:h}}else if(n==="diaper"){const s=document.getElementById("diaper-time"),o=s.value,a=document.getElementById("diaper-type").value,u=document.getElementById("diaper-notes").value;if(!o)throw new Error("Start time is required");const h=new Date(s.value);if(h>r)throw new Error("Cannot add entries in the future");if(!a)throw new Error("Diaper type is required");e={type:"Diaper",diaperType:a,startTime:h,notes:u}}else if(n==="pump"){const s=document.getElementById("pump-start-time"),o=document.getElementById("pump-end-time"),a=s.value,u=o.value,h=parseFloat(document.getElementById("pump-amount").value),d=document.getElementById("pump-unit").value,m=document.getElementById("pump-notes").value;if(!a)throw new Error("Start time is required");if(!u)throw new Error("End time is required");const I=new Date(s.value),E=new Date(o.value);if(I>r)throw new Error("Cannot add entries in the future");if(E<I)throw new Error("End time must be after start time");if(isNaN(h)||h<=0)throw new Error("Amount must be greater than 0");e={type:"Pump",startTime:I,endTime:E,amount:h,unit:d,notes:m}}e&&(await Gm(ne(Rt,"entries"),{...e,startTime:G.fromDate(e.startTime),endTime:e.endTime?G.fromDate(e.endTime):null}),t.className="success",t.textContent="Entry added successfully!",t.style.display="block",hp(),e.type==="Feed"?await Su():e.type==="Diaper"?await Pu():e.type==="Pump"&&await Du(),setTimeout(()=>{t.style.display="none"},3e3))}catch(e){t.className="error",t.textContent=e instanceof Error?e.message:"Failed to add entry",t.style.display="block"}}function hp(){document.getElementById("entry-type").value="",document.getElementById("bottle-amount").value="",document.getElementById("bottle-notes").value="",document.getElementById("diaper-notes").value="",document.getElementById("pump-amount").value="",document.getElementById("pump-notes").value="",document.getElementById("bottle-fields").style.display="none",document.getElementById("diaper-fields").style.display="none",document.getElementById("pump-fields").style.display="none",document.getElementById("submit-entry").style.display="none",Oi()}function Ps(n){var t,e,r;document.querySelectorAll(".tab-button").forEach(s=>s.classList.remove("active")),document.querySelectorAll(".view").forEach(s=>s.style.display="none"),n==="entry"?((t=document.getElementById("entry-tab"))==null||t.classList.add("active"),document.getElementById("entry-view").style.display="block",Li()):n==="timeline"?((e=document.getElementById("timeline-tab"))==null||e.classList.add("active"),document.getElementById("timeline-view").style.display="block",fe()):n==="weekly"&&((r=document.getElementById("weekly-tab"))==null||r.classList.add("active"),document.getElementById("weekly-view").style.display="block",Bi()),window.scrollTo(0,0)}function dn(n){const t=document.getElementById("start-date-filter"),e=document.getElementById("end-date-filter"),r=new Date;if(r.setHours(0,0,0,0),n==="all-time")t.value="",e.value="";else if(n==="today")t.value=Vt(r),e.value=Vt(r);else if(n==="last-48"){const s=new Date(r);s.setDate(s.getDate()-1),t.value=Vt(s),e.value=Vt(r)}else if(n==="last-72"){const s=new Date(r);s.setDate(s.getDate()-2),t.value=Vt(s),e.value=Vt(r)}else if(n==="last-week"){const s=new Date(r);s.setDate(s.getDate()-6),t.value=Vt(s),e.value=Vt(r)}fe()}async function fe(){const n=document.getElementById("timeline-list"),t=document.getElementById("timeline-loading"),e=document.getElementById("start-date-filter").value,r=document.getElementById("end-date-filter").value,s=document.getElementById("type-filter").value;t.style.display="block",n.innerHTML="";const o=document.querySelector(".filter-summary");o&&o.remove();try{let a=ye(ne(Rt,"entries"),Ee("startTime","desc"));if(e&&r){const[d,m,I]=e.split("-").map(Number),E=new Date(d,m-1,I,0,0,0,0),[b,D,N]=r.split("-").map(Number),C=new Date(b,D-1,N,23,59,59,999);a=ye(ne(Rt,"entries"),_e("startTime",">=",G.fromDate(E)),_e("startTime","<=",G.fromDate(C)),Ee("startTime","desc"))}const u=await We(a),h={bottles:{total:0,breastMilk:0,formula:0,sessions:0},diapers:{total:0,pee:0,poo:0,mixed:0},pumps:{total:0,sessions:0}};if(u.empty)n.innerHTML="<p>No entries found.</p>";else{let d="",m=!1;if(u.forEach(I=>{const E=I.data(),b=I.id;if(s!=="all"){let g="";if(E.type==="Feed"&&E.subType==="Breast Milk"?g="bottle-breast-milk":E.type==="Feed"&&E.subType==="Formula"?g="bottle-formula":E.type==="Diaper"?g="diaper":E.type==="Pump"&&(g="pump"),s==="bottle-all"){if(E.type!=="Feed")return}else if(g!==s)return}if(E.type==="Feed"){const g=Cn(E.amount,E.unit);h.bottles.total+=g,h.bottles.sessions++,E.subType==="Breast Milk"?h.bottles.breastMilk+=g:E.subType==="Formula"&&(h.bottles.formula+=g)}else if(E.type==="Diaper")h.diapers.total++,E.diaperType==="Pee"?h.diapers.pee++:E.diaperType==="Poo"?h.diapers.poo++:E.diaperType==="Mixed"&&h.diapers.mixed++;else if(E.type==="Pump"){const g=Cn(E.amount,E.unit);h.pumps.total+=g,h.pumps.sessions++}m=!0;const D=E.startTime.toDate(),N=Xs(D);if(N!==d){d=N;const g=document.createElement("div");g.className="timeline-date-header",g.textContent=N,n.appendChild(g)}const C=document.createElement("div");C.className="timeline-entry";let O=E.type,q="",$="";if(E.type==="Feed")O=`Bottle - ${E.subType}`,q=`<div class="timeline-entry-details">Amount: ${Nt(E.amount,E.unit)}</div>`,$="#d9ebf2";else if(E.type==="Breast Feed")O="Breast Feed",q="",$="#d9ebf2";else if(E.type==="Diaper")q=`<div class="timeline-entry-details">Type: ${E.diaperType}</div>`,$="#fce2d4";else if(E.type==="Pump"){const g=E.endTime?E.endTime.toDate():null,p=g?Math.round((g.getTime()-D.getTime())/6e4):0;q=`<div class="timeline-entry-details">Amount: ${Nt(E.amount,E.unit)}<br>Duration: ${p} minutes</div>`,$="#e2daf2"}C.style.backgroundColor=$;const Z=E.notes?`<div class="timeline-entry-notes">${E.notes}</div>`:"";C.innerHTML=`
                ...
                `;const _t=C.querySelector(".edit-button"),x=C.querySelector(".delete-button");_t.addEventListener("click",()=>pp(b,E)),x.addEventListener("click",()=>yp(b)),n.appendChild(C)}),!m)n.innerHTML="<p>No entries match the selected filters.</p>";else{const I=document.createElement("div");I.className="filter-summary";let E='<div class="summary-header">Summary</div><div class="summary-stats">';if((s==="all"||s==="bottle-breast-milk"||s==="bottle-formula"||s==="bottle-all")&&(E+=`
                    ...
                    `),E+="</div>",I.innerHTML=E;const b=document.querySelector(".filter-section");b&&b.parentNode&&b.parentNode.insertBefore(I,n)}}}catch{n.innerHTML='<p class="error">Failed to load timeline</p>'}finally{t.style.display="none"}}async function Bi(){const n=document.getElementById("weekly-stats"),t=document.getElementById("weekly-loading"),e=document.getElementById("week-range"),r=document.getElementById("prev-week"),s=document.getElementById("next-week"),o=document.getElementById("current-week"),u=Ue(new Date("2025-11-05")),d=Ue(new Date),m=new Date(kt);m.setHours(0,0,0,0),m<u&&(kt=new Date(u)),m.getTime()<=u.getTime()?r.disabled=!0:r.disabled=!1,m.getTime()>=d.getTime()?s.disabled=!0:s.disabled=!1,o&&(m.getTime()===d.getTime()?(o.disabled=!0,o.style.backgroundColor="#999",o.style.color="#ccc",o.style.cursor="default"):(o.disabled=!1,o.style.backgroundColor="",o.style.color="",o.style.cursor="pointer"));const I=np(kt);e.textContent=`${Xs(kt).split(",")[1].trim()} - ${Xs(I).split(",")[1].trim()}`,t.style.display="block",n.innerHTML="";try{const E=ye(ne(Rt,"entries"),_e("startTime",">=",G.fromDate(kt)),_e("startTime","<=",G.fromDate(I)),Ee("startTime","asc")),b=await We(E),D=new Date("2025-11-11");D.setHours(0,0,0,0);const N={},C=[];for(let x=0;x<7;x++){const g=new Date(kt);if(g.setDate(g.getDate()+x),g.setHours(0,0,0,0),g>=D){const p=br(g);C.push(p)}}if(C.length>0){const x=await Promise.all(C.map(g=>Tu(Ke(Rt,"vitaminD",g))));C.forEach((g,p)=>{var v;const y=x[p];N[g]=y.exists()&&((v=y.data())==null?void 0:v.given)===!0})}const O={};for(let x=0;x<7;x++){const g=new Date(kt);g.setDate(g.getDate()+x),g.setHours(0,0,0,0);const p=`${g.getFullYear()}-${g.getMonth()}-${g.getDate()}`,y=br(g);O[p]={date:new Date(g),vitaminD:g>=D?N[y]===!0:null,bottles:{total:0,breastMilk:0,formula:0,sessions:0},diapers:{total:0,pee:0,poo:0,mixed:0},pumps:{total:0,sessions:0}}}b.forEach(x=>{const g=x.data(),p=g.startTime.toDate(),y=new Date(p);y.setHours(0,0,0,0);const v=`${y.getFullYear()}-${y.getMonth()}-${y.getDate()}`;if(O[v]){if(g.type==="Feed"){const T=Cn(g.amount,g.unit);O[v].bottles.total+=T,O[v].bottles.sessions++,g.subType==="Breast Milk"?O[v].bottles.breastMilk+=T:g.subType==="Formula"&&(O[v].bottles.formula+=T)}else if(g.type==="Breast Feed")O[v].bottles.sessions++;else if(g.type==="Diaper")O[v].diapers.total++,g.diaperType==="Pee"?O[v].diapers.pee++:g.diaperType==="Poo"?O[v].diapers.poo++:g.diaperType==="Mixed"&&O[v].diapers.mixed++;else if(g.type==="Pump"){const T=Cn(g.amount,g.unit);O[v].pumps.total+=T,O[v].pumps.sessions++}}});const q=Object.keys(O).map(x=>O[x]).sort((x,g)=>x.date.getTime()-g.date.getTime()),$=document.createElement("div");$.className="weekly-scroll-container";const Z=new Date;Z.setHours(0,0,0,0);let _t=-1;q.forEach((x,g)=>{const p=document.createElement("div");p.className="day-stats";const y=new Date(x.date);y.setHours(0,0,0,0),Z.getTime()===y.getTime()&&(p.classList.add("current-day"),_t=g);const v=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"][x.date.getDay()],T=`${x.date.getMonth()+1}/${x.date.getDate()}`,A=x.diapers.pee+x.diapers.mixed,_=x.diapers.poo+x.diapers.mixed;let bt="";if(x.vitaminD!==null){const ie=x.vitaminD?"Yes":"No";bt=`
                    <div class="stat-group">
                        <div class="stat-group-title">Vitamin D</div>
                        <div class="stat-line" style="color: ${x.vitaminD?"#4caf50":"#f44336"}; font-weight: bold;">${ie}</div>
                    </div>
                `}p.innerHTML=`
                <div class="day-stats-header">${v}<br>${T}</div>
                ${bt}
                <div class="stat-group">
                    <div class="stat-group-title">Bottles</div>
