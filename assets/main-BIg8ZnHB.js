 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $d=new mt(q.comparator);function fe(){return $d}const xl=new mt(q.comparator);function Bn(...n){let t=xl;for(const e of n)t=t.insert(e.key,e);return t}function Bl(n){let t=xl;return n.forEach((e,r)=>t=t.insert(e,r.overlayedDocument)),t}function xe(){return $n()}function Ll(){return $n()}function $n(){return new pn(n=>n.toString(),(n,t)=>n.isEqual(t))}const qd=new mt(q.comparator),jd=new Ct(q.comparator);function X(...n){let t=jd;for(const e of n)t=t.add(e);return t}const zd=new Ct(et);function Hd(){return zd}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Of{constructor(t,e){this.qr={},this.overlays={},this.Qr=new vi(0),this.Kr=!1,this.Kr=!0,this.$r=new Mf,this.referenceDelegate=t(this),this.Ur=new Ff(this),this.indexManager=new Df,this.remoteDocumentCache=function(s){return new Bf(s)}(r=>this.referenceDelegate.Wr(r)),this.serializer=new Sf(e),this.Gr=new kf(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.Kr=!1,Promise.resolve()}get started(){return this.Kr}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(t){return this.indexManager}getDocumentOverlayCache(t){let e=this.overlays[t.toKey()];return e||(e=new Nf,this.overlays[t.toKey()]=e),e}getMutationQueue(t,e){let r=this.qr[t.toKey()];return r||(r=new xf(e,this.referenceDelegate),this.qr[t.toKey()]=r),r}getGlobalsCache(){return this.$r}getTargetCache(){return this.Ur}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Gr}runTransaction(t,e,r){L("MemoryPersistence","Starting transaction:",t);const s=new Uf(this.Qr.next());return this.referenceDelegate.zr(),r(s).next(o=>this.referenceDelegate.jr(s).next(()=>o)).toPromise().then(o=>(s.raiseOnCommittedEvent(),o))}Hr(t,e){return V.or(Object.values(this.qr).map(r=>()=>r.containsKey(t,e)))}}class Uf extends Td{constructor(t){super(),this.currentSequenceNumber=t}}class Mi{constructor(t){this.persistence=t,this.Jr=new Ni,this.Yr=null}static Zr(t){return new Mi(t)}get Xr(){if(this.Yr)return this.Yr;throw K()}addReference(t,e,r){return this.Jr.addReference(r,e),this.Xr.delete(r.toString()),V.resolve()}removeReference(t,e,r){return this.Jr.removeReference(r,e),this.Xr.add(r.toString()),V.resolve()}markPotentiallyOrphaned(t,e){return this.Xr.add(e.toString()),V.resolve()}removeTarget(t,e){this.Jr.gr(e.targetId).forEach(s=>this.Xr.add(s.toString()));const r=this.persistence.getTargetCache();return r.getMatchingKeysForTargetId(t,e.targetId).next(s=>{s.forEach(o=>this.Xr.add(o.toString()))}).next(()=>r.removeTargetData(t,e))}zr(){this.Yr=new Set}jr(t){const e=this.persistence.getRemoteDocumentCache().newChangeBuffer();return V.forEach(this.Xr,r=>{const s=q.fromPath(r);return this.ei(t,s).next(o=>{o||e.removeEntry(s,W.min())})}).next(()=>(this.Yr=null,e.apply(t)))}updateLimboDocument(t,e){return this.ei(t,e).next(r=>{r?this.Xr.delete(e.toString()):this.Xr.add(e.toString())})}Wr(t){return 0}ei(t,e){return V.or([()=>V.resolve(this.Jr.containsKey(e)),()=>this.persistence.getTargetCache().containsKey(t,e),()=>this.persistence.Hr(t,e)])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lt="WebChannelConnection";class em extends class{constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const r=e.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),o=encodeURIComponent(this.databaseId.database);this.Do=r+"://"+e.host,this.vo=`projects/${s}/databases/${o}`,this.Co=this.databaseId.database==="(default)"?`project_id=${s}`:`project_id=${s}&database_id=${o}`}get Fo(){return!1}Mo(e,r,s,o,a){const c=xs(),h=this.xo(e,r.toUriEncodedString());L("RestConnection",`Sending RPC '${e}' ${c}:`,h,s);const d={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(d,o,a),this.No(e,h,d,s).then(m=>(L("RestConnection",`Received RPC '${e}' ${c}: `,m),m),m=>{throw nn("RestConnection",`RPC '${e}' ${c} failed with error: `,m,"url: ",h,"request:",s),m})}Lo(e,r,s,o,a,c){return this.Mo(e,r,s,o,a)}Oo(e,r,s){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+fn}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((o,a)=>e[a]=o),s&&s.headers.forEach((o,a)=>e[a]=o)}xo(e,r){const s=Zf[e];return`${this.Do}/v1/${r}:${s}`}terminate(){}}{constructor(t){super(t),this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}No(t,e,r,s){const o=xs();return new Promise((a,c)=>{const h=new gl;h.setWithCredentials(!0),h.listenOnce(yl.COMPLETE,()=>{try{switch(h.getLastErrorCode()){case br.NO_ERROR:const m=h.getResponseJson();L(Lt,`XHR for RPC '${t}' ${o} received:`,JSON.stringify(m)),a(m);break;case br.TIMEOUT:L(Lt,`RPC '${t}' ${o} timed out`),c(new M(D.DEADLINE_EXCEEDED,"Request time out"));break;case br.HTTP_ERROR:const E=h.getStatus();if(L(Lt,`RPC '${t}' ${o} failed with status:`,E,"response text:",h.getResponseText()),E>0){let v=h.getResponseJson();Array.isArray(v)&&(v=v[0]);const S=v==null?void 0:v.error;if(S&&S.status&&S.message){const P=function(C){const R=C.toLowerCase().replace(/_/g,"-");return Object.values(D).indexOf(R)>=0?R:D.UNKNOWN}(S.status);c(new M(P,S.message))}else c(new M(D.UNKNOWN,"Server responded with status "+h.getStatus()))}else c(new M(D.UNAVAILABLE,"Connection failed."));break;default:K()}}finally{L(Lt,`RPC '${t}' ${o} completed.`)}});const d=JSON.stringify(s);L(Lt,`RPC '${t}' ${o} sending request:`,s),h.send(e,"POST",d,r,15)})}Bo(t,e,r){const s=xs(),o=[this.Do,"/","google.firestore.v1.Firestore","/",t,"/channel"],a=Tl(),c=El(),h={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(h.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(h.useFetchStreams=!0),this.Oo(h.initMessageHeaders,e,r),h.encodeInitMessageHeaders=!0;const m=o.join("");L(Lt,`Creating RPC '${t}' stream ${s}: ${m}`,h);const E=a.createWebChannel(m,h);let v=!1,S=!1;const P=new tm({Io:C=>{S?L(Lt,`Not sending because RPC '${t}' stream ${s} is closed:`,C):(v||(L(Lt,`Opening RPC '${t}' stream ${s} transport.`),E.open(),v=!0),L(Lt,`RPC '${t}' stream ${s} sending:`,C),E.send(C))},To:()=>E.close()}),k=(C,R,O)=>{C.listen(R,F=>{try{O(F)}catch(z){setTimeout(()=>{throw z},0)}})};return k(E,xn.EventType.OPEN,()=>{S||(L(Lt,`RPC '${t}' stream ${s} transport opened.`),P.yo())}),k(E,xn.EventType.CLOSE,()=>{S||(S=!0,L(Lt,`RPC '${t}' stream ${s} transport closed`),P.So())}),k(E,xn.EventType.ERROR,C=>{S||(S=!0,nn(Lt,`RPC '${t}' stream ${s} transport errored:`,C),P.So(new M(D.UNAVAILABLE,"The operation could not be completed")))}),k(E,xn.EventType.MESSAGE,C=>{var R;if(!S){const O=C.data[0];it(!!O);const F=O,z=F.error||((R=F[0])===null||R===void 0?void 0:R.error);if(z){L(Lt,`RPC '${t}' stream ${s} received error:`,z);const Q=z.status;let U=function(y){const T=Tt[y];if(T!==void 0)return Hl(T)}(Q),I=z.message;U===void 0&&(U=D.INTERNAL,I="Unknown error status: "+Q+" with message "+z.message),S=!0,P.So(new M(U,I)),E.close()}else L(Lt,`RPC '${t}' stream ${s} received:`,O),P.bo(O)}}),k(c,_l.STAT_EVENT,C=>{C.stat===ti.PROXY?L(Lt,`RPC '${t}' stream ${s} detected buffering proxy`):C.stat===ti.NOPROXY&&L(Lt,`RPC '${t}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{P.wo()},0),P}}function Bs(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`+h,s.selectionStart=a+2,s.selectionEnd=a+2}else if(e.key.length===1){const c=s.value.substring(0,a+1),h=s.value.substring(a+1);s.value=c+e.key+h,s.selectionStart=a+2,s.selectionEnd=a+2}return}}}),n.addEventListener("paste",e=>{const r=t.value;if(!r||r==="Other")return;const o=e.target.selectionStart,a=r.length;if(o<=a){e.preventDefault();return}}))}async function Pp(){const n=document.getElementById("entry-type").value,t=document.getElementById("submit-status");try{let e=null;const r=new Date;if(n==="bottle-breast-milk"||n==="bottle-formula"){const s=document.getElementById("bottle-time"),o=s.value,a=parseFloat(document.getElementById("bottle-amount").value),c=document.getElementById("bottle-unit").value,h=document.getElementById("bottle-notes").value;if(!o)throw new Error("Start time is required");const d=ut(s.value);if(d>r)throw new Error("Cannot add entries in the future");if(isNaN(a)||a<=0)throw new Error("Amount must be greater than 0");if(n==="bottle-formula"&&!document.getElementById("bottle-type").value)throw new Error("Formula type is required");const m=n==="bottle-formula"?document.getElementById("bottle-type").value:void 0;e={type:"Feed",subType:n==="bottle-breast-milk"?"Breast Milk":"Formula",startTime:d,amount:a,unit:c,formulaType:m,notes:h}}else if(n==="diaper"){const s=document.getElementById("diaper-time"),o=s.value,a=document.getElementById("diaper-type").value,c=document.getElementById("diaper-notes").value;if(!o)throw new Error("Start time is required");const h=ut(s.value);if(h>r)throw new Error("Cannot add entries in the future");if(!a)throw new Error("Diaper type is required");e={type:"Diaper",diaperType:a,startTime:h,notes:c}}else if(n==="solids"){const s=document.getElementById("solids-start-time"),o=document.getElementById("solids-notes").value;if(!s.value)throw new Error("Start time is required");const a=ut(s.value);if(a>r)throw new Error("Cannot add entries in the future");e={type:"Solids",startTime:a,notes:o}}else if(n==="sleep"){const s=document.getElementById("sleep-start-time"),o=document.getElementById("sleep-end-time"),a=document.getElementById("sleep-notes").value;if(!s.value)throw new Error("Start time is required");const c=ut(s.value);if(c>r)throw new Error("Cannot add entries in the future");const h=vt(_t(ct,"entries"),Y("type","==","Sleep"),It("startTime","desc"),_n(1)),d=await At(h);if(!d.empty&&!d.docs[0].data().endTime)throw new Error("A sleep entry is already ongoing. End that entry before adding a new one.");let m;if(o.value){if(m=ut(o.value),m>r)throw new Error("End time cannot be in the future");if(m<=c)throw new Error("End time must be after start time")}e={type:"Sleep",startTime:c,endTime:m,notes:a}}e&&(await up(_t(ct,"entries"),{...e,startTime:j.fromDate(e.startTime),endTime:e.endTime?j.fromDate(e.endTime):null}),t.className="success",t.textContent="Entry added successfully!",t.style.display="block",Cp(),e.type==="Feed"?await zc():e.type==="Diaper"?await Hc():e.type==="Sleep"&&(await Yc(),await Jc()),je(),setTimeout(()=>{t.style.display="none"},3e3))}catch(e){t.className="error",t.textContent=e instanceof Error?e.message:"Failed to add entry",t.style.display="block"}}function Cp(){document.getElementById("entry-type").value="",document.getElementById("bottle-amount").value="",document.getElementById("bottle-type").value="",document.getElementById("bottle-notes").value="",document.getElementById("diaper-notes").value="",document.getElementById("solids-notes").value="",document.getElementById("sleep-end-time").value="",document.getElementById("sleep-notes").value="",document.getElementById("bottle-fields").style.display="none",document.getElementById("bottle-type-container").style.display="none",document.getElementById("diaper-fields").style.display="none",document.getElementById("solids-fields").style.display="none",document.getElementById("sleep-fields").style.display="none",document.getElementById("submit-entry").style.display="none",ls()}function Mn(n){const t=document.getElementById("start-date-filter"),e=document.getElementById("end-date-filter"),r=Xt();if(r.setHours(0,0,0,0),n==="all-time"){const s=new Date(2025,10,5);t.value=jt(s),e.value=jt(r)}else if(n==="today")t.value=jt(r),e.value=jt(r);else if(n==="yesterday"){const s=new Date(r);s.setDate(s.getDate()-1),t.value=jt(s),e.value=jt(s)}else if(n==="two-days-ago"){const s=new Date(r);s.setDate(s.getDate()-2),t.value=jt(s),e.value=jt(s)}else if(n==="three-days-ago"){const s=new Date(r);s.setDate(s.getDate()-3),t.value=jt(s),e.value=jt(s)}Ee()}async function Ee(){const n=++Qe,t=document.getElementById("timeline-list"),e=document.getElementById("timeline-loading"),r=document.getElementById("start-date-filter").value,s=document.getElementById("end-date-filter").value,o=document.getElementById("type-filter").value;e.style.display="block",t.innerHTML="";const a=document.querySelector(".filter-summary");a&&a.remove();try{let c=vt(_t(ct,"entries"),It("startTime","desc"));if(r&&s){const S=ut(`${r}T00:00`),P=ut(`${s}T23:59`);P.setSeconds(59,999),c=vt(_t(ct,"entries"),Y("startTime",">=",j.fromDate(S)),Y("startTime","<=",j.fromDate(P)),It("startTime","desc"))}const h=await At(c);if(n!==Qe)return;let d=[];if(r){const[S,P,k]=r.split("-").map(Number),C=new Date(S,P-1,k-1),R=`${C.getFullYear()}-${String(C.getMonth()+1).padStart(2,"0")}-${String(C.getDate()).padStart(2,"0")}`,O=ut(`${R}T19:00`),F=ut(`${r}T00:00`),z=vt(_t(ct,"entries"),Y("type","==","Sleep"),Y("startTime",">=",j.fromDate(O)),Y("startTime","<",j.fromDate(F)),It("startTime","desc"));try{(await At(z)).forEach(U=>{d.push({id:U.id,data:U.data()})})}catch(Q){console.error("Error fetching prior evening sleep:",Q)}}if(n!==Qe)return;const m=[],E=new Set;h.forEach(S=>{m.push({id:S.id,data:S.data()}),E.add(S.id)}),d.forEach(S=>{E.has(S.id)||(m.push(S),E.add(S.id))}),m.sort((S,P)=>P.data.startTime.toDate().getTime()-S.data.startTime.toDate().getTime());const v={bottles:{total:0,breastMilk:0,formula:0,sessions:0},diapers:{total:0,pee:0,poo:0,mixed:0},sleep:{totalMs:0,sessions:0},solids:{sessions:0}};if(m.length===0)t.innerHTML="<p>No entries found.</p>";else{let S="",P=!1;m.forEach(({id:C,data:R})=>{if(o!=="all"){let w="";if(R.type==="Feed"&&R.subType==="Breast Milk"?w="bottle-breast-milk":R.type==="Feed"&&R.subType==="Formula"?w="bottle-formula":R.type==="Diaper"?w="diaper-all":R.type==="Pump"?w="pump":R.type==="Sleep"?w="sleep":R.type==="Solids"&&(w="solids"),o==="bottle-all"){if(R.type!=="Feed")return}else if(o==="diaper-all"){if(R.type!=="Diaper")return}else if(o==="diaper-pee"){if(R.type!=="Diaper"||R.diaperType!=="Pee"&&R.diaperType!=="Mixed")return}else if(o==="diaper-poo"){if(R.type!=="Diaper"||R.diaperType!=="Poo"&&R.diaperType!=="Mixed")return}else if(w!==o)return}if(R.type==="Feed"){const w=en(R.amount,R.unit);v.bottles.total+=w,v.bottles.sessions++,R.subType==="Breast Milk"?v.bottles.breastMilk+=w:R.subType==="Formula"&&(v.bottles.formula+=w)}else R.type==="Diaper"?(v.diapers.total++,R.diaperType==="Pee"?v.diapers.pee++:R.diaperType==="Poo"?v.diapers.poo++:R.diaperType==="Mixed"&&v.diapers.mixed++):R.type==="Sleep"?v.sleep.sessions++:R.type==="Solids"&&v.solids.sessions++;P=!0;const O=R.startTime.toDate(),F=yi(O);if(F!==S){S=F;const w=document.createElement("div");w.className="timeline-date-header",w.textContent=F,t.appendChild(w)}const z=document.createElement("div");z.className="timeline-entry";let Q=R.type,U="",I="";if(R.type==="Feed")Q=`Bottle - ${R.subType}`,U=`<div class="timeline-entry-details">Amount: ${ye(R.amount,R.unit)}</div>`,I="#d9ebf2";else if(R.type==="Breast Feed")Q="Breast Feed",U="",I="#d9ebf2";else if(R.type==="Diaper")U=`<div class="timeline-entry-details">Type: ${R.diaperType}</div>`,I="#fce2d4";else if(R.type==="Pump")U=`<div class="timeline-entry-details">Amount: ${ye(R.amount,R.unit)}</div>`,I="#e2daf2";else if(R.type==="Solids")Q="Solids",I="#f5e6d0";else if(R.type==="Sleep")if(Q="Sleep",I="#d4e8d4",R.endTime){const w=R.startTime.toDate(),p=R.endTime.toDate(),$=p.getTime()-w.getTime(),rt=Math.floor($/(1e3*60*60)),B=Math.floor($%(1e3*60*60)/(1e3*60));U=`<div class="timeline-entry-details">Duration: ${rt}h ${B}m</div>`,U+=`<div class="timeline-entry-details">End: ${gi(p)}</div>`}else U='<div class="timeline-entry-details">In progress</div>';z.style.backgroundColor=I;const g=R.notes?`<div class="timeline-entry-notes">${R.notes.replace(/\n/g,"<br>")}</div>`:"";let y="";if(R.type==="Diaper"&&(R.diaperType==="Poo"||R.diaperType==="Mixed")){const w=O.getTime(),p=[];m.forEach(rt=>{const B=rt.data;B.type==="Diaper"&&(B.diaperType==="Poo"||B.diaperType==="Mixed")&&p.push({time:B.startTime.toDate().getTime()})}),p.sort((rt,B)=>B.time-rt.time);const $=p.findIndex(rt=>rt.time===w);if($>=0&&$<p.length-1){const rt=p[$+1].time;y=`<div class="timeline-entry-details" style="color: #666; font-style: italic;">${((w-rt)/(1e3*60*60)).toFixed(1)} hours since previous poo</div>`}else $>=0&&$===p.length-1&&(z.dataset.needsPriorPoo="true",z.dataset.pooTime=String(w))}z.innerHTML=`
                ...
                `;const T=z.querySelector(".edit-button"),_=z.querySelector(".delete-button");T.addEventListener("click",()=>Bp(C,R)),_.addEventListener("click",()=>Fp(C)),t.appendChild(z)});const k=t.querySelectorAll('[data-needs-prior-poo="true"]');for(const C of Array.from(k)){const R=parseInt(C.dataset.pooTime||"0",10);if(R>0)try{const O=vt(_t(ct,"entries"),Y("type","==","Diaper"),Y("startTime","<",j.fromDate(new Date(R))),It("startTime","desc")),F=await At(O);let z=null;if(F.forEach(Q=>{if(z!==null)return;const U=Q.data();(U.diaperType==="Poo"||U.diaperType==="Mixed")&&(z=U.startTime.toDate().getTime())}),z!==null){const Q=(R-z)/36e5,U=document.createElement("div");U.className="timeline-entry-details",U.style.color="#666",U.style.fontStyle="italic",U.textContent=`${Q.toFixed(1)} hours since previous poo`;const I=C.querySelector(".timeline-entry-actions");I?C.insertBefore(U,I):C.appendChild(U)}}catch(O){console.error("Error fetching prior poo entry:",O)}C.removeAttribute("data-needs-prior-poo"),C.removeAttribute("data-poo-time")}if(!P)t.innerHTML="<p>No entries match the selected filters.</p>";else{const C=document.createElement("div");C.className="filter-summary";let R='<div class="summary-header">Summary</div><div class="summary-stats">',O=!1;if(o==="all"||o==="bottle-breast-milk"||o==="bottle-formula"||o==="bottle-all"||o==="solids"){const F=v.bottles.sessions+v.solids.sessions,z=o!=="solids",Q=o==="all"||o==="solids";R+=`
                    ...
                    `,O=!0}if(o==="all"||o==="sleep"){let F=0;if(r&&s){const U=[];m.forEach(lt=>{const ot=lt.data;ot.type==="Sleep"&&U.push({startTime:ot.startTime.toDate(),endTime:ot.endTime?ot.endTime.toDate():null})});const[I,g,y]=r.split("-").map(Number),T=new Date(I,g-1,y);T.setDate(T.getDate()-1);const _=new Date(T);_.setHours(0,0,0,0);const w=new Date(T);w.setHours(23,59,59,999);try{const lt=vt(_t(ct,"entries"),Y("type","==","Sleep"),Y("startTime",">=",j.fromDate(_)),Y("startTime","<=",j.fromDate(w)),It("startTime","asc"));(await At(lt)).forEach(ne=>{const kt=ne.data();U.push({startTime:kt.startTime.toDate(),endTime:kt.endTime?kt.endTime.toDate():null})})}catch(lt){console.error("Error fetching prior sleep entries:",lt)}const[p,$,rt]=s.split("-").map(Number),B=new Date(p,$-1,rt);B.setDate(B.getDate()+1);const x=new Date(B);x.setHours(0,0,0,0);const ht=new Date(B);ht.setHours(23,59,59,999);try{const lt=vt(_t(ct,"entries"),Y("type","==","Sleep"),Y("startTime",">=",j.fromDate(x)),Y("startTime","<=",j.fromDate(ht)),It("startTime","asc"));(await At(lt)).forEach(ne=>{const kt=ne.data();U.push({startTime:kt.startTime.toDate(),endTime:kt.endTime?kt.endTime.toDate():null})})}catch(lt){console.error("Error fetching post sleep entries:",lt)}const pt=new Date(I,g-1,y),st=new Date(p,$-1,rt),Ut=new Date(pt);for(;Ut<=st;){const lt=so(Ut);F+=ro(U,lt.start,lt.end),Ut.setDate(Ut.getDate()+1)}}const z=Math.floor(F/(1e3*60*60)),Q=Math.floor(F%(1e3*60*60)/(1e3*60));R+=`
                        <div class="stat-group">
                    ...
                    `,O=!0}if(R+="</div>",n===Qe&&O){C.innerHTML=R;const F=document.querySelector(".filter-section");F&&F.parentNode&&F.parentNode.insertBefore(C,t)}}}}catch{n===Qe&&(t.innerHTML='<p class="error">Failed to load timeline</p>')}finally{n===Qe&&(e.style.display="none")}}function ro(n,t,e){let r=0;for(const s of n){if(!s.endTime)continue;const o=Math.max(s.startTime.getTime(),t.getTime()),a=Math.min(s.endTime.getTime(),e.getTime());a>o&&(r+=a-o)}return r}function so(n){const t=new Date(n);t.setHours(0,0,0,0);const e=new Date(t);e.setDate(e.getDate()-1);const r=ut(`${el(e)}T19:00`),s=new Date(t);s.setDate(s.getDate()+1);const o=ut(`${el(s)}T07:00`);return{start:r,end:o}}function Vp(n){const t=Math.floor(n/36e5),e=Math.floor(n%(1e3*60*60)/(1e3*60));return`${t}h ${e}m`}async function je(){const n=++Ne,t=document.getElementById("weekly-stats"),e=document.getElementById("weekly-loading"),r=document.getElementById("week-range"),s=document.getElementById("prev-week"),o=document.getElementById("next-week"),a=document.getElementById("current-week"),c=new Date(2025,10,5),h=un(c),d=Xt(),m=un(d),E=new Date(Qt);E.setHours(0,0,0,0),E<h&&(Qt=new Date(h)),E.getTime()<=h.getTime()?s.disabled=!0:s.disabled=!1,E.getTime()>=m.getTime()?o.disabled=!0:o.disabled=!1,a&&(E.getTime()===m.getTime()?(a.disabled=!0,a.style.backgroundColor="#999",a.style.color="#ccc",a.style.cursor="default"):(a.disabled=!1,a.style.backgroundColor="",a.style.color="",a.style.cursor="pointer"));const v=_p(Qt);r.textContent=`${yi(Qt).split(",")[1].trim()} - ${yi(v).split(",")[1].trim()}`,e.style.display="block",t.innerHTML="";try{const S=vt(_t(ct,"entries"),Y("startTime",">=",j.fromDate(Qt)),Y("startTime","<=",j.fromDate(v)),It("startTime","asc")),P=await At(S);if(n!==Ne)return;const k=new Date("2025-11-11");k.setHours(0,0,0,0);const C={},R=[];for(let B=0;B<7;B++){const x=new Date(Qt);if(x.setDate(x.getDate()+B),x.setHours(0,0,0,0),x>=k){const ht=`${x.getFullYear()}-${String(x.getMonth()+1).padStart(2,"0")}-${String(x.getDate()).padStart(2,"0")}`;R.push(ht)}}if(R.length>0){const B=await Promise.all(R.map(x=>Lc(yn(ct,"vitaminD",x))));R.forEach((x,ht)=>{var st;const pt=B[ht];C[x]=pt.exists()&&((st=pt.data())==null?void 0:st.given)===!0})}if(n!==Ne)return;const O=[];P.forEach(B=>{const x=B.data();x.type==="Sleep"&&O.push({startTime:x.startTime.toDate(),endTime:x.endTime?x.endTime.toDate():null})});const F=new Date(Qt);F.setDate(F.getDate()-1),F.setHours(0,0,0,0);const z=new Date(Qt);z.setHours(0,0,0,0);const Q=vt(_t(ct,"entries"),Y("type","==","Sleep"),Y("startTime",">=",j.fromDate(F)),Y("startTime","<",j.fromDate(z)),It("startTime","asc")),U=await At(Q);if(n!==Ne)return;U.forEach(B=>{const x=B.data();O.push({startTime:x.startTime.toDate(),endTime:x.endTime?x.endTime.toDate():null})});const I=new Date(v);I.setDate(I.getDate()+1),I.setHours(0,0,0,0);const g=new Date(I);g.setDate(g.getDate()+1),g.setHours(0,0,0,0);const y=vt(_t(ct,"entries"),Y("type","==","Sleep"),Y("startTime",">=",j.fromDate(I)),Y("startTime","<",j.fromDate(g)),It("startTime","asc")),T=await At(y);if(n!==Ne)return;T.forEach(B=>{const x=B.data();O.push({startTime:x.startTime.toDate(),endTime:x.endTime?x.endTime.toDate():null})});const _={};for(let B=0;B<7;B++){const x=new Date(Qt);x.setDate(x.getDate()+B),x.setHours(0,0,0,0);const ht=`${x.getFullYear()}-${x.getMonth()}-${x.getDate()}`,pt=`${x.getFullYear()}-${String(x.getMonth()+1).padStart(2,"0")}-${String(x.getDate()).padStart(2,"0")}`,st=so(x);_[ht]={date:new Date(x),vitaminD:x>=k?C[pt]===!0:null,bottles:{total:0,breastMilk:0,formula:0,sessions:0},diapers:{total:0,pee:0,poo:0,mixed:0},solids:{sessions:0},sleepMs:ro(O,st.start,st.end)}}P.forEach(B=>{const x=B.data(),ht=x.startTime.toDate(),pt=Rt(ht);pt.setHours(0,0,0,0);const st=`${pt.getFullYear()}-${pt.getMonth()}-${pt.getDate()}`;if(_[st])if(x.type==="Feed"){const Ut=en(x.amount,x.unit);_[st].bottles.total+=Ut,_[st].bottles.sessions++,x.subType==="Breast Milk"?_[st].bottles.breastMilk+=Ut:x.subType==="Formula"&&(_[st].bottles.formula+=Ut)}else x.type==="Breast Feed"?_[st].bottles.sessions++:x.type==="Diaper"?(_[st].diapers.total++,x.diaperType==="Pee"?_[st].diapers.pee++:x.diaperType==="Poo"?_[st].diapers.poo++:x.diaperType==="Mixed"&&_[st].diapers.mixed++):x.type==="Solids"&&_[st].solids.sessions++});const w=Object.keys(_).map(B=>_[B]).sort((B,x)=>B.date.getTime()-x.date.getTime()),p=document.createElement("div");p.className="weekly-scroll-container";const $=Xt();$.setHours(0,0,0,0);let rt=-1;w.forEach((B,x)=>{const ht=document.createElement("div");ht.className="day-stats";const pt=new Date(B.date);pt.setHours(0,0,0,0),$.getTime()===pt.getTime()&&(ht.classList.add("current-day"),rt=x);const st=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"][B.date.getDay()],Ut=`${B.date.getMonth()+1}/${B.date.getDate()}`,lt=B.diapers.pee+B.diapers.mixed,ot=B.diapers.poo+B.diapers.mixed;let ne="";if(B.vitaminD!==null){const kt=B.vitaminD?"Yes":"No";ne=`
                    <div class="stat-group">
