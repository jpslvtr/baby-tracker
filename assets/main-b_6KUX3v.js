...
*/var Be,pl;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function t(v,g){function y(){}y.prototype=g.prototype,v.D=g.prototype,v.prototype=new y,v.prototype.constructor=v,v.C=function(T,_,w){for(var p=Array(arguments.length-2),$=2;$<arguments.length;$++)p[$-2]=arguments[$];return g.prototype[_].apply(T,p)}}function e(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}t(r,e),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(v,g,y){y||(y=0);var T=Array(16);if(typeof g=="string")for(var _=0;16>_;++_)T[_]=g.charCodeAt(y++)|g.charCodeAt(y++)<<8|g.charCodeAt(y++)<<16|g.charCodeAt(y++)<<24;else for(_=0;16>_;++_)T[_]=g[y++]|g[y++]<<8|g[y++]<<16|g[y++]<<24;g=v.g[0],y=v.g[1],_=v.g[2];var w=v.g[3],p=g+(w^y&(_^w))+T[0]+3614090360&4294967295;g=y+(p<<7&4294967295|p>>>25),p=w+(_^g&(y^_))+T[1]+3905402710&4294967295,w=g+(p<<12&4294967295|p>>>20),p=_+(y^w&(g^y))+T[2]+606105819&4294967295,_=w+(p<<17&4294967295|p>>>15),p=y+(g^_&(w^g))+T[3]+3250441966&4294967295,y=_+(p<<22&4294967295|p>>>10),p=g+(w^y&(_^w))+T[4]+4118548399&4294967295,g=y+(p<<7&4294967295|p>>>25),p=w+(_^g&(y^_))+T[5]+1200080426&4294967295,w=g+(p<<12&4294967295|p>>>20),p=_+(y^w&(g^y))+T[6]+2821735955&4294967295,_=w+(p<<17&4294967295|p>>>15),p=y+(g^_&(w^g))+T[7]+4249261313&4294967295,y=_+(p<<22&4294967295|p>>>10),p=g+(w^y&(_^w))+T[8]+1770035416&4294967295,g=y+(p<<7&4294967295|p>>>25),p=w+(_^g&(y^_))+T[9]+2336552879&4294967295,w=g+(p<<12&4294967295|p>>>20),p=_+(y^w&(g^y))+T[10]+4294925233&4294967295,_=w+(p<<17&4294967295|p>>>15),p=y+(g^_&(w^g))+T[11]+2304563134&4294967295,y=_+(p<<22&4294967295|p>>>10),p=g+(w^y&(_^w))+T[12]+1804603682&4294967295,g=y+(p<<7&4294967295|p>>>25),p=w+(_^g&(y^_))+T[13]+4254626195&4294967295,w=g+(p<<12&4294967295|p>>>20),p=_+(y^w&(g^y))+T[14]+2792965006&4294967295,_=w+(p<<17&4294967295|p>>>15),p=y+(g^_&(w^g))+T[15]+1236535329&4294967295,y=_+(p<<22&4294967295|p>>>10),p=g+(_^w&(y^_))+T[1]+4129170786&4294967295,g=y+(p<<5&4294967295|p>>>27),p=w+(y^_&(g^y))+T[6]+3225465664&4294967295,w=g+(p<<9&4294967295|p>>>23),p=_+(g^y&(w^g))+T[11]+643717713&4294967295,_=w+(p<<14&4294967295|p>>>18),p=y+(w^g&(_^w))+T[0]+3921069994&4294967295,y=_+(p<<20&4294967295|p>>>12),p=g+(_^w&(y^_))+T[5]+3593408605&4294967295,g=y+(p<<5&4294967295|p>>>27),p=w+(y^_&(g^y))+T[10]+38016083&4294967295,w=g+(p<<9&4294967295|p>>>23),p=_+(g^y&(w^g))+T[15]+3634488961&4294967295,_=w+(p<<14&4294967295|p>>>18),p=y+(w^g&(_^w))+T[4]+3889429448&4294967295,y=_+(p<<20&4294967295|p>>>12),p=g+(_^w&(y^_))+T[9]+568446438&4294967295,g=y+(p<<5&4294967295|p>>>27),p=w+(y^_&(g^y))+T[14]+3275163606&4294967295,w=g+(p<<9&4294967295|p>>>23),p=_+(g^y&(w^g))+T[3]+4107603335&4294967295,_=w+(p<<14&4294967295|p>>>18),p=y+(w^g&(_^w))+T[8]+1163531501&4294967295,y=_+(p<<20&4294967295|p>>>12),p=g+(_^w&(y^_))+T[13]+2850285829&4294967295,g=y+(p<<5&4294967295|p>>>27),p=w+(y^_&(g^y))+T[2]+4243563512&4294967295,w=g+(p<<9&4294967295|p>>>23),p=_+(g^y&(w^g))+T[7]+1735328473&4294967295,_=w+(p<<14&4294967295|p>>>18),p=y+(w^g&(_^w))+T[12]+2368359562&4294967295,y=_+(p<<20&4294967295|p>>>12),p=g+(y^_^w)+T[5]+4294588738&4294967295,g=y+(p<<4&4294967295|p>>>28),p=w+(g^y^_)+T[8]+2272392833&4294967295,w=g+(p<<11&4294967295|p>>>21),p=_+(w^g^y)+T[11]+1839030562&4294967295,_=w+(p<<16&4294967295|p>>>16),p=y+(_^w^g)+T[14]+4259657740&4294967295,y=_+(p<<23&4294967295|p>>>9),p=g+(y^_^w)+T[1]+2763975236&4294967295,g=y+(p<<4&4294967295|p>>>28),p=w+(g^y^_)+T[4]+1272893353&4294967295,w=g+(p<<11&4294967295|p>>>21),p=_+(w^g^y)+T[7]+4139469664&4294967295,_=w+(p<<16&4294967295|p>>>16),p=y+(_^w^g)+T[10]+3200236656&4294967295,y=_+(p<<23&4294967295|p>>>9),p=g+(y^_^w)+T[13]+681279174&4294967295,g=y+(p<<4&4294967295|p>>>28),p=w+(g^y^_)+T[0]+3936430074&4294967295,w=g+(p<<11&4294967295|p>>>21),p=_+(w^g^y)+T[3]+3572445317&4294967295,_=w+(p<<16&4294967295|p>>>16),p=y+(_^w^g)+T[6]+76029189&4294967295,y=_+(p<<23&4294967295|p>>>9),p=g+(y^_^w)+T[9]+3654602809&4294967295,g=y+(p<<4&4294967295|p>>>28),p=w+(g^y^_)+T[12]+3873151461&4294967295,w=g+(p<<11&4294967295|p>>>21),p=_+(w^g^y)+T[15]+530742520&4294967295,_=w+(p<<16&4294967295|p>>>16),p=y+(_^w^g)+T[2]+3299628645&4294967295,y=_+(p<<23&4294967295|p>>>9),p=g+(_^(y|~w))+T[0]+4096336452&4294967295,g=y+(p<<6&4294967295|p>>>26),p=w+(y^(g|~_))+T[7]+1126891415&4294967295,w=g+(p<<10&4294967295|p>>>22),p=_+(g^(w|~y))+T[14]+2878612391&4294967295,_=w+(p<<15&4294967295|p>>>17),p=y+(w^(_|~g))+T[5]+4237533241&4294967295,y=_+(p<<21&4294967295|p>>>11),p=g+(_^(y|~w))+T[12]+1700485571&4294967295,g=y+(p<<6&4294967295|p>>>26),p=w+(y^(g|~_))+T[3]+2399980690&4294967295,w=g+(p<<10&4294967295|p>>>22),p=_+(g^(w|~y))+T[10]+4293915773&4294967295,_=w+(p<<15&4294967295|p>>>17),p=y+(w^(_|~g))+T[1]+2240044497&4294967295,y=_+(p<<21&4294967295|p>>>11),p=g+(_^(y|~w))+T[8]+1873313359&4294967295,g=y+(p<<6&4294967295|p>>>26),p=w+(y^(g|~_))+T[15]+4264355552&4294967295,w=g+(p<<10&4294967295|p>>>22),p=_+(g^(w|~y))+T[6]+2734768916&4294967295,_=w+(p<<15&4294967295|p>>>17),p=y+(w^(_|~g))+T[13]+1309151649&4294967295,y=_+(p<<21&4294967295|p>>>11),p=g+(_^(y|~w))+T[4]+4149444226&4294967295,g=y+(p<<6&4294967295|p>>>26),p=w+(y^(g|~_))+T[11]+3174756917&4294967295,w=g+(p<<10&4294967295|p>>>22),p=_+(g^(w|~y))+T[2]+718787259&4294967295,_=w+(p<<15&4294967295|p>>>17),p=y+(w^(_|~g))+T[9]+3951481745&4294967295,v.g[0]=v.g[0]+g&4294967295,v.g[1]=v.g[1]+(_+(p<<21&4294967295|p>>>11))&4294967295,v.g[2]=v.g[2]+_&4294967295,v.g[3]=v.g[3]+w&4294967295}r.prototype.u=function(v,g){g===void 0&&(g=v.length);for(var y=g-this.blockSize,T=this.B,_=this.h,w=0;w<g;){if(_==0)for(;w<=y;)s(this,v,w),w+=this.blockSize;if(typeof v=="string"){for(;w<g;)if(T[_++]=v.charCodeAt(w++),_==this.blockSize){s(this,T),_=0;break}}else for(;w<g;)if(T[_++]=v[w++],_==this.blockSize){s(this,T),_=0;break}}this.h=_,this.o+=g},r.prototype.v=function(){var v=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);v[0]=128;for(var g=1;g<v.length-8;++g)v[g]=0;var y=8*this.o;for(g=v.length-8;g<v.length;++g)v[g]=y&255,y/=256;for(this.u(v),v=Array(16),g=y=0;4>g;++g)for(var T=0;32>T;T+=8)v[y++]=this.g[g]>>>T&255;return v};function o(v,g){var y=c;return Object.prototype.hasOwnProperty.call(y,v)?y[v]:y[v]=g(v)}function a(v,g){this.h=g;for(var y=[],T=!0,_=v.length-1;0<=_;_--){var w=v[_]|0;T&&w==g||(y[_]=w,T=!1)}this.g=y}var c={};function h(v){return-128<=v&&128>v?o(v,function(g){return new a([g|0],0>g?-1:0)}):new a([v|0],0>v?-1:0)}function d(v){if(isNaN(v)||!isFinite(v))return E;if(0>v)return C(d(-v));for(var g=[],y=1,T=0;v>=y;T++)g[T]=v/y|0,y*=4294967296;return new a(g,0)}function m(v,g){if(v.length==0)throw Error("number format error: empty string");if(g=g||10,2>g||36<g)throw Error("radix out of range: "+g);if(v.charAt(0)=="-")return C(m(v.substring(1),g));if(0<=v.indexOf("-"))throw Error('number format error: interior "-" character');for(var y=d(Math.pow(g,8)),T=E,_=0;_<v.length;_+=8){var w=Math.min(8,v.length-_),p=parseInt(v.substring(_,_+w),g);8>w?(w=d(Math.pow(g,w)),T=T.j(w).add(d(p))):(T=T.j(y),T=T.add(d(p)))}return T}var E=h(0),I=h(1),S=h(16777216);n=a.prototype,n.m=function(){if(k(this))return-C(this).m();for(var v=0,g=1,y=0;y<this.g.length;y++){var T=this.i(y);v+=(0<=T?T:4294967296+T)*g,g*=4294967296}return v},n.toString=function(v){if(v=v||10,2>v||36<v)throw Error("radix out of range: "+v);if(P(this))return"0";if(k(this))return"-"+C(this).toString(v);for(var g=d(Math.pow(v,6)),y=this,T="";;){var _=z(y,g).g;y=R(y,_.j(g));var w=((0<y.g.length?y.g[0]:y.h)>>>0).toString(v);if(y=_,P(y))return w+T;for(;6>w.length;)w="0"+w;T=w+T}},n.i=function(v){return 0>v?0:v<this.g.length?this.g[v]:this.h};function P(v){if(v.h!=0)return!1;for(var g=0;g<v.g.length;g++)if(v.g[g]!=0)return!1;return!0}function k(v){return v.h==-1}n.l=function(v){return v=R(this,v),k(v)?-1:P(v)?0:1};function C(v){for(var g=v.g.length,y=[],T=0;T<g;T++)y[T]=~v.g[T];return new a(y,~v.h).add(I)}n.abs=function(){return k(this)?C(this):this},n.add=function(v){for(var g=Math.max(this.g.length,v.g.length),y=[],T=0,_=0;_<=g;_++){var w=T+(this.i(_)&65535)+(v.i(_)&65535),p=(w>>>16)+(this.i(_)>>>16)+(v.i(_)>>>16);T=p>>>16,w&=65535,p&=65535,y[_]=p<<16|w}return new a(y,y[y.length-1]&-2147483648?-1:0)};function R(v,g){return v.add(C(g))}n.j=function(v){if(P(this)||P(v))return E;if(k(this))return k(v)?C(this).j(C(v)):C(C(this).j(v));if(k(v))return C(this.j(C(v)));if(0>this.l(S)&&0>v.l(S))return d(this.m()*v.m());for(var g=this.g.length+v.g.length,y=[],T=0;T<2*g;T++)y[T]=0;for(T=0;T<this.g.length;T++)for(var _=0;_<v.g.length;_++){var w=this.i(T)>>>16,p=this.i(T)&65535,$=v.i(_)>>>16,rt=v.i(_)&65535;y[2*T+2*_]+=p*rt,O(y,2*T+2*_),y[2*T+2*_+1]+=w*rt,O(y,2*T+2*_+1),y[2*T+2*_+1]+=p*$,O(y,2*T+2*_+1),y[2*T+2*_+2]+=w*$,O(y,2*T+2*_+2)}for(T=0;T<g;T++)y[T]=y[2*T+1]<<16|y[2*T];for(T=g;T<2*g;T++)y[T]=0;return new a(y,0)};function O(v,g){for(;(v[g]&65535)!=v[g];)v[g+1]+=v[g]>>>16,v[g]&=65535,g++}function F(v,g){this.g=v,this.h=g}function z(v,g){if(P(g))throw Error("division by zero");if(P(v))return new F(E,E);if(k(v))return g=z(C(v),g),new F(C(g.g),C(g.h));if(k(g))return g=z(v,C(g)),new F(C(g.g),g.h);if(30<v.g.length){if(k(v)||k(g))throw Error("slowDivide_ only works with positive integers.");for(var y=I,T=g;0>=T.l(v);)y=Q(y),T=Q(T);var _=U(y,1),w=U(T,1);for(T=U(T,2),y=U(y,2);!P(T);){var p=w.add(T);0>=p.l(v)&&(_=_.add(y),w=p),T=U(T,1),y=U(y,1)}return g=R(v,_.j(g)),new F(_,g)}for(_=E;0<=v.l(g);){for(y=Math.max(1,Math.floor(v.m()/g.m())),T=Math.ceil(Math.log(y)/Math.LN2),T=48>=T?1:Math.pow(2,T-48),w=d(y),p=w.j(g);k(p)||0<p.l(v);)y-=T,w=d(y),p=w.j(g);P(w)&&(w=I),_=_.add(w),v=R(v,p)}return new F(_,v)}n.A=function(v){return z(this,v).h},n.and=function(v){for(var g=Math.max(this.g.length,v.g.length),y=[],T=0;T<g;T++)y[T]=this.i(T)&v.i(T);return new a(y,this.h&v.h)},n.or=function(v){for(var g=Math.max(this.g.length,v.g.length),y=[],T=0;T<g;T++)y[T]=this.i(T)|v.i(T);return new a(y,this.h|v.h)},n.xor=function(v){for(var g=Math.max(this.g.length,v.g.length),y=[],T=0;T<g;T++)y[T]=this.i(T)^v.i(T);return new a(y,this.h^v.h)};function Q(v){for(var g=v.g.length+1,y=[],T=0;T<g;T++)y[T]=v.i(T)<<1|v.i(T-1)>>>31;return new a(y,v.h)}function U(v,g){var y=g>>5;g%=32;for(var T=v.g.length-y,_=[],w=0;w<T;w++)_[w]=0<g?v.i(w+y)>>>g|v.i(w+y+1)<<32-g:v.i(w+y);return new a(_,v.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,pl=r,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.A,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=d,a.fromString=m,Be=a}).apply(typeof pa<"u"?pa:typeof self<"u"?self:typeof window<"u"?window:{});var Ir=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vl{constructor(t,e){this.user=e,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${t}`)}}class ad{getToken(){return Promise.resolve(null)}invalidateToken(){}start(t,e){t.enqueueRetryable(()=>e(Ot.UNAUTHENTICATED))}shutdown(){}}class ld{constructor(t){this.token=t,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(t,e){this.changeListener=e,t.enqueueRetryable(()=>e(this.token.user))}shutdown(){this.changeListener=null}}class cd{constructor(t){this.t=t,this.currentUser=Ot.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(t,e){st(this.o===void 0);let r=this.i;const s=h=>this.i!==r?(r=this.i,e(h)):Promise.resolve();let o=new ce;this.o=()=>{this.i++,this.currentUser=this.u(),o.resolve(),o=new ce,t.enqueueRetryable(()=>s(this.currentUser))};const a=()=>{const h=o;t.enqueueRetryable(async()=>{await h.promise,await s(this.currentUser)})},c=h=>{L("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=h,this.o&&(this.auth.addAuthTokenListener(this.o),a())};this.t.onInit(h=>c(h)),setTimeout(()=>{if(!this.auth){const h=this.t.getImmediate({optional:!0});h?c(h):(L("FirebaseAuthCredentialsProvider","Auth not yet detected"),o.resolve(),o=new ce)}},0),a()}getToken(){const t=this.i,e=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(e).then(r=>this.i!==t?(L("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(st(typeof r.accessToken=="string"),new vl(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const t=this.auth&&this.auth.getUid();return st(t===null||typeof t=="string"),new Ot(t)}}class ud{constructor(t,e,r){this.l=t,this.h=e,this.P=r,this.type="FirstParty",this.user=Ot.FIRST_PARTY,this.I=new Map}T(){return this.P?this.P():null}get headers(){this.I.set("X-Goog-AuthUser",this.l);const t=this.T();return t&&this.I.set("Authorization",t),this.h&&this.I.set("X-Goog-Iam-Authorization-Token",this.h),this.I}}class hd{constructor(t,e,r){this.l=t,this.h=e,this.P=r}getToken(){return Promise.resolve(new ud(this.l,this.h,this.P))}start(t,e){t.enqueueRetryable(()=>e(Ot.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class dd{constructor(t){this.value=t,this.type="AppCheck",this.headers=new Map,t&&t.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class fd{constructor(t){this.A=t,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(t,e){st(this.o===void 0);const r=o=>{o.error!=null&&L("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${o.error.message}`);const a=o.token!==this.R;return this.R=o.token,L("FirebaseAppCheckTokenProvider",`Received ${a?"new":"existing"} token.`),a?e(o.token):Promise.resolve()};this.o=o=>{t.enqueueRetryable(()=>r(o))};const s=o=>{L("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=o,this.o&&this.appCheck.addTokenListener(this.o)};this.A.onInit(o=>s(o)),setTimeout(()=>{if(!this.appCheck){const o=this.A.getImmediate({optional:!0});o?s(o):L("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const t=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(t).then(e=>e?(st(typeof e.token=="string"),this.R=e.token,new dd(e.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`+h,s.selectionStart=a+2,s.selectionEnd=a+2}else if(e.key.length===1){const c=s.value.substring(0,a+1),h=s.value.substring(a+1);s.value=c+e.key+h,s.selectionStart=a+2,s.selectionEnd=a+2}return}}}),n.addEventListener("paste",e=>{const r=t.value;if(!r||r==="Other")return;const o=e.target.selectionStart,a=r.length;if(o<=a){e.preventDefault();return}}))}async function Pp(){const n=document.getElementById("entry-type").value,t=document.getElementById("submit-status");try{let e=null;const r=new Date;if(n==="bottle-breast-milk"||n==="bottle-formula"){const s=document.getElementById("bottle-time"),o=s.value,a=parseFloat(document.getElementById("bottle-amount").value),c=document.getElementById("bottle-unit").value,h=document.getElementById("bottle-notes").value;if(!o)throw new Error("Start time is required");const d=ut(s.value);if(d>r)throw new Error("Cannot add entries in the future");if(isNaN(a)||a<=0)throw new Error("Amount must be greater than 0");if(n==="bottle-formula"&&!document.getElementById("bottle-type").value)throw new Error("Formula type is required");const m=n==="bottle-formula"?document.getElementById("bottle-type").value:void 0;e={type:"Feed",subType:n==="bottle-breast-milk"?"Breast Milk":"Formula",startTime:d,amount:a,unit:c,formulaType:m,notes:h}}else if(n==="diaper"){const s=document.getElementById("diaper-time"),o=s.value,a=document.getElementById("diaper-type").value,c=document.getElementById("diaper-notes").value;if(!o)throw new Error("Start time is required");const h=ut(s.value);if(h>r)throw new Error("Cannot add entries in the future");if(!a)throw new Error("Diaper type is required");e={type:"Diaper",diaperType:a,startTime:h,notes:c}}else if(n==="solids"){const s=document.getElementById("solids-start-time"),o=document.getElementById("solids-notes").value;if(!s.value)throw new Error("Start time is required");const a=ut(s.value);if(a>r)throw new Error("Cannot add entries in the future");e={type:"Solids",startTime:a,notes:o}}else if(n==="sleep"){const s=document.getElementById("sleep-start-time"),o=document.getElementById("sleep-end-time"),a=document.getElementById("sleep-notes").value;if(!s.value)throw new Error("Start time is required");const c=ut(s.value);if(c>r)throw new Error("Cannot add entries in the future");const h=vt(_t(ct,"entries"),Y("type","==","Sleep"),It("startTime","desc"),_n(1)),d=await At(h);if(!d.empty&&!d.docs[0].data().endTime)throw new Error("A sleep entry is already ongoing. End that entry before adding a new one.");let m;if(o.value){if(m=ut(o.value),m>r)throw new Error("End time cannot be in the future");if(m<=c)throw new Error("End time must be after start time")}e={type:"Sleep",startTime:c,endTime:m,notes:a}}e&&(await up(_t(ct,"entries"),{...e,startTime:j.fromDate(e.startTime),endTime:e.endTime?j.fromDate(e.endTime):null}),t.className="success",t.textContent="Entry added successfully!",t.style.display="block",Cp(),e.type==="Feed"?await zc():e.type==="Diaper"?await Hc():e.type==="Sleep"&&(await Yc(),await Jc()),je(),setTimeout(()=>{t.style.display="none"},3e3))}catch(e){t.className="error",t.textContent=e instanceof Error?e.message:"Failed to add entry",t.style.display="block"}}function Cp(){document.getElementById("entry-type").value="",document.getElementById("bottle-amount").value="",document.getElementById("bottle-type").value="",document.getElementById("bottle-notes").value="",document.getElementById("diaper-notes").value="",document.getElementById("solids-notes").value="",document.getElementById("sleep-end-time").value="",document.getElementById("sleep-notes").value="",document.getElementById("bottle-fields").style.display="none",document.getElementById("bottle-type-container").style.display="none",document.getElementById("diaper-fields").style.display="none",document.getElementById("solids-fields").style.display="none",document.getElementById("sleep-fields").style.display="none",document.getElementById("submit-entry").style.display="none",ls()}function xn(n){const t=document.getElementById("start-date-filter"),e=document.getElementById("end-date-filter"),r=Xt();if(r.setHours(0,0,0,0),n==="all-time"){const s=new Date(2025,10,5);t.value=jt(s),e.value=jt(r)}else if(n==="today")t.value=jt(r),e.value=jt(r);else if(n==="yesterday"){const s=new Date(r);s.setDate(s.getDate()-1),t.value=jt(s),e.value=jt(s)}else if(n==="two-days-ago"){const s=new Date(r);s.setDate(s.getDate()-2),t.value=jt(s),e.value=jt(s)}else if(n==="three-days-ago"){const s=new Date(r);s.setDate(s.getDate()-3),t.value=jt(s),e.value=jt(s)}Ee()}async function Ee(){const n=++Qe,t=document.getElementById("timeline-list"),e=document.getElementById("timeline-loading"),r=document.getElementById("start-date-filter").value,s=document.getElementById("end-date-filter").value,o=document.getElementById("type-filter").value;e.style.display="block",t.innerHTML="";const a=document.querySelector(".filter-summary");a&&a.remove();try{let c=vt(_t(ct,"entries"),It("startTime","desc"));if(r&&s){const S=ut(`${r}T00:00`),P=ut(`${s}T23:59`);P.setSeconds(59,999),c=vt(_t(ct,"entries"),Y("startTime",">=",j.fromDate(S)),Y("startTime","<=",j.fromDate(P)),It("startTime","desc"))}const h=await At(c);if(n!==Qe)return;let d=[];if(r){const[S,P,k]=r.split("-").map(Number),C=new Date(S,P-1,k-1),R=`${C.getFullYear()}-${String(C.getMonth()+1).padStart(2,"0")}-${String(C.getDate()).padStart(2,"0")}`,O=ut(`${R}T19:00`),F=ut(`${r}T00:00`),z=vt(_t(ct,"entries"),Y("type","==","Sleep"),Y("startTime",">=",j.fromDate(O)),Y("startTime","<",j.fromDate(F)),It("startTime","desc"));try{(await At(z)).forEach(U=>{d.push({id:U.id,data:U.data()})})}catch(Q){console.error("Error fetching prior evening sleep:",Q)}}if(n!==Qe)return;const m=[],E=new Set;h.forEach(S=>{m.push({id:S.id,data:S.data()}),E.add(S.id)}),d.forEach(S=>{E.has(S.id)||(m.push(S),E.add(S.id))}),m.sort((S,P)=>P.data.startTime.toDate().getTime()-S.data.startTime.toDate().getTime());const I={bottles:{total:0,breastMilk:0,formula:0,sessions:0},diapers:{total:0,pee:0,poo:0,mixed:0},sleep:{totalMs:0,sessions:0}};if(m.length===0)t.innerHTML="<p>No entries found.</p>";else{let S="",P=!1;m.forEach(({id:C,data:R})=>{if(o!=="all"){let w="";if(R.type==="Feed"&&R.subType==="Breast Milk"?w="bottle-breast-milk":R.type==="Feed"&&R.subType==="Formula"?w="bottle-formula":R.type==="Diaper"?w="diaper-all":R.type==="Pump"?w="pump":R.type==="Sleep"?w="sleep":R.type==="Solids"&&(w="solids"),o==="bottle-all"){if(R.type!=="Feed")return}else if(o==="diaper-all"){if(R.type!=="Diaper")return}else if(o==="diaper-pee"){if(R.type!=="Diaper"||R.diaperType!=="Pee"&&R.diaperType!=="Mixed")return}else if(o==="diaper-poo"){if(R.type!=="Diaper"||R.diaperType!=="Poo"&&R.diaperType!=="Mixed")return}else if(w!==o)return}if(R.type==="Feed"){const w=en(R.amount,R.unit);I.bottles.total+=w,I.bottles.sessions++,R.subType==="Breast Milk"?I.bottles.breastMilk+=w:R.subType==="Formula"&&(I.bottles.formula+=w)}else R.type==="Diaper"?(I.diapers.total++,R.diaperType==="Pee"?I.diapers.pee++:R.diaperType==="Poo"?I.diapers.poo++:R.diaperType==="Mixed"&&I.diapers.mixed++):R.type==="Sleep"&&I.sleep.sessions++;P=!0;const O=R.startTime.toDate(),F=yi(O);if(F!==S){S=F;const w=document.createElement("div");w.className="timeline-date-header",w.textContent=F,t.appendChild(w)}const z=document.createElement("div");z.className="timeline-entry";let Q=R.type,U="",v="";if(R.type==="Feed")Q=`Bottle - ${R.subType}`,U=`<div class="timeline-entry-details">Amount: ${ye(R.amount,R.unit)}</div>`,v="#d9ebf2";else if(R.type==="Breast Feed")Q="Breast Feed",U="",v="#d9ebf2";else if(R.type==="Diaper")U=`<div class="timeline-entry-details">Type: ${R.diaperType}</div>`,v="#fce2d4";else if(R.type==="Pump")U=`<div class="timeline-entry-details">Amount: ${ye(R.amount,R.unit)}</div>`,v="#e2daf2";else if(R.type==="Solids")Q="Solids",v="#f5e6d0";else if(R.type==="Sleep")if(Q="Sleep",v="#d4e8d4",R.endTime){const w=R.startTime.toDate(),p=R.endTime.toDate(),$=p.getTime()-w.getTime(),rt=Math.floor($/(1e3*60*60)),B=Math.floor($%(1e3*60*60)/(1e3*60));U=`<div class="timeline-entry-details">Duration: ${rt}h ${B}m</div>`,U+=`<div class="timeline-entry-details">End: ${gi(p)}</div>`}else U='<div class="timeline-entry-details">In progress</div>';z.style.backgroundColor=v;const g=R.notes?`<div class="timeline-entry-notes">${R.notes.replace(/\n/g,"<br>")}</div>`:"";let y="";if(R.type==="Diaper"&&(R.diaperType==="Poo"||R.diaperType==="Mixed")){const w=O.getTime(),p=[];m.forEach(rt=>{const B=rt.data;B.type==="Diaper"&&(B.diaperType==="Poo"||B.diaperType==="Mixed")&&p.push({time:B.startTime.toDate().getTime()})}),p.sort((rt,B)=>B.time-rt.time);const $=p.findIndex(rt=>rt.time===w);if($>=0&&$<p.length-1){const rt=p[$+1].time;y=`<div class="timeline-entry-details" style="color: #666; font-style: italic;">${((w-rt)/(1e3*60*60)).toFixed(1)} hours since previous poo</div>`}else $>=0&&$===p.length-1&&(z.dataset.needsPriorPoo="true",z.dataset.pooTime=String(w))}z.innerHTML=`
                ...
                `;const T=z.querySelector(".edit-button"),_=z.querySelector(".delete-button");T.addEventListener("click",()=>Bp(C,R)),_.addEventListener("click",()=>Op(C)),t.appendChild(z)});const k=t.querySelectorAll('[data-needs-prior-poo="true"]');for(const C of Array.from(k)){const R=parseInt(C.dataset.pooTime||"0",10);if(R>0)try{const O=vt(_t(ct,"entries"),Y("type","==","Diaper"),Y("startTime","<",j.fromDate(new Date(R))),It("startTime","desc")),F=await At(O);let z=null;if(F.forEach(Q=>{if(z!==null)return;const U=Q.data();(U.diaperType==="Poo"||U.diaperType==="Mixed")&&(z=U.startTime.toDate().getTime())}),z!==null){const Q=(R-z)/36e5,U=document.createElement("div");U.className="timeline-entry-details",U.style.color="#666",U.style.fontStyle="italic",U.textContent=`${Q.toFixed(1)} hours since previous poo`;const v=C.querySelector(".timeline-entry-actions");v?C.insertBefore(U,v):C.appendChild(U)}}catch(O){console.error("Error fetching prior poo entry:",O)}C.removeAttribute("data-needs-prior-poo"),C.removeAttribute("data-poo-time")}if(!P)t.innerHTML="<p>No entries match the selected filters.</p>";else{const C=document.createElement("div");C.className="filter-summary";let R='<div class="summary-header">Summary</div><div class="summary-stats">',O=!1;if((o==="all"||o==="bottle-breast-milk"||o==="bottle-formula"||o==="bottle-all")&&(R+=`
                        <div class="stat-group">
                            <div class="stat-group-title">Bottles</div>
                            <div class="stat-line">Number of feeds: ${I.bottles.sessions}</div>
                            <div class="stat-line">Breast Milk: ${ye(I.bottles.breastMilk,"oz")}</div>
                            <div class="stat-line">Formula: ${ye(I.bottles.formula,"oz")}</div>
                            <div class="stat-line">Total volume: ${ye(I.bottles.total,"oz")}</div>
                        </div>
                    `,O=!0),o==="all"||o==="diaper-all"||o==="diaper-pee"||o==="diaper-poo"){const F=I.diapers.pee+I.diapers.mixed,z=I.diapers.poo+I.diapers.mixed;R+=`
                        <div class="stat-group">
                            <div class="stat-group-title">Diapers</div>
                            <div class="stat-line">Pee: ${F}</div>
                            <div class="stat-line">Poo: ${z}</div>
                        </div>
                    `,O=!0}if(o==="all"||o==="sleep"){let F=0;if(r&&s){const U=[];m.forEach(lt=>{const ot=lt.data;ot.type==="Sleep"&&U.push({startTime:ot.startTime.toDate(),endTime:ot.endTime?ot.endTime.toDate():null})});const[v,g,y]=r.split("-").map(Number),T=new Date(v,g-1,y);T.setDate(T.getDate()-1);const _=new Date(T);_.setHours(0,0,0,0);const w=new Date(T);w.setHours(23,59,59,999);try{const lt=vt(_t(ct,"entries"),Y("type","==","Sleep"),Y("startTime",">=",j.fromDate(_)),Y("startTime","<=",j.fromDate(w)),It("startTime","asc"));(await At(lt)).forEach(ne=>{const kt=ne.data();U.push({startTime:kt.startTime.toDate(),endTime:kt.endTime?kt.endTime.toDate():null})})}catch(lt){console.error("Error fetching prior sleep entries:",lt)}const[p,$,rt]=s.split("-").map(Number),B=new Date(p,$-1,rt);B.setDate(B.getDate()+1);const M=new Date(B);M.setHours(0,0,0,0);const ht=new Date(B);ht.setHours(23,59,59,999);try{const lt=vt(_t(ct,"entries"),Y("type","==","Sleep"),Y("startTime",">=",j.fromDate(M)),Y("startTime","<=",j.fromDate(ht)),It("startTime","asc"));(await At(lt)).forEach(ne=>{const kt=ne.data();U.push({startTime:kt.startTime.toDate(),endTime:kt.endTime?kt.endTime.toDate():null})})}catch(lt){console.error("Error fetching post sleep entries:",lt)}const pt=new Date(v,g-1,y),it=new Date(p,$-1,rt),Ut=new Date(pt);for(;Ut<=it;){const lt=so(Ut);F+=ro(U,lt.start,lt.end),Ut.setDate(Ut.getDate()+1)}}const z=Math.floor(F/(1e3*60*60)),Q=Math.floor(F%(1e3*60*60)/(1e3*60));R+=`
                        <div class="stat-group">
                            <div class="stat-group-title">Sleep</div>
                            <div class="stat-line">Total sleep: ${z}h ${Q}m</div>
                            <div class="stat-line">Number of sleeps: ${I.sleep.sessions}</div>
                            <div class="stat-line" style="font-size: 11px; color: #888;">prev day 7pm - next day 7am</div>
                        </div>
                    `,O=!0}if(R+="</div>",n===Qe&&O){C.innerHTML=R;const F=document.querySelector(".filter-section");F&&F.parentNode&&F.parentNode.insertBefore(C,t)}}}}catch{n===Qe&&(t.innerHTML='<p class="error">Failed to load timeline</p>')}finally{n===Qe&&(e.style.display="none")}}function ro(n,t,e){let r=0;for(const s of n){if(!s.endTime)continue;const o=Math.max(s.startTime.getTime(),t.getTime()),a=Math.min(s.endTime.getTime(),e.getTime());a>o&&(r+=a-o)}return r}function so(n){const t=new Date(n);t.setHours(0,0,0,0);const e=new Date(t);e.setDate(e.getDate()-1);const r=ut(`${el(e)}T19:00`),s=new Date(t);s.setDate(s.getDate()+1);const o=ut(`${el(s)}T07:00`);return{start:r,end:o}}function Vp(n){const t=Math.floor(n/36e5),e=Math.floor(n%(1e3*60*60)/(1e3*60));return`${t}h ${e}m`}async function je(){const n=++Ne,t=document.getElementById("weekly-stats"),e=document.getElementById("weekly-loading"),r=document.getElementById("week-range"),s=document.getElementById("prev-week"),o=document.getElementById("next-week"),a=document.getElementById("current-week"),c=new Date(2025,10,5),h=un(c),d=Xt(),m=un(d),E=new Date(Qt);E.setHours(0,0,0,0),E<h&&(Qt=new Date(h)),E.getTime()<=h.getTime()?s.disabled=!0:s.disabled=!1,E.getTime()>=m.getTime()?o.disabled=!0:o.disabled=!1,a&&(E.getTime()===m.getTime()?(a.disabled=!0,a.style.backgroundColor="#999",a.style.color="#ccc",a.style.cursor="default"):(a.disabled=!1,a.style.backgroundColor="",a.style.color="",a.style.cursor="pointer"));const I=_p(Qt);r.textContent=`${yi(Qt).split(",")[1].trim()} - ${yi(I).split(",")[1].trim()}`,e.style.display="block",t.innerHTML="";try{const S=vt(_t(ct,"entries"),Y("startTime",">=",j.fromDate(Qt)),Y("startTime","<=",j.fromDate(I)),It("startTime","asc")),P=await At(S);if(n!==Ne)return;const k=new Date("2025-11-11");k.setHours(0,0,0,0);const C={},R=[];for(let B=0;B<7;B++){const M=new Date(Qt);if(M.setDate(M.getDate()+B),M.setHours(0,0,0,0),M>=k){const ht=`${M.getFullYear()}-${String(M.getMonth()+1).padStart(2,"0")}-${String(M.getDate()).padStart(2,"0")}`;R.push(ht)}}if(R.length>0){const B=await Promise.all(R.map(M=>Lc(yn(ct,"vitaminD",M))));R.forEach((M,ht)=>{var it;const pt=B[ht];C[M]=pt.exists()&&((it=pt.data())==null?void 0:it.given)===!0})}if(n!==Ne)return;const O=[];P.forEach(B=>{const M=B.data();M.type==="Sleep"&&O.push({startTime:M.startTime.toDate(),endTime:M.endTime?M.endTime.toDate():null})});const F=new Date(Qt);F.setDate(F.getDate()-1),F.setHours(0,0,0,0);const z=new Date(Qt);z.setHours(0,0,0,0);const Q=vt(_t(ct,"entries"),Y("type","==","Sleep"),Y("startTime",">=",j.fromDate(F)),Y("startTime","<",j.fromDate(z)),It("startTime","asc")),U=await At(Q);if(n!==Ne)return;U.forEach(B=>{const M=B.data();O.push({startTime:M.startTime.toDate(),endTime:M.endTime?M.endTime.toDate():null})});const v=new Date(I);v.setDate(v.getDate()+1),v.setHours(0,0,0,0);const g=new Date(v);g.setDate(g.getDate()+1),g.setHours(0,0,0,0);const y=vt(_t(ct,"entries"),Y("type","==","Sleep"),Y("startTime",">=",j.fromDate(v)),Y("startTime","<",j.fromDate(g)),It("startTime","asc")),T=await At(y);if(n!==Ne)return;T.forEach(B=>{const M=B.data();O.push({startTime:M.startTime.toDate(),endTime:M.endTime?M.endTime.toDate():null})});const _={};for(let B=0;B<7;B++){const M=new Date(Qt);M.setDate(M.getDate()+B),M.setHours(0,0,0,0);const ht=`${M.getFullYear()}-${M.getMonth()}-${M.getDate()}`,pt=`${M.getFullYear()}-${String(M.getMonth()+1).padStart(2,"0")}-${String(M.getDate()).padStart(2,"0")}`,it=so(M);_[ht]={date:new Date(M),vitaminD:M>=k?C[pt]===!0:null,bottles:{total:0,breastMilk:0,formula:0,sessions:0},diapers:{total:0,pee:0,poo:0,mixed:0},sleepMs:ro(O,it.start,it.end)}}P.forEach(B=>{const M=B.data(),ht=M.startTime.toDate(),pt=Rt(ht);pt.setHours(0,0,0,0);const it=`${pt.getFullYear()}-${pt.getMonth()}-${pt.getDate()}`;if(_[it])if(M.type==="Feed"){const Ut=en(M.amount,M.unit);_[it].bottles.total+=Ut,_[it].bottles.sessions++,M.subType==="Breast Milk"?_[it].bottles.breastMilk+=Ut:M.subType==="Formula"&&(_[it].bottles.formula+=Ut)}else M.type==="Breast Feed"?_[it].bottles.sessions++:M.type==="Diaper"&&(_[it].diapers.total++,M.diaperType==="Pee"?_[it].diapers.pee++:M.diaperType==="Poo"?_[it].diapers.poo++:M.diaperType==="Mixed"&&_[it].diapers.mixed++)});const w=Object.keys(_).map(B=>_[B]).sort((B,M)=>B.date.getTime()-M.date.getTime()),p=document.createElement("div");p.className="weekly-scroll-container";const $=Xt();$.setHours(0,0,0,0);let rt=-1;w.forEach((B,M)=>{const ht=document.createElement("div");ht.className="day-stats";const pt=new Date(B.date);pt.setHours(0,0,0,0),$.getTime()===pt.getTime()&&(ht.classList.add("current-day"),rt=M);const it=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"][B.date.getDay()],Ut=`${B.date.getMonth()+1}/${B.date.getDate()}`,lt=B.diapers.pee+B.diapers.mixed,ot=B.diapers.poo+B.diapers.mixed;let ne="";if(B.vitaminD!==null){const kt=B.vitaminD?"Yes":"No";ne=`
                    <div class="stat-group">
                        <div class="stat-group-title">Vitamin D</div>
                        <div class="stat-line" style="color: ${B.vitaminD?"#4caf50":"#f44336"}; font-weight: bold;">${kt}</div>
                    </div>
                `}ht.innerHTML=`
                <div class="day-stats-header">${it}<br>${Ut}</div>
                ${ne}
                <div class="stat-group">
                    <div class="stat-group-title">Bottles</div>
                    <div class="stat-line">Number of feeds: ${B.bottles.sessions}</div>
                    <div class="stat-line">Breast Milk: ${ye(B.bottles.breastMilk,"oz")}</div>
                    <div class="stat-line">Formula: ${ye(B.bottles.formula,"oz")}</div>
                    <div class="stat-line">Total volume: ${ye(B.bottles.total,"oz")}</div>
                </div>
                <div class="stat-group">
                    <div class="stat-group-title">Diapers</div>
